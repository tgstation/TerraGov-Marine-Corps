...
#define MOVE_FORCE_PUSH_RATIO 2				//Same move force to normally push
#define MOVE_FORCE_FORCEPUSH_RATIO 3		//3x move force to forcefully push
#define MOVE_FORCE_CRUSH_RATIO 4			//4x move force to do things like crush objects
