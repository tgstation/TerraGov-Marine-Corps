...
#define AMMO_RECIEVER_MAGAZINES (1<<1)
    #define AMMO_RECIEVER_AUTO_EJECT (1<<2)
#define AMMO_RECIEVER_HANDFULS (1<<3)
#define AMMO_RECIEVER_TOGGLES_OPEN (1<<4)
    #define AMMO_RECIEVER_TOGGLES_OPEN_EJECTS (1<<5)
#define AMMO_RECIEVER_CLOSED (1<<6)
#define AMMO_RECIEVER_ROTATES_CHAMBER (1<<7)
#define AMMO_RECIEVER_UNIQUE_ACTION_LOCKS (1<<8)
