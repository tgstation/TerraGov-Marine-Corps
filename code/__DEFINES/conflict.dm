...
//Knockout sources
#define KNOCKOUT_STATUSEFFECT_UNCONSCIOUS (1<<0)
#define KNOCKOUT_STATUSEFFECT_SLEEEPING (1<<1)
#define KNOCKOUT_STATUSEFFECT_ADMINSLEEP (1<<2)
#define KNOCKOUT_OXYLOSS (1<<3)
#define KNOCKOUT_SSD (1<<4)


//Immobility sources
#define IMMOBILE_INNATE (1<<0)
#define IMMOBILE_STATUSEFFECT_IMMOBILIZED (1<<1)
#define IMMOBILE_STATUSEFFECT_STUN (1<<2)
#define IMMOBILE_STATUSEFFECT_PARALYZED (1<<3)
#define IMMOBILE_FAKEDDEATH (1<<4)
#define IMMOBILE_STAT_UNCONSCIOUS (1<<5)
#define IMMOBILE_STAT_SOFTCRITPULLED (1<<6)
#define IMMOBILE_BUCKLED (1<<7)
#define IMMOBILE_RESTRAINED_PSYCHICGRABBED (1<<8)
#define IMMOBILE_GRABSTATE_GRAB_NECK (1<<9)
#define IMMOBILE_FROZEN (1<<10)
#define IMMOBILE_TRAIT_STASIS (1<<11)
#define IMMOBILE_LIMBLESS (1<<12)
#define IMMOBILE_STEPTRIGGER_THROWER (1<<13)
#define IMMOBILE_DEVOURED (1<<14)
#define IMMOBILE_KNOCKOUT (1<<15)
#define IMMOBILE_XENOLYING (1<<16)
#define IMMOBILE_RESTING (1<<17)


//Lying sources
#define LYING_STATUSEFFECT_KNOCKEDDOWN (1<<0)
#define LYING_STATUSEFFECT_PARALYZED (1<<1)
#define LYING_STAT_NOTCONSCIOUS (1<<2)
#define LYING_BUCKLED (1<<3)
#define LYING_LEGLESS (1<<4)
#define LYING_FAKEDDEATH (1<<5)
#define LYING_STATUSEFFECT_WORMED (1<<6)
...
//Hand block sources
#define HANDBLOCK_STATUSEFFECT_PARALYZED (1<<0)
#define HANDBLOCK_STATUSEFFECT_STUN (1<<1)
#define HANDBLOCK_STAT_NOTCONSCIOUS (1<<2)
#define HANDBLOCK_TRAIT_STASIS (1<<3)
#define HANDBLOCK_FAKEDDEATH (1<<4)
#define HANDBLOCK_GRABSTATE_GRAB_NECK (1<<5)
#define HANDBLOCK_RESTRAINED (1<<6)
#define HANDBLOCK_ARMLESS (1<<7)
#define HANDBLOCK_STATUSEFFECT_DISABLEHANDS (1<<8)
#define HANDBLOCK_STATUSEFFECT_WORMED (1<<9)
#define HANDBLOCK_DEVOURED (1<<10)
#define HANDBLOCK_KNOCKOUT (1<<11)
#define HANDBLOCK_XENOLYING (1<<12)
#define HANDBLOCK_RESTING (1<<13)


//Pull block sources
#define PULLBLOCK_LYING (1<<0)
#define PULLBLOCK_HANDBLOCK (1<<1)
#define PULLBLOCK_STATUSEFFECT_IMMOBILIZED (1<<2)


//UI block sources
#define UI_LYING (1<<0)
#define UI_HANDBLOCK (1<<1)
#define UI_STATUSEFFECT_IMMOBILIZED (1<<2)
