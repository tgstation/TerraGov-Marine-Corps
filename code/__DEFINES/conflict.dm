...
#define GUN_INTERNAL_MAG (1<<2)
#define GUN_AUTO_EJECTOR (1<<3)
#define GUN_AMMO_COUNTER (1<<4)
#define GUN_LOAD_INTO_CHAMBER (1<<5)
#define GUN_ENERGY (1<<6)
#define GUN_WIELDED_FIRING_ONLY (1<<7)
#define GUN_ALLOW_SYNTHETIC (1<<8)
#define GUN_WIELDED_STABLE_FIRING_ONLY (1<<9)
#define GUN_IFF (1<<10)
#define GUN_DEPLOYED_FIRE_ONLY (1<<11)
#define GUN_IS_ATTACHMENT (1<<12)
#define GUN_ATTACHMENT_FIRE_ONLY (1<<13)
#define GUN_IS_SENTRY (1<<14)
#define GUN_PUMP_REQUIRED (1<<15)
#define GUN_CHAMBER_CYCLES (1<<16)
#define GUN_CHAMBER_TOGGLES (1<<17)
...
#define MAGAZINE_CHAMBER_CAN_OPEN (1<<4)
#define MAGAZINE_CHAMBER_IS_OPEN (1<<5)
#define MAGAZINE_HAS_CONTENTS (1<<6)
