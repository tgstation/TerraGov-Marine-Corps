...
#define MAPTEXT_HUDMESSAGE_TITLE(text, alignment) {"<span style='font-family: \"F25 Bank\"; font-size: 14pt; line-height: 1.25; text-align: [##alignment]'><u>[##text]</u></span>"}

#define MAPTEXT_HUDMESSAGE(text) {"<span style='font-family: \"F25 Bank\"; font-size: 12pt; line-height: 1; -dm-text-outline: 1px black'>[##text]</span>"}
