...
#define CHAT_FOOC			(1<<14)

#define TOGGLES_CHAT_DEFAULT (CHAT_OOC|CHAT_DEAD|CHAT_GHOSTEARS|CHAT_GHOSTSIGHT|CHAT_PRAYER|CHAT_RADIO|CHAT_DEBUGLOGS|CHAT_GHOSTRADIO|CHAT_FFATTACKLOGS|CHAT_GHOSTHIVEMIND|CHAT_STATISTICS|CHAT_LOOC|CHAT_FOOC)
