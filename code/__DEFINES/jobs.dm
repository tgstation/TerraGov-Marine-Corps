...
///Xenos pick fights when there are 4 humans on each team there will be 2 xenos which is a fair fight factoring in the other team's damage
#define ENCOUNTER_XENO_HUMAN_RATIO 8
