...
///Every x humans xenos gain another larva. Xenos pick their fights, when there is 6 humans on each team there will be 2 xenos which is a fair fight factoring in the other team's damage
#define ENCOUNTER_XENO_HUMAN_RATIO 5
