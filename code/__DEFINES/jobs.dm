...
#define JOB_DISPLAY_ORDER_SURVIVOR 26
#define JOB_DISPLAY_ORDER_PRISONER 27
...
GLOBAL_LIST_INIT(jobs_marines, list(SECURITY_OFFICER, SQUAD_LEADER, SQUAD_SPECIALIST, SQUAD_SMARTGUNNER, SQUAD_CORPSMAN, SQUAD_ENGINEER, SQUAD_MARINE))
...
MEDICAL_DOCTOR, MEDICAL_RESEARCHER, SQUAD_LEADER, SQUAD_SPECIALIST, SQUAD_SMARTGUNNER, SQUAD_CORPSMAN, SQUAD_ENGINEER, SQUAD_MARINE, \
