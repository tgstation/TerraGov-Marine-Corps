...
CHIEF_MEDICAL_OFFICER, SYNTHETIC, AI, COMMAND_MASTER_AT_ARMS))
GLOBAL_LIST_INIT(jobs_police, list(COMMAND_MASTER_AT_ARMS, MASTER_AT_ARMS))
GLOBAL_LIST_INIT(jobs_officers, list(CAPTAIN, FIELD_COMMANDER, INTELLIGENCE_OFFICER, PILOT_OFFICER, TANK_CREWMAN, CORPORATE_LIAISON, SYNTHETIC, AI))
...
CHIEF_MEDICAL_OFFICER, SYNTHETIC, AI, COMMAND_MASTER_AT_ARMS, MASTER_AT_ARMS, TANK_CREWMAN, CORPORATE_LIAISON, SHIP_ENGINEER, CARGO_TECHNICIAN, \
