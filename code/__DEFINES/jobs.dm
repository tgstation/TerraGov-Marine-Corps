...
GLOBAL_LIST_INIT(jobs_officers, list(CAPTAIN, CHIEF_EXECUTIVE_OFFICER, FIELD_COMMANDER, CORPSEC_COMMANDER, STAFF_OFFICER, PILOT_OFFICER, TRANSPORT_OFFICER, MECH_PILOT, ASSAULT_CREWMAN, TRANSPORT_CREWMAN, CORPORATE_LIAISON, SYNTHETIC, SILICON_AI))
...
GLOBAL_LIST_INIT(jobs_marines, list(SECURITY_OFFICER, SQUAD_LEADER, SQUAD_SPECIALIST, SQUAD_SMARTGUNNER, SQUAD_CORPSMAN, SQUAD_ENGINEER, SQUAD_MARINE, SQUAD_SLUT, PMC_MEDIC, PMC_GUNNER, PMC_STANDARD, PMC_SNIPER, PMC_LEADER))
...
GLOBAL_LIST_INIT(jobs_regular_all, list(CAPTAIN, SECURITY_OFFICER, CHIEF_EXECUTIVE_OFFICER, FIELD_COMMANDER, CORPSEC_COMMANDER, STAFF_OFFICER, PILOT_OFFICER, TRANSPORT_OFFICER, MECH_PILOT, REQUISITIONS_OFFICER, CHIEF_SHIP_ENGINEER, \
CHIEF_MEDICAL_OFFICER, SYNTHETIC, SILICON_AI, CORPORATE_LIAISON, SHIP_TECH, ASSAULT_CREWMAN, TRANSPORT_CREWMAN, \
MEDICAL_DOCTOR, MEDICAL_RESEARCHER, SQUAD_LEADER, SQUAD_SMARTGUNNER, SQUAD_CORPSMAN, SQUAD_ENGINEER, SQUAD_MARINE,  SQUAD_SLUT, \
...
PMC_MEDIC, PMC_GUNNER, PMC_STANDARD, PMC_SNIPER, PMC_LEADER))
