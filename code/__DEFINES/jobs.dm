...
#define JOB_DISPLAY_ORDER_UNSC_LEADER				27
#define JOB_DISPLAY_ORDER_INSURRECTIONIST				28
#define JOB_DISPLAY_ORDER_INSURRECTIONIST_LEADER	29
...
#define INSURRECTIONIST_LEADER "Insurrectionist Leader"
...
GLOBAL_LIST_INIT(jobs_unsc, list(UNSC_MARINE, UNSC_LEADER))
GLOBAL_LIST_INIT(jobs_insurrection, list(INSURRECTIONIST, INSURRECTIONIST_LEADER))
