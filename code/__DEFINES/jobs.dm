...
#define JOB_DISPLAY_ORDER_SECURITY_OFFICER 24
...
GLOBAL_LIST_INIT(jobs_marines, list(SECURITY_OFFICER, SQUAD_LEADER, SQUAD_SMARTGUNNER, SQUAD_CORPSMAN, SQUAD_ENGINEER, SQUAD_MARINE))
