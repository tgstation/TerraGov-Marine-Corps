...
#define JOB_DISPLAY_ORDER_SYNTHETIC 			8
...
#define JOB_DISPLAY_ORDER_SHIP_TECH     		13
...
GLOBAL_LIST_INIT(jobs_officers, list(CAPTAIN, FIELD_COMMANDER, STAFF_OFFICER, PILOT_OFFICER, TANK_CREWMAN, WALKER_PILOT, CORPORATE_LIAISON, SYNTHETIC, SILICON_AI))
...
CHIEF_MEDICAL_OFFICER, SYNTHETIC, SILICON_AI, COMMAND_MASTER_AT_ARMS, MASTER_AT_ARMS, TANK_CREWMAN, WALKER_PILOT, CORPORATE_LIAISON, SHIP_TECH, \
