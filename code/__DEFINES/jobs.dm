...
#define JOB_DISPLAY_ORDER_MEDICAL_COMPANION 19
...
#define MEDICAL_COMPANION "Medical Companion"
...
GLOBAL_LIST_INIT(jobs_medical, list(CHIEF_MEDICAL_OFFICER, MEDICAL_DOCTOR, MEDICAL_RESEARCHER, MEDICAL_COMPANION))
...
MEDICAL_DOCTOR, MEDICAL_RESEARCHER, MEDICAL_COMPANION, SQUAD_LEADER, SQUAD_SMARTGUNNER, SQUAD_CORPSMAN, SQUAD_ENGINEER, SQUAD_MARINE, \
