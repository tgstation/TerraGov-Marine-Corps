...
#define JOB_DISPLAY_ORDER_TAD_PILOT 6
#define JOB_DISPLAY_ORDER_CAS_PILOT 7
#define JOB_DISPLAY_ORDER_MECH_PILOT 8
#define JOB_DISPLAY_ORDER_CORPORATE_LIAISON 9
...
#define TAD_PILOT "Tadpole Pilot"
#define CAS_PILOT "Condor Pilot"
...
GLOBAL_LIST_INIT(jobs_officers, list(CAPTAIN, FIELD_COMMANDER, STAFF_OFFICER, CAS_PILOT, TAD_PILOT, MECH_PILOT, CORPORATE_LIAISON, SYNTHETIC, SILICON_AI))
GLOBAL_LIST_INIT(jobs_support, list(CAS_PILOT, TAD_PILOT, MECH_PILOT, REQUISITIONS_OFFICER, SYNTHETIC, SILICON_AI))
...
GLOBAL_LIST_INIT(jobs_regular_all, list(CAPTAIN, FIELD_COMMANDER, STAFF_OFFICER, CAS_PILOT, TAD_PILOT, MECH_PILOT, REQUISITIONS_OFFICER, CHIEF_SHIP_ENGINEER, \
