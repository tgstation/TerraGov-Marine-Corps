...
#define JOB_DISPLAY_ORDER_SQUAD_LEADER 20
...
#define JOB_DISPLAY_ORDER_SQUAD_SPECIALIST 24
#define JOB_DISPLAY_ORDER_SQUAD_MARINE 25
#define JOB_DISPLAY_ORDER_SQUAD_SLUT 26
#define JOB_DISPLAY_ORDER_SURVIVOR 27
#define JOB_DISPLAY_ORDER_SECURITY_OFFICER 28
#define JOB_DISPLAY_ORDER_PRISONER 29
...
GLOBAL_LIST_INIT(jobs_officers, list(CAPTAIN, CHIEF_EXECUTIVE_OFFICER, FIELD_COMMANDER, CORPSEC_COMMANDER, STAFF_OFFICER, PILOT_OFFICER, MECH_PILOT, CORPORATE_LIAISON, SYNTHETIC, SILICON_AI))
...
GLOBAL_LIST_INIT(jobs_marines, list(SECURITY_OFFICER, SQUAD_LEADER, SQUAD_SPECIALIST, SQUAD_SMARTGUNNER, SQUAD_CORPSMAN, SQUAD_ENGINEER, SQUAD_MARINE, SQUAD_SLUT))
GLOBAL_LIST_INIT(jobs_som, list(SOM_SQUAD_MARINE, SOM_SQUAD_VETERAN, SOM_SQUAD_ENGINEER, SOM_SQUAD_CORPSMAN, SOM_SQUAD_LEADER, SOM_FIELD_COMMANDER, SOM_STAFF_OFFICER, SOM_COMMANDER, SOM_SQUAD_SLUT))
GLOBAL_LIST_INIT(jobs_regular_all, list(CAPTAIN, SECURITY_OFFICER, CHIEF_EXECUTIVE_OFFICER, FIELD_COMMANDER, CORPSEC_COMMANDER, STAFF_OFFICER, PILOT_OFFICER, MECH_PILOT, REQUISITIONS_OFFICER, CHIEF_SHIP_ENGINEER, \
CHIEF_MEDICAL_OFFICER, SYNTHETIC, SILICON_AI, CORPORATE_LIAISON, SHIP_TECH, \
MEDICAL_DOCTOR, MEDICAL_RESEARCHER, SQUAD_LEADER, SQUAD_SPECIALIST, SQUAD_SMARTGUNNER, SQUAD_CORPSMAN, SQUAD_ENGINEER, SQUAD_MARINE, SQUAD_SLUT, \
