...
#define SPAM_TRIGGER_WARNING	5	//Number of messages required per the time period before the spam-prevention will warn you
...
#define SPAM_TRIGGER_WEIGHT_WARNING 2 //The weight required per the time period before the spam-prevention will warn you
