...
#define DISTRESS_EVAC_NONE "DISTRESS_EVAC_NONE"
#define DISTRESS_EVAC_INPROGRESS "DISTRESS_EVAC_INPROGRESS"
#define DISTRESS_EVAC_COMPLETED "DISTRESS_EVAC_COMPLETED"
