...
#define ZOMBIE_CRASH_POINTS_PER_CYCLE_MIN 5
#define ZOMBIE_CRASH_POINTS_PER_CYCLE_MAX 60
#define ZOMBIE_CRASH_POINTS_PER_TUNNEL_MIN 10
#define ZOMBIE_CRASH_POINTS_PER_TUNNEL_MAX 120
