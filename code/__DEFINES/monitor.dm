...
#define SPAWN_RATE_PER_PLAYER 18 //For each player, the time between two consecutive spawns is reduced by 18 ticks. So for 35 players, it's one mob every 30 seconds
