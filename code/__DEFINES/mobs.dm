...
#define CASTE_IS_STRONG (1<<4) // Can tear open acidded walls or reinforced miners without being MOB_SIZE_BIG.
...
#define CASTE_STAGGER_IMMUNE (1<<10) // Immunity to all forms of stagger.
#define CASTE_KNOCKBACK_IMMUNE (1<<11) // Immunity to all forms of knockback / throwing.
#define CASTE_SLOW_IMMUNE (1<<12) // Immunity to all forms of slow.
#define CASTE_STUN_IMMUNE (1<<13) // Immunity to all forms of stun.
