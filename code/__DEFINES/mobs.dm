...
#define XENO_PROGRESS_UPTICK_BASE				2 //a normal rate is 1 per second.
#define XENO_PROGRESS_UPTICK_ADDITION_SILO		0.2 //per additional silo, +0.1 per second.

#define XENO_EVOLVE_UPGRADE_REDUCTION			-60 //reduce upgrade by 1 minute's progress when evolving or regressing.

#define XENO_UPGRADETHRESHOLD_TIER1_MATURE		300 //5 minutes
#define XENO_UPGRADETHRESHOLD_TIER1_ELDER		900 //15 minutes
#define XENO_UPGRADETHRESHOLD_TIER1_ANCIENT		1800 //30 minutes

#define XENO_UPGRADETHRESHOLD_TIER2_MATURE		600 //10 minutes
#define XENO_UPGRADETHRESHOLD_TIER2_ELDER		1800 //30 minutes
#define XENO_UPGRADETHRESHOLD_TIER2_ANCIENT		2700 //45 minutes

#define XENO_UPGRADETHRESHOLD_TIER3_MATURE		900 //15 minutes
#define XENO_UPGRADETHRESHOLD_TIER3_ELDER		2700 //45 minutes
#define XENO_UPGRADETHRESHOLD_TIER3_ANCIENT		3600 //60 minutes

//tier4 = queen, hivemind.
#define XENO_UPGRADETHRESHOLD_TIER4_MATURE		1200 //20 minutes
#define XENO_UPGRADETHRESHOLD_TIER4_ELDER		3600 //60 minutes
#define XENO_UPGRADETHRESHOLD_TIER4_ANCIENT		4500 //75 minutes
