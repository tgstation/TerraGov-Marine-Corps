...
#define CASTE_IS_STRONG (1<<21) // Can tear open acidded walls or reinforced miners without being MOB_SIZE_BIG.
// Xenomorph can_flags:
...
#define CASTE_CAN_BE_QUEEN_HEALED (1<<6) // Does nothing.
#define CASTE_CAN_HOLD_JELLY (1<<7) // Can we hold fireproof jelly in our hands?
