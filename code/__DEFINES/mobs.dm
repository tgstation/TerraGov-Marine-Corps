...
//Ravager defines:
#define RAVAGER_CHARGESPEED					2
#define RAVAGER_CHARGESTRENGTH				2
#define RAVAGER_CHARGEDISTANCE				4
#define RAVAGER_CHARGE_TYPE					3

#define RAVAGER_ENDURE_DURATION				60 SECONDS
#define RAVAGER_ENDURE_WARNING				0.66
#define RAVAGER_ENDURE_HP_LIMIT				-350
