...
#define XENO_REAGENT_STING_CHANNEL_TIME		0.01 SECONDS
...
//Afflictor Defines
#define AFFLICTOR_CAMOUFLAGE_COOLDOWN				70 //7 seconds
#define AFFLICTOR_CAMOUFLAGE_WALK_PLASMADRAIN		1
#define AFFLICTOR_CAMOUFLAGE_RUN_PLASMADRAIN		6
#define AFFLICTOR_CAMOUFLAGE_STILL_ALPHA			14 //95% transparency
#define AFFLICTOR_CAMOUFLAGE_WALK_ALPHA				38 //85% transparency
#define AFFLICTOR_CAMOUFLAGE_RUN_ALPHA				128 //50% transparency
#define AFFLICTOR_CAMOUFLAGE_STEALTH_DELAY			10 //2 seconds before 95% stealth
#define AFFLICTOR_CAMOUFLAGE_INITIAL_DELAY			10 //1 seconds before we can increase stealth
