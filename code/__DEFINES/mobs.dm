...
#define SPIDERLING_RAGE_SPEED 1 // how much faster spiderlings move when enraged
#define SPIDERLING_RAGE_ATTACK_SPEED 1 // how much faster spiderlings attack when enraged
