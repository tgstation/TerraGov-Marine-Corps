...
#define TARGET_PROG_DISPLAY		1
#define USER_PROG_DISPLAY		0

#define PROG_ICON_GENERIC	"busy_generic"
#define PROG_ICON_MEDICAL	"busy_medical"
#define PROG_ICON_BUILD		"busy_build"
#define PROG_ICON_FRIENDLY	"busy_friendly"
#define PROG_ICON_HOSTILE	"busy_hostile"
#define PROG_ICON_CLOCK		"busy_clock"
#define PROG_ICON_BAR		"busy_bar"

#define TARGET_PROG_ICON_GENERIC	list(TARGET_PROG_DISPLAY, PROG_ICON_GENERIC, "pixel_y" = 32)
#define TARGET_PROG_ICON_MEDICAL	list(TARGET_PROG_DISPLAY, PROG_ICON_MEDICAL, "pixel_y" = 0)
#define TARGET_PROG_ICON_BUILD		list(TARGET_PROG_DISPLAY, PROG_ICON_BUILD, "pixel_y" = 32)
#define TARGET_PROG_ICON_FRIENDLY	list(TARGET_PROG_DISPLAY, PROG_ICON_FRIENDLY, "pixel_y" = 32)
#define TARGET_PROG_ICON_HOSTILE	list(TARGET_PROG_DISPLAY, PROG_ICON_HOSTILE, "pixel_y" = 32)
#define TARGET_PROG_ICON_CLOCK		list(TARGET_PROG_DISPLAY, PROG_ICON_CLOCK, "pixel_y" = 32)
#define TARGET_PROG_ICON_BAR		list(TARGET_PROG_DISPLAY, PROG_ICON_BAR, "pixel_y" = 32)

#define USER_PROG_ICON_GENERIC	list(USER_PROG_DISPLAY, PROG_ICON_GENERIC, "pixel_y" = 32)
#define USER_PROG_ICON_MEDICAL	list(USER_PROG_DISPLAY, PROG_ICON_MEDICAL, "pixel_y" = 0)
#define USER_PROG_ICON_BUILD	list(USER_PROG_DISPLAY, PROG_ICON_BUILD, "pixel_y" = 32)
#define USER_PROG_ICON_FRIENDLY	list(USER_PROG_DISPLAY, PROG_ICON_FRIENDLY, "pixel_y" = 32)
#define USER_PROG_ICON_HOSTILE	list(USER_PROG_DISPLAY, PROG_ICON_HOSTILE, "pixel_y" = 32)
#define USER_PROG_ICON_CLOCK	list(USER_PROG_DISPLAY, PROG_ICON_CLOCK, "pixel_y" = 32)
#define USER_PROG_ICON_BAR		list(USER_PROG_DISPLAY, PROG_ION_BAR, "pixel_y" = 32)
