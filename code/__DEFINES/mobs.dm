...
#define CASTE_INNATE_HEALING		(1<<4) // Xenomorphs suffer no heal penalty while on weeds
...
#define CASTE_NO_STAND_HEAL_PENALTY	(1<<11) // Xenomorphs don't suffer a penalty to healing when not resting
