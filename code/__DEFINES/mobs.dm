...
#define DEFENDER_CHARGESPEED			70
#define DEFENDER_CHARGESTRENGTH			3
#define DEFENDER_CHARGEDISTANCE			4
#define DEFENDER_CHARGECOOLDOWN			15 SECONDS
#define DEFENDER_CHARGE_TYPE			3
