...
GLOBAL_LIST_INIT(specialist_gear_listed_products, list(
	...
	/obj/item/ammo_magazine/rifle/autosniper = list(CAT_SPSUP, "SR-81 Autosniper Magazine", 2, "black"),
	/obj/item/ammo_magazine/packet/autosniper = list(CAT_SPSUP, "Box of low-pressure 8.6x70mm", 3, "black"),
