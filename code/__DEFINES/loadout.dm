...
GLOBAL_LIST_INIT(specialist_gear_listed_products, list(
	...
	/obj/item/storage/box/crate/heavy_armor = list(CAT_AMR, "Heavy Armor Pack", 25, "black"),
	/obj/item/storage/box/crate/heavy_grenadier = list(CAT_AMR, "Heavy Grenadier Pack", 20, "black"),
	...
	/obj/item/ammo_magazine/rifle/ap = list(SP_SUP, "PR-412 Armor Piercing Magazine", 2, "black"),
	/obj/item/ammo_magazine/rifle/standard_smarttargetrifle = list(SP_SUP, "SG-62 Target Rifle Magazine", 1, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle = list(SP_SUP, "SG-153 Spotting Rifle Magazine", 2, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/highimpact = list(SP_SUP, "SG-153 Spotting Rifle High Impact Magazine", 2, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/heavyrubber = list(SP_SUP, "SG-153 Spotting Rifle Heavy Rubber Magazine", 2, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/tungsten = list(SP_SUP, "SG-153 Spotting Rifle Tungsten Magazine", 2, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/flak = list(SP_SUP, "SG-153 Spotting Rifle Flak Magazine", 2, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/plasmaloss = list(SP_SUP, "SG-153 Spotting Rifle Tanglefoot Magazine", 3, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/incendiary = list(SP_SUP, "SG-153 Spotting Rifle Incendiary Magazine", 3, "black"),
	/obj/item/ammo_magazine/rifle/autosniper = list(SP_SUP, "SR-81 Autosniper Magazine", 2, "black"),
	/obj/item/ammo_magazine/packet/autosniper = list(SP_SUP, "Box of low-pressure 8.6x70mm", 3, "black"),
	/obj/item/ammo_magazine/rifle/tx8 = list(SP_SUP, "BR-8 High Velocity Magazine", 1, "black"),
	/obj/item/ammo_magazine/rifle/tx8/impact = list(SP_SUP, "BR-8 High Velocity Impact Magazine", 2, "black"),
	/obj/item/ammo_magazine/rifle/tx8/incendiary = list(SP_SUP, "BR-8 High Velocity Incendiary Magazine", 2, "black"),
	/obj/item/ammo_magazine/packet/scout_rifle = list(SP_SUP, "Box of A19 high velocity bullets", 3, "black"),
	))
