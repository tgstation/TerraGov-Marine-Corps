...
GLOBAL_LIST_INIT(smartgunner_gear_listed_products, list(
	...
	/obj/item/ammo_magazine/standard_smartmachinegun = list(CAT_LEDSUP, "T-29 Standard Smartmachinegun 200 ammo drum", 5 , "black"),
	/obj/item/ammo_magazine/extended_smartmachinegun = list(CAT_LEDSUP, "T-29 Extended Smartmachinegun 350 ammo drum", 5 , "black"),
