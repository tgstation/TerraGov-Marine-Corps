...
GLOBAL_LIST_INIT(commanddoll_gear_listed_products, list(
	...
	/obj/item/storage/box/crate/loot/operator_pack = list(CAT_CDSUP, "Operator Pack (PR-412E + AP & Incen Mags)", 25, "orange"),
	/obj/item/storage/box/crate/loot/m25e_pack = list(CAT_CDSUP, "CQC Pack (SMG-25BE + AP-Mags)", 20, "orange"),
