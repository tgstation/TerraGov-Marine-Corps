...
GLOBAL_LIST_INIT(engineer_gear_listed_products, list(
		...
		/obj/item/storage/box/explosive_mines/claymore = list(CAT_ENGSUP, "M20 claymore box", 18, "black"),
		/obj/item/storage/box/explosive_mines/claymore/large = list(CAT_ENGSUP, "Large M20 claymore box", 35, "black"),
