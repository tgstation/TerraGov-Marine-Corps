...
GLOBAL_LIST_INIT(som_veteran_gear_listed_products, list(
	...
	/obj/effect/supply_drop/som_big = list(CAT_SPSUP, "V-35 Battle Rifle", 20, "black"),
	/obj/effect/supply_drop/culverin = list(CAT_SPSUP, "VX-42 Culverin + Powerpack", 30, "black"),
	/obj/effect/supply_drop/blink_kit = list(CAT_SPSUP, "Blink Drive Kit", 30, "black"),
	/obj/effect/supply_drop/som_rpg = list(CAT_SPSUP, "V-71 RPG Kit", 30, "black"),
	/obj/item/clothing/glasses/night/vsd = list(CAT_SPSUP, "CM-12 Night Vision Goggles", 15, "black"),
	...
	/obj/item/ammo_magazine/rifle/mpi_km = list(CAT_SPSUP, "MPi-KM Extended Magazine", 1, "black"),
...
GLOBAL_LIST_INIT(pmc_specialist_clothes_listed_products, list(
		/obj/effect/vendor_bundle/pmc/basic = list(CAT_STD, "Standard PMC Kit", 0, "white"),
		/obj/effect/vendor_bundle/robot/essentials = list(CAT_STD, "Essential Combat Robot Kit", 0, "white"),
...
GLOBAL_LIST_INIT(pmc_leader_clothes_listed_products, list(
		/obj/effect/vendor_bundle/pmc/leader = list(CAT_STD, "Standard PMC Kit", 0, "white"),
		/obj/effect/vendor_bundle/robot/essentials = list(CAT_STD, "Essential Combat Robot Kit", 0, "white"),
...
GLOBAL_LIST_INIT(icc_standard_clothes_listed_products, list(
		...
		/obj/item/storage/pouch/grenade/slightlyfull = list(CAT_POU, "Grenade pouch (grenades included)", 0,"black"),
		/obj/item/storage/pouch/construction/icc/full = list(CAT_POU, "Construction pouch (materials included)", 0,"black"),
		/obj/item/storage/pouch/magazine/pistol/large = list(CAT_POU, "Pistol magazine pouch", 0,"black"),
...
GLOBAL_LIST_INIT(job_specific_clothes_vendor, list(
	...
	PMC_SNIPER = GLOB.pmc_specialist_clothes_listed_products,
	...
	ICC_MEDIC = GLOB.icc_standard_clothes_listed_products,
...
GLOBAL_LIST_INIT(loadout_role_essential_set, list(
	...
	SOM_SQUAD_CORPSMAN = list(
		...
		/obj/item/clothing/under/som/medic/vest = 1,
	),
	SOM_SQUAD_VETERAN = list(
		...
		/obj/item/clothing/under/som/veteran/webbing = 1,
	),
	SOM_SQUAD_LEADER = list(
		...
		/obj/item/clothing/under/som/leader/webbing = 1,
	),
))
