...
GLOBAL_LIST_INIT(leader_gear_listed_products, list(
		...
		/obj/item/storage/pouch/explosive/antigas = list(CAT_LEDSUP, "Pack of M40-AG Antigas grenades", 24, "orange"),
...
GLOBAL_LIST_INIT(commander_gear_listed_products, list(
		...
		/obj/item/storage/pouch/explosive/antigas = list(CAT_FCSUP, "Pack of M40-AG Antigas grenades", 24, "orange"),
