...
GLOBAL_LIST_INIT(specialist_gear_listed_products, list(
	...
	/obj/item/storage/box/crate/loot/autosniper_pack_spec = list(CAT_SPSUP, "Autosniper Pack (SR-81 + Mags + Packet + NVG Scope)", 15, "black"),
	...
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/highimpact = list(CAT_SPSUP, "SG-153 Spotting Rifle High Impact Magazine", 2, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/heavyrubber = list(CAT_SPSUP, "SG-153 Spotting Rifle Heavy Rubber Magazine", 2, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/tungsten = list(CAT_SPSUP, "SG-153 Spotting Rifle Tungsten Magazine", 2, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/flak = list(CAT_SPSUP, "SG-153 Spotting Rifle Flak Magazine", 2, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/plasmaloss = list(CAT_SPSUP, "SG-153 Spotting Rifle Tanglefoot Magazine", 2, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/incendiary = list(CAT_SPSUP, "SG-153 Spotting Rifle Incendiary Magazine", 2, "black"),
	...
	/obj/item/ammo_magazine/rifle/tx8/impact = list(CAT_SPSUP, "BR-8 High Velocity Impact Magazine", 2, "black"),
	/obj/item/ammo_magazine/rifle/tx8/incendiary = list(CAT_SPSUP, "BR-8 High Velocity Incendiary Magazine", 2, "black"),
	/obj/item/ammo_magazine/packet/scout_rifle = list(CAT_SPSUP, "Box of A19 high velocity bullets", 3, "black"),
	/obj/item/ammo_magazine/sniper = list(CAT_SPSUP, "AMR Magazine", 1, "black"),
	/obj/item/ammo_magazine/sniper/incendiary = list(CAT_SPSUP, "AMR Incendiary Magazine", 2, "black"),
	/obj/item/ammo_magazine/sniper/flak = list(CAT_SPSUP, "AMR Flak Magazine", 2, "black"),
	))
...
GLOBAL_LIST_INIT(commanddoll_gear_listed_products, list(
	...
	/obj/item/storage/box/crate/loot/operator_pack = list(CAT_CDSUP, "Operator Pack (PR-412E + AP-Mags + Scout Sight)", 25, "orange"),
	...
	/obj/item/storage/box/crate/loot/targetrifle_pack_spec = list(CAT_CDSUP, "SG-62 Target Rifle (SG-153 + Mixed Ammo) Pack", 20, "orange"),
	/obj/item/storage/box/crate/loot/infiltration_pack_spec = list(CAT_CDSUP, "Infiltrator Pack (Abduction gear + NVG + tranq pistol + scout cloak)", 25, "black"),
	...
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/highimpact = list(CAT_CDSUP, "SG-153 Spotting Rifle High Impact Magazine", 2, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/heavyrubber = list(CAT_CDSUP, "SG-153 Spotting Rifle Heavy Rubber Magazine", 2, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/tungsten = list(CAT_CDSUP, "SG-153 Spotting Rifle Tungsten Magazine", 2, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/flak = list(CAT_CDSUP, "SG-153 Spotting Rifle Flak Magazine", 2, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/plasmaloss = list(CAT_CDSUP, "SG-153 Spotting Rifle Tanglefoot Magazine", 2, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/incendiary = list(CAT_CDSUP, "SG-153 Spotting Rifle Incendiary Magazine", 2, "black"),
	/obj/item/ammo_magazine/rifle/tx8 = list(CAT_CDSUP, "BR-8 High Velocity Magazine", 1, "black"),
	/obj/item/ammo_magazine/rifle/tx8/impact = list(CAT_CDSUP, "BR-8 High Velocity Impact Magazine", 2, "black"),
	/obj/item/ammo_magazine/rifle/tx8/incendiary = list(CAT_CDSUP, "BR-8 High Velocity Incendiary Magazine", 2, "black"),
	/obj/item/ammo_magazine/packet/scout_rifle = list(CAT_CDSUP, "Box of A19 high velocity bullets", 3, "black"),
	))
...
GLOBAL_LIST_INIT(specialist_clothes_listed_products, list(
		/obj/effect/vendor_bundle/basic_specialist = list(CAT_STD, "Standard Sneaking Suit kit", 0, "white"),
		/obj/effect/vendor_bundle/basic_specialist/tback = list(CAT_STD, "Standard Leotard Sneaking Suit kit", 0, "white"),
...
GLOBAL_LIST_INIT(synthetic_clothes_listed_products, list(
		...
		/obj/item/clothing/under/marine/whites = list(CAT_STD, "NTC dress uniform", 0, "black"),
		...
		/obj/item/clothing/suit/storage/RO = list(CAT_SMR, "NTC RO Jacket", 0, "synth-cosmetic"),
		...
		/obj/item/clothing/head/tgmccap = list(CAT_SHN, "NTC cap", 0, "black"),
