...
GLOBAL_LIST_INIT(specialist_gear_listed_products, list(
	...
	/obj/item/storage/box/crate/heavy_grenadier = list(CAT_SPSUP, "Heavy Grenadier Pack", 30, "black"),
	...
	/obj/item/clothing/glasses/night/m42_night_goggles = list(CAT_CDSUP, "M42 Night Vision Goggles", 15, "orange"),
	/obj/item/storage/box/crate/loot/operator_pack = list(CAT_SPSUP, "Operator Pack (PR-412E + AP & Incen Mags)", 30, "orange"),
	/obj/item/storage/box/crate/loot/m25e_pack = list(CAT_SPSUP, "CQC Pack (SMG-25BE + AP-Mags)", 25, "orange"),
	...
	/obj/item/storage/box/crate/m42c_system_Jungle  = list(CAT_SPSUP, "Anti Material Rifle Pack (AMR + Mixed Ammo + NVG Scope)", 30, "black"),
	/obj/item/storage/box/crate/loot/targetrifle_pack_spec = list(CAT_SPSUP, "SG-62 Target Rifle (SG-153 + Mixed Ammo) Pack", 15, "black"),
	/obj/item/storage/box/crate/loot/infiltration_pack_spec = list(CAT_SPSUP, "Infiltrator Pack (Abduction gear + NVG + tranq pistol + scout cloak)", 40, "black"),
	/obj/item/storage/box/crate/loot/infiltration_lethal_pack_spec = list(CAT_SPSUP, "Assassin Pack (Lethal gear + NVG + P-1911 + scout cloak)", 40, "black"),
...
GLOBAL_LIST_INIT(commanddoll_gear_listed_products, list(
	...
	/obj/item/storage/box/crate/loot/operator_pack = list(CAT_SPSUP, "Operator Pack (PR-412E + AP & Incen Mags)", 25, "orange"),
	/obj/item/storage/box/crate/loot/m25e_pack = list(CAT_SPSUP, "CQC Pack (SMG-25BE + AP-Mags)", 20, "orange"),
	/obj/item/storage/box/crate/loot/scoutrifle_pack_spec = list(CAT_SPSUP, "Scout Rifle Pack (BR-8 + Mixed Mags + Packet + NVG)", 15, "orange"),
	/obj/item/storage/box/crate/loot/targetrifle_pack_spec = list(CAT_CDSUP, "SG-62 Target Rifle (SG-153 + Mixed Ammo) Pack", 10, "black"),
	/obj/item/storage/box/crate/loot/infiltration_pack_spec = list(CAT_CDSUP, "Nonlethal Pack (Nonlethal gear + NVG + tranq pistol + scout cloak)", 35, "black"),
	/obj/item/storage/box/crate/loot/infiltration_lethal_pack_spec = list(CAT_CDSUP, "Assassin Pack (Lethal gear + NVG + P-1911 + scout cloak)", 35, "black"),
