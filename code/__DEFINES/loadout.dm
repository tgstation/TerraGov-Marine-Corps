...
GLOBAL_LIST_INIT(specialist_gear_listed_products, list(
	...
	/obj/item/binoculars/tactical/scout = list(CAT_ESS, "Tactical Scout binoculars", 0, "white"),
	/obj/item/weapon/gun/rifle/m412/elite = list(CAT_SPSUP, "PR-412E Battle Rifle", 10, "orange"),
	/obj/item/storage/box/crate/loot/scoutrifle_pack = list(CAT_SPSUP, "Scout Rifle Pack", 25, "orange"),
	/obj/item/storage/box/crate/loot/autosniper_pack = list(CAT_SPSUP, "Autosniper Pack", 30, "orange"),
	/obj/item/storage/box/crate/heavy_armor = list(CAT_SPSUP, "Heavy Armor Pack", 15, "orange"),
	/obj/item/storage/backpack/marine/satchel/scout_cloak/scout = list(CAT_SPSUP, "Scout Cloak", 15, "white"),
	/obj/item/storage/backpack/marine/satchel/scout_cloak/sniper = list(CAT_SPSUP, "Sniper Cloak", 15, "white"),
	/obj/item/storage/box/crate/heavy_grenadier = list(CAT_SPSUP, "Heavy Grenadier Pack", 15, "white"),
	/obj/item/weapon/gun/rifle/standard_smarttargetrifle = list(CAT_SPSUP, "SG-62 Target Rifle (with SG-153 Spotting rifle underbarrel)", 25, "orange"),
	/obj/item/attachable/scope/nightvision = list(CAT_SPSUP, "T-46 Nightvision Scope", 3, "white"),
	/obj/item/clothing/glasses/thermal/m64_thermal_goggles = list(CAT_SPSUP, "M64 Thermal Goggles", 10, "white"),
	/obj/item/ammo_magazine/rifle/standard_smarttargetrifle = list(CAT_SPSUP, "SG-62 Target Rifle Magazine", 1, "orange"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle = list(CAT_SPSUP, "SG-153 Spotting Rifle Magazine", 2, "black"),
	/obj/item/ammo_magazine/rifle/ap = list(CAT_SPSUP, "M412 Armor Piercing Magazine", 1, "orange"),
	...
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/plasmaloss = list(CAT_SPSUP, "SG-153 Spotting Rifle Tanglefoot Magazine", 3, "black"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/incendiary = list(CAT_SPSUP, "SG-153 Spotting Rifle Incendiary Magazine", 3, "black"),
	/obj/item/ammo_magazine/rifle/autosniper = list(CAT_SPSUP, "SR-81 Autosniper Magazine", 2, "orange"),
	/obj/item/ammo_magazine/packet/autosniper = list(CAT_SPSUP, "Box of low-pressure 8.6x70mm", 3, "orange"),
	/obj/item/ammo_magazine/rifle/tx8 = list(CAT_SPSUP, "BR-8 High Velocity Magazine", 1, "orange"),
