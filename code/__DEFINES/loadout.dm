...
GLOBAL_LIST_INIT(smartgunner_gear_listed_products, list(
	...
	/obj/item/weapon/gun/minigun/smart_microgun = list(CAT_LEDSUP, "T-85 Microgun", 30 , "white"),
	/obj/item/ammo_magazine/minigun_powerpack/smartgun = list(CAT_LEDSUP, "T-85 powerpack", 10, "black"),
	/obj/item/ammo_magazine/packet/t25 = list(CAT_LEDSUP, "Smartgun ammo box", 6 , "black"),
	))
