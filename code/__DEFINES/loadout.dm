...
GLOBAL_LIST_INIT(commanddoll_gear_listed_products, list(
	...
	/obj/item/storage/box/crate/loot/infiltration_pack_spec = list(CAT_CDSUP, "Nonlethal Pack (Nonlethal gear + NVG + tranq pistol + scout cloak)", 30, "black"),
	/obj/item/storage/box/crate/loot/infiltration_lethal_pack_spec = list(CAT_CDSUP, "Assassin Pack (Lethal gear + NVG + P-1911 + scout cloak)", 30, "black"),
