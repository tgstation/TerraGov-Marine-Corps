...
GLOBAL_LIST_INIT(marine_clothes_listed_products, list(
		...
		/obj/effect/vendor_bundle/jaeger_hell_jumper = list(CAT_AMR, "Jaeger EVA medium armor kit", 0, "orange"),
		...
		/obj/item/clothing/suit/modular/robot/light = list(CAT_AMR, "Combat robot light armor plating", 0, "black"),
		/obj/item/clothing/suit/modular/robot = list(CAT_AMR, "Combat robot medium armor plating", 0, "black"),
		/obj/item/clothing/suit/modular/robot/heavy = list(CAT_AMR, "Combat robot heavy armor plating", 0, "black"),
		...
		/obj/item/clothing/head/modular/robot/light = list(CAT_HEL, "Light head robotic armor plating", 0, "black"),
		/obj/item/clothing/head/modular/robot = list(CAT_HEL, "Medium head robotic armor plating", 0, "black"),
		/obj/item/clothing/head/modular/robot/heavy = list(CAT_HEL, "Heavy head robotic armor plating", 0, "black"),
