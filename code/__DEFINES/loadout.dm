...
GLOBAL_LIST_INIT(specialist_gear_listed_products, list(
	...
	/obj/item/storage/box/crate/loot/operator_pack = list(CAT_SPSUP, "Operator Pack (PR-412E + AP&Incen Mags + Scout Sight)", 40, "orange"),
	/obj/item/storage/box/crate/loot/m25e_pack = list(CAT_SPSUP, "CQC Pack (SMG-25BE + AP-Mags + Thermal Sight)", 30, "orange"),
