...
GLOBAL_LIST_INIT(medic_gear_listed_products, list(
		...
		/obj/item/storage/syringe_case/combat = list(CAT_MEDSUP, "Combat autoinjector case", 3, "black"),
		/obj/item/storage/syringe_case = list(CAT_MEDSUP, "Empty autoinjector case", 2, "black"),
