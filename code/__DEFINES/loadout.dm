...
GLOBAL_LIST_INIT(synthetic_clothes_listed_products, list(
		...
		/obj/item/clothing/suit/storage/wizrobe/marisa/fake = list(CAT_SMR, "Witch's robe", 0, "synth-storage"),
		...
		/obj/item/clothing/head/wizard/marisa/fake = list(CAT_SHN, "Witch hat", 0, "black"),
