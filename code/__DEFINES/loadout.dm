...
GLOBAL_LIST_INIT(engineer_gear_listed_products, list(
		...
		/obj/item/storage/box/explosive_mines/claymore/large = list(CAT_ENGSUP, "Large M20 mine box", 35, "engi-explosive"),
		/obj/item/storage/box/explosive_mines/claymore = list(CAT_ENGSUP, "M20 mine box", 18, "engi-explosive"),
