...
GLOBAL_LIST_INIT(specialist_gear_listed_products, list(
	...
	/obj/item/storage/box/crate/loot/targetrifle_pack_spec = list(CAT_SPSUP, "SG-62 Target Rifle (SG-153 + Mixed Ammo) Pack", 15, "orange"),
...
GLOBAL_LIST_INIT(commanddoll_gear_listed_products, list(
	...
	/obj/item/storage/box/crate/loot/targetrifle_pack_spec = list(CAT_CDSUP, "SG-62 Target Rifle (SG-153 + Mixed Ammo) Pack", 15, "orange"),
