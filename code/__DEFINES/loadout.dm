...
GLOBAL_LIST_INIT(specialist_gear_listed_products, list(
	...
	/obj/item/storage/box/crate/loot/infiltration_pack_spec = list(CAT_CDSUP, "Infiltrator Pack (Abduction gear + NVG + tranq pistol + scout cloak)", 40, "black"),
	/obj/item/storage/box/crate/loot/infiltration_lethal_pack_spec = list(CAT_CDSUP, "Assassin Pack (Lethal gear + NVG + P-1911 + scout cloak)", 40, "black"),
