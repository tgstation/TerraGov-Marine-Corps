...
GLOBAL_LIST_INIT(medic_gear_listed_products, list(
		...
		/obj/item/reagent_containers/hypospray/advanced/big = list(CAT_MEDSUP, "Big hypospray", 2, "orange"),
...
GLOBAL_LIST_INIT(marine_clothes_listed_products, list(
		...
		/obj/item/storage/pouch/shotgun = list(CAT_POU, "Shotgun shell pouch", 1, "black"),
		/obj/item/storage/pouch/magazine/large = list(CAT_POU, "Magazine pouch", 1, "black"),
		/obj/item/storage/pouch/flare/full = list(CAT_POU, "Flare pouch", 1, "orange"),
		/obj/item/storage/pouch/medkit/firstaid = list(CAT_POU, "First aid pouch", 1,"orange"),
		/obj/item/storage/pouch/medical_injectors/firstaid = list(CAT_POU, "Combat injector pouch", 1,"orange"),
		/obj/item/storage/pouch/tools/full = list(CAT_POU, "Tool pouch (tools included)", 1,"black"),
		/obj/item/storage/pouch/grenade/slightlyfull = list(CAT_POU, "Grenade pouch (grenades included)", 1,"black"),
		/obj/item/storage/pouch/construction/full = list(CAT_POU, "Construction pouch (materials included)", 1,"black"),
		/obj/item/storage/pouch/magazine/pistol/large = list(CAT_POU, "Pistol magazine pouch", 1,"black"),
		/obj/item/storage/pouch/pistol = list(CAT_POU, "Sidearm pouch", 1,"black"),
...
GLOBAL_LIST_INIT(engineer_clothes_listed_products, list(
		...
		/obj/item/armor_module/storage/engineering = list(CAT_MOD, "Engineering Storage Module", 0, "black"),
		/obj/item/storage/pouch/shotgun = list(CAT_POU, "Shotgun shell pouch", 1, "black"),
		/obj/item/storage/pouch/construction = list(CAT_POU, "Construction pouch", 1, "orange"),
		/obj/item/storage/pouch/explosive = list(CAT_POU, "Explosive pouch", 1, "black"),
		/obj/item/storage/pouch/tools/full = list(CAT_POU, "Tools pouch", 1, "black"),
		/obj/item/storage/pouch/grenade/slightlyfull = list(CAT_POU, "Grenade pouch (grenades included)", 1,"black"),
		/obj/item/storage/pouch/electronics/full = list(CAT_POU, "Electronics pouch", 1, "black"),
		/obj/item/storage/pouch/magazine/large = list(CAT_POU, "Magazine pouch", 1, "black"),
		/obj/item/storage/pouch/general/medium = list(CAT_POU, "Medium general pouch", 1, "black"),
		/obj/item/storage/pouch/flare/full = list(CAT_POU, "Flare pouch", 1, "black"),
		/obj/item/storage/pouch/medkit/firstaid = list(CAT_POU, "First aid pouch", 1, "orange"),
		/obj/item/storage/pouch/medical_injectors/firstaid = list(CAT_POU, "Combat injector pouch", 1,"orange"),
		/obj/item/storage/pouch/magazine/pistol/large = list(CAT_POU, "Pistol magazine pouch", 1, "black"),
		/obj/item/storage/pouch/pistol = list(CAT_POU, "Sidearm pouch", 1, "black"),
...
GLOBAL_LIST_INIT(medic_clothes_listed_products, list(
		...
		/obj/item/armor_module/storage/general = list(CAT_MOD, "General Purpose Storage Module", 0, "black"),
		/obj/item/armor_module/storage/engineering = list(CAT_MOD, "Engineering Storage Module", 0, "black"),
		/obj/item/storage/pouch/medical_injectors/medic = list(CAT_POU, "Advanced Autoinjector pouch", 1, "orange"),
		/obj/item/storage/pouch/medkit/medic = list(CAT_POU, "Medkit pouch", 1, "orange"),
		/obj/effect/essentials_set/mimir = list(CAT_ARMMOD, "Mark 1 Mimir Resistance set", 0,"black"),
		/obj/item/armor_module/module/ballistic_armor = list(CAT_ARMMOD, "Hod Accident Prevention Plating", 0,"black"),
		/obj/effect/essentials_set/tyr = list(CAT_ARMMOD, "Mark 1 Tyr extra armor set", 0,"black"),
		/obj/item/armor_module/module/better_shoulder_lamp = list(CAT_ARMMOD, "Baldur light armor module", 0,"black"),
...
GLOBAL_LIST_INIT(leader_clothes_listed_products, list(
		...
		/obj/item/armor_module/storage/engineering = list(CAT_MOD, "Engineering Storage Module", 0, "black"),
		/obj/item/storage/pouch/shotgun = list(CAT_POU, "Shotgun shell pouch", 1, "black"),
		/obj/item/storage/pouch/general/large = list(CAT_POU, "General pouch", 1, "black"),
		/obj/item/storage/pouch/magazine/large = list(CAT_POU, "Magazine pouch", 1, "black"),
		/obj/item/storage/pouch/flare/full = list(CAT_POU, "Flare pouch", 1, "black"),
...
GLOBAL_LIST_INIT(synthetic_clothes_listed_products, list(
		...
		/obj/item/storage/pouch/general/large = list(CAT_POU, "General pouch", 1, "black"),
		/obj/item/storage/pouch/tools/full = list(CAT_POU, "Tool pouch", 1, "black"),
		/obj/item/storage/pouch/construction/full = list(CAT_POU, "Construction pouch", 1, "black"),
		/obj/item/storage/pouch/electronics/full = list(CAT_POU, "Electronics pouch", 1, "black"),
		/obj/item/storage/pouch/medkit/medic = list(CAT_POU, "Medkit pouch", 1, "black"),
		/obj/item/storage/pouch/surgery = list(CAT_WEB, "White surgical pouch", 1, "black"),
		/obj/item/storage/pouch/flare/full = list(CAT_POU, "Flare pouch", 1, "black"),
		/obj/item/storage/pouch/radio = list(CAT_POU, "Radio pouch", 1, "black"),
		/obj/item/storage/pouch/field_pouch/full = list(CAT_POU, "Field pouch", 1, "black"),
