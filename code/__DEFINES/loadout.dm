...
GLOBAL_LIST_INIT(specialist_gear_listed_products, list(
	...
	/obj/item/storage/box/crate/m42c_system_Jungle  = list(CAT_SPSUP, "Anti Material Rifle Pack (AMR + Mixed Ammo + Thermals)", 35, "black"),
	/obj/item/storage/box/crate/loot/targetrifle_pack_spec = list(CAT_SPSUP, "SG-62 Target Rifle (SG-153 + Mixed Ammo) Pack", 15, "black"),
	/obj/item/storage/box/crate/loot/infiltration_pack_spec = list(CAT_SPSUP, "Infiltrator Pack (Abduction gear + NVG + tranq pistol + scout cloak)", 35, "black"),
	/obj/item/storage/box/crate/loot/infiltration_lethal_pack_spec = list(CAT_SPSUP, "Assassin Pack (Lethal gear + NVG + P-1911 + scout cloak)", 35, "black"),
