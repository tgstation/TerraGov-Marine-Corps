...
#define SKILL_MEDICAL_NOVICE	1 // recognizing chemicals, using autoinjectors & hyposprays with any chemicals (SL)
#define SKILL_MEDICAL_PRACTICED	2 //syringe use & defib use (Squad Corpsman)
