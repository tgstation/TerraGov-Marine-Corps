...
#define INTERACT_MACHINE_NANO		(INTERACT_REQUIRES_DEXTERITY|INTERACT_CHECK_INCAPACITATED|INTERACT_SILICON_ALLOWED|INTERACT_UI_INTERACT)
#define INTERACT_OBJ_DEFAULT		(INTERACT_REQUIRES_DEXTERITY|INTERACT_CHECK_INCAPACITATED)
#define INTERACT_OBJ_NANO			(INTERACT_REQUIRES_DEXTERITY|INTERACT_CHECK_INCAPACITATED|INTERACT_UI_INTERACT)
