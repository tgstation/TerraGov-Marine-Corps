...
#define COMSIG_CHEM_BOOSTER_ON_OFF "chem_booster_on_off"		//from base of on_off(): (/datum/component/chem_booster, boost_on)
#define COMSIG_CHEM_BOOSTER_RES_UPD "chem_booster_res_upd"
