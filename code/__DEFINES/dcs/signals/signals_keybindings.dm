...
#define COMSIG_XENOABILITY_ACID_DASH_THIOACETIC "xenoability_acid_dash_acidder"
...
#define COMSIG_XENOABILITY_ACID_SHROUD_THIOACETIC "xenoability_acid_shroud_acidder"
