...
#define COMSIG_XENOABILITY_ACID_DASH_ACIDDER "xenoability_acid_dash_acidder"
...
#define COMSIG_XENOABILITY_ACID_SHROUD_ACIDDER "xenoability_acid_shroud_acidder"
