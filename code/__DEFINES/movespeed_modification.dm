...
#define MOVESPEED_ID_DRAGON_PSYCHIC_CHANNEL "DRAGON_PSYCHIC_CHANNEL"
#define MOVESPEED_ID_DRAGON_UNLEASH "DRAGON_UNLEASH"
#define MOVESPEED_ID_DRAGON_UNLEASH_WITHDRAWAL "DRAGON_UNLEASH_WITHDRAWAL"
