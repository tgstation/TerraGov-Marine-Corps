...
#define INDIVIDUAL_ROLEPLAY_LOG (LOG_SAY | LOG_WHISPER | LOG_DSAY | LOG_PRAYER | LOG_SPEECH_INDICATORS | LOG_EMOTE | LOG_HIVEMIND | LOG_TELECOMMS | LOG_OOC | LOG_LOOC | LOG_XOOC | LOG_MOOC)
#define INDIVIDUAL_EMOTE_LOG (LOG_SAY | LOG_EMOTE)
