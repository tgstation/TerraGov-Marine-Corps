...
#define LOG_XMOOC (1 << 12)
#define LOG_ADMIN (1 << 13)
#define LOG_GAME (1 << 14)
#define LOG_ADMIN_PRIVATE (1 << 15)
#define LOG_ASAY (1 << 16)
#define LOG_MSAY (1 << 17)
#define LOG_MECHA (1 << 18)
#define LOG_SPEECH_INDICATORS (1 << 19)
#define LOG_VICTIM (1 << 20)
#define LOG_TRANSPORT (1<<21)
...
#define INDIVIDUAL_ROLEPLAY_LOG (LOG_SAY | LOG_WHISPER | LOG_DSAY | LOG_PRAYER | LOG_SPEECH_INDICATORS | LOG_EMOTE | LOG_HIVEMIND | LOG_TELECOMMS | LOG_OOC | LOG_LOOC | LOG_XOOC | LOG_MOOC | LOG_XMOOC)
#define INDIVIDUAL_EMOTE_LOG (LOG_EMOTE)
#define INDIVIDUAL_COMMS_LOG (LOG_HIVEMIND | LOG_TELECOMMS)
#define INDIVIDUAL_OOC_LOG (LOG_OOC | LOG_LOOC | LOG_XOOC | LOG_MOOC | LOG_XMOOC | LOG_ADMIN)
#define INDIVIDUAL_SHOW_ALL_LOG (LOG_ATTACK | LOG_SAY | LOG_WHISPER | LOG_EMOTE | LOG_HIVEMIND | LOG_DSAY | LOG_TELECOMMS | LOG_OOC | LOG_LOOC | LOG_XOOC | LOG_MOOC | LOG_XMOOC | LOG_ADMIN | LOG_GAME | LOG_ADMIN_PRIVATE | LOG_ASAY | LOG_MSAY | LOG_MECHA | LOG_SPEECH_INDICATORS | LOG_VICTIM)
...
#define LOG_CATEGORY_GAME_XMOOC "game-xmooc"
