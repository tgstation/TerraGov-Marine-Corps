...
#define INDIVIDUAL_SHOW_ALL_LOG (LOG_ATTACK | LOG_SAY | LOG_WHISPER | LOG_EMOTE | LOG_HIVEMIND | LOG_DSAY | LOG_TELECOMMS | LOG_OOC | LOG_LOOC | LOG_XOOC | LOG_MOOC | LOG_ADMIN | LOG_GAME | LOG_ADMIN_PRIVATE | LOG_ASAY | LOG_MSAY | LOG_MECHA | LOG_SPEECH_INDICATORS | LOG_VICTIM | LOG_XMOOC)
