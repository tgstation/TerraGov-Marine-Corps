...
var/list/first_names_male_clf = file2list("config/names/first_male_clf.txt")
var/list/first_names_female_clf = file2list("config/names/first_female_clf.txt")
...
var/list/last_names_clf = file2list("config/names/last_name_clf.txt")
