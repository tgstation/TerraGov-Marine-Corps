...
/datum/component/fov_handler/RegisterWithParent()
	...
	RegisterSignal(parent, COMSIG_MOB_DEATH, PROC_REF(update_mask))
	RegisterSignal(parent, COMSIG_MOB_REVIVE, PROC_REF(update_mask))
...
/datum/component/fov_handler/UnregisterFromParent()
	. = ..()
	UnregisterSignal(parent, list(COMSIG_MOB_RESET_PERSPECTIVE, COMSIG_ATOM_DIR_CHANGE, COMSIG_MOB_DEATH, COMSIG_MOB_REVIVE, COMSIG_MOB_LOGOUT))
