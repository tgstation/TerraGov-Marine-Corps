...
/datum/component/automatedfire/autofire/Initialize(_auto_fire_shot_delay = 0.3 SECONDS, _auto_burst_fire_shot_delay, _burstfire_shot_delay, _burst_shots_to_fire = 3, _fire_mode = GUN_FIREMODE_SEMIAUTO, datum/callback/_callback_bursting, datum/callback/_callback_reset_fire, datum/callback/_callback_fire)
	...
	RegisterSignal(parent, COMSIG_GUN_AUTOBURSTDELAY_MODIFIED, .proc/modify_autoburst_shot_delay)
	...
	auto_burst_fire_shot_delay = _auto_burst_fire_shot_delay * auto_fire_shot_delay
...
/datum/component/automatedfire/autofire/proc/modify_autoburst_shot_delay(datum/source, _auto_burst_fire_shot_delay)
	SIGNAL_HANDLER
