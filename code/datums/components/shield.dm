...
/datum/component/shield/Initialize(shield_flags, shield_soft_armor, shield_hard_armor, shield_cover = list("melee" = 80, "bullet" = 100, "laser" = 100, "energy" = 100, "bomb" = 80, "bio" = 30, "rad" = 0, BURN = 80, "acid" = 80))
	. = ..()
	if(!isitem(parent))
...
/datum/component/shield/overhealth
	layer = 100
	cover = list("melee" = 0, "bullet" = 80, "laser" = 100, "energy" = 100, "bomb" = 0, "bio" = 0, "rad" = 0, BURN = 0, "acid" = 80)
