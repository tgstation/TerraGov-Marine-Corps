...
/datum/component/jump/Initialize(_jump_duration = 0.5 SECONDS, _jump_cooldown = 1 SECONDS, _stamina_cost = 8, _jump_height = 16, _jump_sound = null, _jump_flags = JUMP_SHADOW, _jumper_flags_pass = PASSTABLE|PASSFIRE)
	. = ..()
	if(!isliving(parent))
