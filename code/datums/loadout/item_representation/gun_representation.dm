...
/datum/item_representation/gun/instantiate_object(datum/loadout_seller/seller, master = null, datum/loadout/loadout = null)
	. = ..()
	if(!.)
		return
	for(var/datum/item_representation/gun_attachement/gun_attachement AS in attachments)
		gun_attachement.install_on_gun(seller, ., loadout)
...
/datum/item_representation/gun_attachement/proc/install_on_gun(seller, obj/item/weapon/gun/gun_to_attach, datum/loadout/loadout)
	...
	var/obj/item/attachable/attachment = instantiate_object(seller, null, loadout)
...
/datum/item_representation/handful_representation/instantiate_object(datum/loadout_seller/seller, master = null, datum/loadout/loadout = null)
	. = ..()
	if(!.)
		return
