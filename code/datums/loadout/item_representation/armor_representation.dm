...
/datum/item_representation/suit_with_storage/instantiate_object(datum/loadout_seller/seller, master, datum/loadout/loadout)
	...
	suit.pockets = pockets.instantiate_object(seller, suit, loadout)
...
/datum/item_representation/modular_armor/instantiate_object(datum/loadout_seller/seller, master = null, datum/loadout/loadout = null)
	. = ..()
	if(!.)
		return
	...
	if(installed_storage)
		...
		modular_armor.storage = storage_implementation.instantiate_object(seller, modular_armor, loadout)
...
/datum/item_representation/armor_module/proc/install_on_armor(datum/loadout_seller/seller, obj/item/clothing/suit/modular/armor, datum/loadout/loadout)
	var/obj/item/armor_module/module = instantiate_object(seller, null, loadout)
...
/datum/item_representation/armor_module/colored/instantiate_object(datum/loadout_seller/seller, master = null, datum/loadout/loadout = null)
	. = ..()
	if(!.)
		return
