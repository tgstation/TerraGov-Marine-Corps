...
/datum/item_representation/suit_with_storage/instantiate_object(datum/loadout_seller/seller, master = null, datum/loadout/loadout, mob/user)
	...
	suit.pockets = pockets.instantiate_object(seller, suit, loadout, user)
...
/datum/item_representation/modular_armor/instantiate_object(datum/loadout_seller/seller, master = null, datum/loadout/loadout, mob/user)
	...
	for(var/key in armor_modules)
		...
		armor_module.install_on_armor(seller, modular_armor, loadout, user)
	installed_module?.install_on_armor(seller, modular_armor, loadout, user)
	if(installed_storage)
		installed_storage.install_on_armor(seller, modular_armor, loadout, user)
		modular_armor.storage = storage_implementation.instantiate_object(seller, modular_armor, loadout, user)
...
/datum/item_representation/armor_module/proc/install_on_armor(datum/loadout_seller/seller, obj/item/clothing/suit/modular/armor, datum/loadout/loadout, mob/user)
	var/obj/item/armor_module/module = instantiate_object(seller, null, loadout, user)
