...
/datum/wires/proc/cut(wire, mob/user)
	if(user && !HAS_SKILL_LEVEL(user, SKILL_ENGINEERING, SKILL_LEVEL_PROFESSIONAL))
		...
		var/fumbling_time = 20 * D_GET_SKILL_DIFF(user, SKILL_ENGINEERING, SKILL_LEVEL_PROFESSIONAL)
