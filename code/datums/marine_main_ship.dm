...
/datum/marine_main_ship/proc/make_maint_all_access()
	...
	priority_announce("The maintenance access requirement has been revoked on all airlocks.", "Attention:", sound = 'sound/misc/notice1.ogg', color_override = "grey")

/datum/marine_main_ship/proc/revoke_maint_all_access()
	maint_all_access = FALSE
	priority_announce("The maintenance access requirement has been readded on all maintenance airlocks.", "Attention:", sound = 'sound/misc/notice2.ogg', color_override = "grey")
