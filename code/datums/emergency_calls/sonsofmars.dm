...
/datum/emergency_call/som/create_member(datum/mind/M)
	...
	if(medics < max_medics)
		...
		J.equip(H)
		to_chat(H, "<span class='notice'>You are a Sons of Mars medic assigned to this fireteam to respond to the TGN distress signal. Keep your squad alive in this fight!</span>")
		medics++
		return
	...
	if(prob(20))
		...
		J.equip(H)
		to_chat(H, "<span class='notice'>You are a veteran of the Sons of Mars and are assigned to this fireteam to respond to the TGN distress signal sent out nearby. Do them proud and kill all who stand in your teams way!</span>")
		return
