/datum/game_mode/extended
	...
	valid_job_types = list(
		...
		/datum/job/som/commander = 1,
		/datum/job/job/som/fieldcommander = 1,
		/datum/job/job/som/squadcorpsman = 1,
		/datum/job/job/som/squadengineer = 1,
		/datum/job/job/som/squadleader = 1,
		/datum/job/job/som/squadveteran = 1,
		/datum/job/job/som/squadstandard = 5,
