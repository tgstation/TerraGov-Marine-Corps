/datum/game_mode/search_and_destroy
	name = "Search and Destroy"
	config_tag = "Search and Destroy"
	...
	valid_job_types = list(
		...
		/datum/job/som/leader = 4
		/datum/job/som/veteran = 8
		/datum/job/som/medic = 8
...
/datum/game_mode/search_and_destroy/post_setup()
	. = ..()
...
/datum/game_mode/search_and_destroy/announce()
...
/datum/game_mode/search_and_destroy/set_valid_squads()
...
/datum/game_mode/search_and_destroy/get_joinable_factions(should_look_balance)
...
/datum/game_mode/search_and_destroy/check_finished()
	if(round_finished)
		return TRUE
...
/datum/game_mode/search_and_destroy/declare_completion()
	. = ..()
