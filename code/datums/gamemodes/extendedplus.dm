/datum/game_mode/infestation/extended_plus
	...
	valid_job_types = list(
		...
		/datum/job/pmc/squad/standard = 6,
		/datum/job/pmc/squad/medic = 2,
		/datum/job/pmc/squad/gunner = 2,
		/datum/job/pmc/squad/sniper = 2,
		/datum/job/pmc/squad/leader = 2,
		/datum/job/vsd_squad/standard = 4,
		/datum/job/vsd_squad/medic = 2,
		/datum/job/vsd_squad/engineer = 2,
		/datum/job/vsd_squad/spec = 1,
		/datum/job/vsd_squad/leader = 1,
		/datum/job/usl_squad/standard = 4,
		/datum/job/usl_squad/spec = 1,
		/datum/job/usl_squad/leader = 1,
		/datum/job/icc_squad/standard = 8,
