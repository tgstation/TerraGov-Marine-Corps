...
/datum/campaign_mission/capture_mission/asat
	...
	starting_faction_mission_brief = "A NTC ASAT battery has been detected in this location. It forms part if their space defense grid across the planet and so is a valuable installation to them. \
	...
	starting_faction_additional_rewards = "Additional ICC support, ability to counteract NTC drop pod usage"
