...
/datum/loadout_item/suit_store/main_gun/corpsman/laser_carbine/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout)
	...
	if(!istype(wearer.back, /obj/item/storage/backpack/marine/corpsman/satchel))
		wearer.equip_to_slot_or_del(new /obj/item/reagent_containers/hypospray/autoinjector/quickclotplus, ITEM_SLOT_BACK, FALSE, TRUE)
		wearer.equip_to_slot_or_del(new /obj/item/reagent_containers/hypospray/autoinjector/peridaxon_plus, ITEM_SLOT_BACK, FALSE, TRUE)
		wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/sticky, ITEM_SLOT_BACK, FALSE, TRUE)
...
/datum/loadout_item/suit_store/main_gun/corpsman/laser_rifle/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout)
	...
	if(!istype(wearer.back, /obj/item/storage/backpack/marine/corpsman/satchel))
		wearer.equip_to_slot_or_del(new /obj/item/reagent_containers/hypospray/autoinjector/quickclotplus, ITEM_SLOT_BACK, FALSE, TRUE)
		wearer.equip_to_slot_or_del(new /obj/item/reagent_containers/hypospray/autoinjector/peridaxon_plus, ITEM_SLOT_BACK, FALSE, TRUE)
		wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/flamer_tank/mini, ITEM_SLOT_BACK, FALSE, TRUE)
		wearer.equip_to_slot_or_del(new /obj/item/storage/box/MRE, ITEM_SLOT_BACK, FALSE, TRUE)
		wearer.equip_to_slot_or_del(new ammo_type, ITEM_SLOT_BACK, FALSE, TRUE)
