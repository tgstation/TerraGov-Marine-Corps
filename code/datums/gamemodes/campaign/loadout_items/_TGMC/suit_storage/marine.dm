...
/datum/loadout_item/suit_store/main_gun/marine/scout_carbine
	...
	item_whitelist = list(
		/obj/item/clothing/suit/modular/jaeger/light/shield = ITEM_SLOT_OCLOTHING,
		/obj/item/clothing/suit/modular/jaeger/light/shield_overclocked = ITEM_SLOT_OCLOTHING,
	)
