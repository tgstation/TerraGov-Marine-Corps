...
/datum/loadout_item/secondary/kit/som_engineer/barricade_capsule
	name = "Cade Capsule"
	desc = "Three barricade capsules. Used to create instant fortifications in open areas."
	ui_icon = "construction"
	purchase_cost = 30

/datum/loadout_item/secondary/kit/som_engineer/barricade_capsule/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
