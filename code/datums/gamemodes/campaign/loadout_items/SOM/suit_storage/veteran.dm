...
/datum/loadout_item/suit_store/main_gun/som_veteran/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout)
	...
	if(istype(wearer.back, /obj/item/storage))
		if(istype(wearer.belt, /obj/item/storage/holster/belt/pistol/m4a3/som)) //if we have a backpack and pistol belt, we just load more ammo in the back
			...
			wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/som, ITEM_SLOT_BACK, FALSE, TRUE)
			wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/som, ITEM_SLOT_BACK, FALSE, TRUE)
			wearer.equip_to_slot_or_del(new /obj/item/weapon/gun/pistol/som/standard(wearer), ITEM_SLOT_BACK, FALSE, TRUE)
...
/datum/loadout_item/suit_store/main_gun/som_veteran/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/som, ITEM_SLOT_ICLOTHING, FALSE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/som, ITEM_SLOT_ICLOTHING, FALSE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/som, ITEM_SLOT_ICLOTHING, FALSE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/som, ITEM_SLOT_ICLOTHING, FALSE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/incendiary/som, ITEM_SLOT_ICLOTHING, FALSE, TRUE)
...
/datum/loadout_item/suit_store/main_gun/som_veteran/standard_rifle/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout)
	wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/micro_grenade, ITEM_SLOT_ICLOTHING, FALSE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/micro_grenade/dragonbreath, ITEM_SLOT_ICLOTHING, FALSE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/micro_grenade/dragonbreath, ITEM_SLOT_ICLOTHING, FALSE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/micro_grenade/cluster, ITEM_SLOT_ICLOTHING, FALSE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/micro_grenade/cluster, ITEM_SLOT_ICLOTHING, FALSE, TRUE)
...
/datum/loadout_item/suit_store/main_gun/som_veteran/smg/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout)
	...
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/som, ITEM_SLOT_ICLOTHING, FALSE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/incendiary/som, ITEM_SLOT_ICLOTHING, FALSE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/flashbang/stun, ITEM_SLOT_ICLOTHING, FALSE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/storage/box/MRE/som, ITEM_SLOT_ICLOTHING, FALSE, TRUE)
...
/datum/loadout_item/suit_store/main_gun/som_veteran/breacher/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout)
	...
	wearer.equip_to_slot_or_del(new /obj/item/tool/weldingtool/largetank, ITEM_SLOT_BACK, FALSE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/plastique, ITEM_SLOT_BACK, FALSE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/plastique, ITEM_SLOT_BACK, FALSE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/plastique, ITEM_SLOT_BACK, FALSE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/cell/lasgun/volkite, ITEM_SLOT_BACK, FALSE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/cell/lasgun/volkite, ITEM_SLOT_BACK, FALSE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/cell/lasgun/volkite, ITEM_SLOT_BACK, FALSE, TRUE)
	if(!istype(wearer.back, /obj/item/storage/backpack/satchel))
		wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/som, ITEM_SLOT_BACK, FALSE, TRUE)
...
/datum/loadout_item/suit_store/main_gun/som_veteran/volkite_caliver_pack/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout)
	...
	if(istype(wearer.belt, /obj/item/weapon/gun/shotgun/double/sawn))
		wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/buckshot, ITEM_SLOT_ICLOTHING, FALSE, TRUE)
		wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/buckshot, ITEM_SLOT_ICLOTHING, FALSE, TRUE)
		wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/buckshot, ITEM_SLOT_ICLOTHING, FALSE, TRUE)
	else
		wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/som, ITEM_SLOT_ICLOTHING, FALSE, TRUE)
...
/datum/loadout_item/suit_store/main_gun/som_veteran/radioactive_smg/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout)
	wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/packet/p10x20mm, ITEM_SLOT_ICLOTHING, FALSE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/som/incendiary, ITEM_SLOT_ICLOTHING, FALSE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/binoculars, ITEM_SLOT_ICLOTHING, FALSE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/tool/extinguisher/mini, ITEM_SLOT_ICLOTHING, FALSE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/storage/box/MRE/som, ITEM_SLOT_ICLOTHING, FALSE, TRUE)

	if(istype(wearer.belt, /obj/item/storage/belt))
		wearer.equip_to_slot_or_del(new ammo_type, ITEM_SLOT_BELT, FALSE, TRUE)
		wearer.equip_to_slot_or_del(new ammo_type, ITEM_SLOT_BELT, FALSE, TRUE)
		wearer.equip_to_slot_or_del(new ammo_type, ITEM_SLOT_BELT, FALSE, TRUE)
		wearer.equip_to_slot_or_del(new secondary_ammo_type, ITEM_SLOT_BELT, FALSE, TRUE)
		wearer.equip_to_slot_or_del(new secondary_ammo_type, ITEM_SLOT_BELT, FALSE, TRUE)
		wearer.equip_to_slot_or_del(new secondary_ammo_type, ITEM_SLOT_BELT, FALSE, TRUE)
	if(istype(wearer.l_pocket, /obj/item/storage/pouch/magazine))
		...
		wearer.equip_to_slot_or_del(new secondary_ammo_type, ITEM_SLOT_L_POCKET, FALSE, TRUE)
		wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/som/incendiary, ITEM_SLOT_L_POCKET, FALSE, TRUE)
	if(istype(wearer.r_pocket, /obj/item/storage/pouch/magazine))
		...
		wearer.equip_to_slot_or_del(new secondary_ammo_type, ITEM_SLOT_R_POCKET, FALSE, TRUE)
		wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/som/incendiary, ITEM_SLOT_R_POCKET, FALSE, TRUE)

	if(!isstorageobj(wearer.back))
		return

	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/rad, ITEM_SLOT_BACK, FALSE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/rad, ITEM_SLOT_BACK, FALSE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/plastique, ITEM_SLOT_BACK, FALSE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/plastique, ITEM_SLOT_BACK, FALSE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/plastique, ITEM_SLOT_BACK, FALSE, TRUE)
...
/datum/loadout_item/suit_store/energy_sword/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout)
	...
	wearer.equip_to_slot_or_del(new /obj/item/reagent_containers/hypospray/autoinjector/combat_advanced, ITEM_SLOT_BACK, FALSE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/reagent_containers/hypospray/autoinjector/russian_red, ITEM_SLOT_BACK, FALSE, TRUE)
	if(!istype(wearer.back, /obj/item/storage/backpack/satchel))
		wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/som, ITEM_SLOT_BACK, FALSE, TRUE)
		wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/som, ITEM_SLOT_BACK, FALSE, TRUE)
