...
/datum/loadout_item/suit_store/main_gun/som_veteran/standard_rifle/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	...
	if(!istype(wearer.back, /obj/item/storage/backpack/satchel))
		...
		wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/som, ITEM_SLOT_BACK, TRUE, TRUE)
		wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/handful/micro_grenade/cluster, ITEM_SLOT_BACK, TRUE, TRUE)
		wearer.equip_to_slot_or_del(new secondary_ammo_type, ITEM_SLOT_BACK, TRUE, TRUE)
...
/datum/loadout_item/suit_store/main_gun/som_veteran/smg/role_post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	...
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/som, ITEM_SLOT_ICLOTHING, TRUE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/incendiary/som, ITEM_SLOT_ICLOTHING, TRUE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/flashbang/stun, ITEM_SLOT_ICLOTHING, TRUE, TRUE)
...
/datum/loadout_item/suit_store/main_gun/som_veteran/radioactive_smg/post_equip(mob/living/carbon/human/wearer, datum/outfit/quick/loadout, datum/outfit_holder/holder)
	wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/packet/p10x20mm, ITEM_SLOT_ICLOTHING, TRUE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/som/incendiary, ITEM_SLOT_ICLOTHING, TRUE, TRUE)
	...
	wearer.equip_to_slot_or_del(new secondary_ammo_type, ITEM_SLOT_BACK, TRUE, TRUE)
	wearer.equip_to_slot_or_del(new secondary_ammo_type, ITEM_SLOT_BACK, TRUE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/som/incendiary, ITEM_SLOT_BACK, TRUE, TRUE)
	wearer.equip_to_slot_or_del(new /obj/item/ammo_magazine/smg/som/incendiary, ITEM_SLOT_BACK, TRUE, TRUE)
	if(!istype(wearer.back, /obj/item/storage/backpack/satchel))
		wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/rad, ITEM_SLOT_BACK, TRUE, TRUE)
		wearer.equip_to_slot_or_del(new /obj/item/explosive/grenade/rad, ITEM_SLOT_BACK, TRUE, TRUE)
		wearer.equip_to_slot_or_del(new secondary_ammo_type, ITEM_SLOT_BACK, TRUE, TRUE)
		wearer.equip_to_slot_or_del(new ammo_type, ITEM_SLOT_BACK, TRUE, TRUE)
