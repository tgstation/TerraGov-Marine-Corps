...
/datum/campaign_mission/destroy_mission/New(initiating_faction)
	...
	objective_description = list(
		"starting_faction" = "<U>Major Victory</U>:Destroy all [objectives_total] targets.<br> <U>Minor Victory</U>: Destroy at least [min_destruction_amount] targets.",
		"hostile_faction" = "<U>Major Victory</U>: Protect all [objectives_total] assets from destruction.<br> <U>Minor Victory</U>: Protect at least [objectives_total - min_destruction_amount + 1] assets.",
	)
