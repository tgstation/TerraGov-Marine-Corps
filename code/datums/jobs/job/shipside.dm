...
/datum/job/terragov/command/tank_crew
	...
	html_description = {"
		...
		<b>Unlock Requirement</b>: Starting Role<br /><br />
		<b>Gamemode Availability</b>: Distress<br /><br /><br />
		<b>Duty</b>: Placed in control of one of the most powerful tools in the Marine arsenal. Pilot and Man the tank to a Marine Major.
	"}
...
/datum/job/terragov/requisitions/officer
	...
	html_description = {"
		...
		<b>Unlock Requirement</b>: Starting Role<br /><br />
		<b>Gamemode Availability</b>: Distress<br /><br /><br />
		<b>Duty</b>: Requisition supplies to the battlefield. Ensure that the marines are delivering ore to the cargo pad for more points. Supply the marines with deluxe equipment to ensure success.
	"}
