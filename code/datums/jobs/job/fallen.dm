...
/datum/job/fallen/marine
	...
	minimal_access = list(ACCESS_MARINE_PREP, ACCESS_MARINE_SHUTTLE)
...
/datum/job/fallen/marine/engineer
	...
	minimal_access = list(ACCESS_MARINE_PREP, ACCESS_MARINE_ENGPREP, ACCESS_CIVILIAN_ENGINEERING, ACCESS_MARINE_SHUTTLE, ACCESS_MARINE_REMOTEBUILD, ACCESS_MARINE_ENGINEERING)
...
/datum/job/fallen/marine/corpsman
	...
	minimal_access = list(ACCESS_MARINE_PREP, ACCESS_MARINE_MEDPREP, ACCESS_MARINE_MEDBAY, ACCESS_MARINE_CHEMISTRY, ACCESS_MARINE_SHUTTLE)
...
/datum/job/fallen/marine/smartgunner
	...
	minimal_access = list(ACCESS_MARINE_PREP, ACCESS_MARINE_SMARTPREP, ACCESS_MARINE_SHUTTLE)
