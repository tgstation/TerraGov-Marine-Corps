...
//Squad Leader
/datum/job/marine/tfmember
	title = TF_MEMBER
	paygrade = "E5"
	comm_title = "SPEC OPS"
	total_positions = 10
	supervisors = "the acting task force leader"
	access = ALL_PMC_ACCESS
	minimal_access = ALL_PMC_ACCESS
	skills_type = /datum/skills/SL/pmc
	outfit = /datum/outfit/job/marine/tfmember
	larvaworth = LARVA_POINTS_REGULAR


/datum/job/marine/tfmember/radio_help_message(mob/M)
	. = ..()
	to_chat(M, {"\nYou are part of TGMC Task Force ECHO, called in for emergency situations. Assess the situation that the TGMC has on hand.
Always keep your guard up at all times and stay with your squad."})


/datum/outfit/job/marine/tfmember
	name = TF_MEMBER
	jobtype = /datum/job/marine/tfmember

	id = /obj/item/card/id/dogtag
	belt = /obj/item/storage/belt/gun/m4a3/vp78
	ears = /obj/item/radio/headset/distress/PMC
	w_uniform = /obj/item/clothing/under/marine/officer/hos
	shoes = /obj/item/clothing/shoes/marine
	wear_suit = /obj/item/clothing/suit/storage/marine/M3echo
	gloves = /obj/item/clothing/gloves/marine/veteran/PMC
	head = /obj/item/clothing/head/helmet/marine/commando
