...
message = oldreplacetext(message, "l", "r")
message = oldreplacetext(message, "rr", "ru")
message = oldreplacetext(message, "v", "b")
message = oldreplacetext(message, "f", "hu")
message = oldreplacetext(message, "'t", "")
message = oldreplacetext(message, "t ", "to ")
message = oldreplacetext(message, " I ", " ai ")
message = oldreplacetext(message, "th", "z")
message = oldreplacetext(message, "ish", "isu")
message = oldreplacetext(message, "is", "izu")
message = oldreplacetext(message, "ziz", "zis")
message = oldreplacetext(message, "se", "su")
message = oldreplacetext(message, "br", "bur")
message = oldreplacetext(message, "ry", "ri")
message = oldreplacetext(message, "you", "yuu")
message = oldreplacetext(message, "ck", "cku")
message = oldreplacetext(message, "eu", "uu")
message = oldreplacetext(message, "ow", "au")
message = oldreplacetext(message, "are", "aa")
message = oldreplacetext(message, "ay", "ayu")
message = oldreplacetext(message, "ea", "ii")
message = oldreplacetext(message, "ch", "chi")
message = oldreplacetext(message, "than", "sen")
message = oldreplacetext(message, ".", "")
