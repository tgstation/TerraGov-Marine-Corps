		...
		steal
			...
			*/
			...
			/*burger
				...
				explanation_text = "Steal a burger made out of human organs, this will be presented as proof of Weyland-Yutani's chronic lack of standards."
				weight = 60
			...
			/*magboots
				...
				explanation_text = "Steal a pair of \"Weyland-Yutani\" brand magboots."
				weight = 20
