...
/proc/setupcorpses()
	for (var/obj/effect/landmark/A in landmarks_list)
		...
		if (A.name == "Corpse-Engineer")
			...
			M.equip_to_slot_or_del(new /obj/item/device/pda/engineering(M), WEAR_WAIST)
			M.equip_to_slot_or_del(new /obj/item/clothing/under/rank/engineer(M), WEAR_BODY)
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/orange(M), WEAR_FEET)
		//	M.equip_to_slot_or_del(new /obj/item/weapon/storage/toolbox/mechanical(M), WEAR_L_HAND)
			M.equip_to_slot_or_del(new /obj/item/clothing/gloves/yellow(M), WEAR_HANDS)
			M.equip_to_slot_or_del(new /obj/item/device/t_scanner(M), WEAR_R_STORE)
			...
			if (prob(50))
				M.equip_to_slot_or_del(new /obj/item/clothing/head/helmet/hardhat(M), WEAR_HEAD)
			else
				if (prob(50))
					M.equip_to_slot_or_del(new /obj/item/clothing/head/helmet/welding(M), WEAR_HEAD)
			cdel(A)
			continue
		if (A.name == "Corpse-Engineer-Space")
			...
			M.death()
			M.equip_to_slot_or_del(new /obj/item/device/radio/headset/headset_eng(M), WEAR_L_EAR)
			M.equip_to_slot_or_del(new /obj/item/weapon/tank/emergency_oxygen(M), WEAR_WAIST)
			M.equip_to_slot_or_del(new /obj/item/clothing/under/rank/engineer(M), WEAR_BODY)
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/orange(M), WEAR_FEET)
			M.equip_to_slot_or_del(new /obj/item/clothing/suit/space(M), WEAR_JACKET)
		//	M.equip_to_slot_or_del(new /obj/item/weapon/storage/toolbox/mechanical(M), WEAR_L_HAND)
			M.equip_to_slot_or_del(new /obj/item/clothing/gloves/yellow(M), WEAR_HANDS)
			M.equip_to_slot_or_del(new /obj/item/device/t_scanner(M), WEAR_R_STORE)
			M.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack(M), WEAR_BACK)
			...
			if (prob(50))
				...
				if (prob(50))
					...
					M.equip_to_slot_or_del(new /obj/item/clothing/head/helmet/space(M), WEAR_HEAD)
			cdel(A)
			continue
		if (A.name == "Corpse-Engineer-Chief")
			...
			M.death()
			M.equip_to_slot_or_del(new /obj/item/device/radio/headset/headset_eng(M), WEAR_L_EAR)
			M.equip_to_slot_or_del(new /obj/item/weapon/storage/utilitybelt(M), WEAR_WAIST)
			M.equip_to_slot_or_del(new /obj/item/clothing/under/rank/chief_engineer(M), WEAR_BODY)
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/orange(M), WEAR_FEET)
		//	M.equip_to_slot_or_del(new /obj/item/weapon/storage/toolbox/mechanical(M), WEAR_L_HAND)
			M.equip_to_slot_or_del(new /obj/item/clothing/gloves/yellow(M), WEAR_HANDS)
			M.equip_to_slot_or_del(new /obj/item/device/t_scanner(M), WEAR_R_STORE)
		...
		if (A.name == "Corpse-Syndicate")
			...
			M.death()
			M.equip_to_slot_or_del(new /obj/item/device/radio/headset(M), WEAR_L_EAR)
			//M.equip_to_slot_or_del(new /obj/item/weapon/gun/revolver(M), WEAR_WAIST)
			M.equip_to_slot_or_del(new /obj/item/clothing/under/syndicate(M), WEAR_BODY)
			...
			M.equip_to_slot_or_del(new /obj/item/weapon/tank/jetpack(M), WEAR_BACK)
			M.equip_to_slot_or_del(new /obj/item/clothing/mask/gas(M), WEAR_FACE)
			if (prob(50))
				M.equip_to_slot_or_del(new /obj/item/clothing/suit/space/syndicate(M), WEAR_JACKET)
				if (prob(50))
					M.equip_to_slot_or_del(new /obj/item/clothing/head/helmet/swat(M), WEAR_HEAD)
				else
					M.equip_to_slot_or_del(new /obj/item/clothing/head/helmet/space/syndicate(M), WEAR_HEAD)
			else
				M.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/vest(M), WEAR_JACKET)
				M.equip_to_slot_or_del(new /obj/item/clothing/head/helmet/swat(M), WEAR_HEAD)
			cdel(A)
			continue
*/
