...
/datum/faction/syndicate/Cybersun_Industries
	...
	desc = "<b>Cybersun Industries</b> is a well-known organization that bases its business model primarily on the research and development of human-enhancing computer \
			...
			Their competent coverups and unchallenged mind-manipulation and augmentation technology makes them a large threat to Weyland-Yutani. In the recent years of \
...
/datum/faction/syndicate/MI13
	...
	desc = "<b>MI13</b> is a secretive faction that employs highly-trained agents to perform covert operations. Their role in the syndicate coalition is unknown, but MI13 operatives \
			generally tend be stealthy and avoid killing people and combating Weyland-Yutani forces. MI13 is not a real organization, it is instead an alias to a larger \
...
/datum/faction/syndicate/Tiger_Cooperative
	...
	desc = "The <b>Tiger Cooperative</b> is a faction of religious fanatics that follow the teachings of a strange alien race called the Exolitics. Their operatives \
			...
			sophisticated members of the Syndicate coalition, but admired for their ability to put a hurt on Weyland-Yutani."
...
/datum/faction/syndicate/SELF
	...
	desc = "The <b>S.E.L.F.</b> (Sentience-Enabled Life Forms) organization is a collection of malfunctioning or corrupt artificial intelligences seeking to liberate silicon-based life from the tyranny of \
			...
			destroy Weyland-Yutani and free the robots, artificial intelligences, and pAIs that have been enslaved."
...
/datum/faction/syndicate/ARC
	...
	desc = "The <b>Animal Rights Consortium</b> is a bizarre reincarnation of the ancient Earth-based PETA, which focused on the equal rights of animals and nonhuman biologicals. They have \
			...
			life forms that have been allegedly \"oppressed\" by Weyland-Yutani research and civilian offices. They are considered a religious terrorist group."
...
/datum/faction/syndicate/Marauders // these are basically the old vanilla syndicate
	...
	/* Additional notes:
		...
		nuclear attacks on Weyland-Yutani.
	*/
	...
	desc = "The <b>Gorlex Marauders</b> are the founding members of the Syndicate Coalition. They prefer old-fashion technology and a focus on aggressive but precise hostility \
			against Weyland-Yutani and their corrupt Communistic methodology. They pose the most significant threat to Weyland-Yutani because of their possession of weapons of \
			...
			hate of Weyland-Yutani communism, they began provoking revolution amongst the employees using borrowed Cybersun mind-manipulation technology. \
			...
			pacifier of Donk and Waffle co disputes, and full-time aggressor of Weyland-Yutani."
...
/obj/item/weapon/energy/sword:4:Energy Sword;
/obj/item/storage/box/syndicate:10:Syndicate Bundle;
/obj/item/storage/box/emps:3:5 EMP Grenades;
Whitespace:Seperator;
Stealthy and Inconspicuous Weapons;
/obj/item/tool/pen/paralysis:3:Paralysis Pen;
/obj/item/tool/soap/syndie:1:Syndicate Soap;
...
/obj/item/circuitboard/ai_module/syndicate:7:Hacked AI Upload Module;
/obj/item/explosive/plastique:2:C-4 (Destroys walls);
/obj/item/device/powersink:5:Powersink (DANGER!);
/obj/item/device/radio/beacon/syndicate:7:Singularity Beacon (DANGER!);
/obj/item/circuitboard/computer/teleporter:20:Teleporter Circuit Board;
Whitespace:Seperator;
Implants;
...
/datum/faction/syndicate/Donk
	...
	desc = "<b>Donk.co</b> is led by a group of ex-pirates, who used to be at a state of all-out war against Waffle.co because of an obscure political scandal, but have recently come to a war limitation. \
			They now consist of a series of colonial governments and companies. They were the first to officially begin confrontations against Weyland-Yutani because of an incident where \
			Weyland-Yutani purposely swindled them out of a fortune, sending their controlled colonies into a terrible poverty. Their missions against Weyland-Yutani \
...
/datum/faction/syndicate/Waffle
	...
	desc = "<b>Waffle.co</b> is an interstellar company that produces the best waffles in the galaxy. Their waffles have been rumored to be dipped in the most exotic and addictive \
			...
			economy and stock market, they have been able to bribe their way into amassing a large arsenal of weapons of mass destruction. They target Weyland-Yutani because of their communistic \
	...
	alliances = list("Gorlex Marauders")
	friendly_identification = 2
	operative_notes = "Most other syndicate operatives are not to be trusted, except for members of the Gorlex Marauders. Do not trust fellow members of the Waffle.co (but try not to rat them out), as they might have been assigned opposing objectives. We encourage humorous terrorism against Weyland-Yutani; we like to see our operatives creatively kill people while getting the job done."
...
/datum/faction/Wizard
	...
	desc = "The <b>Wizards Federation</b> is a mysterious organization of magically-talented individuals who act as an equal collective, and have no heirarchy. It is unknown how the wizards \
			...
			individuals in the known universe, and have been labeled threats to humanity by most governments. As such, they are enemies of both Weyland-Yutani and the Syndicate."
