...
/datum/game_mode/distress/proc/transform_xeno(datum/mind/M)
	...
	to_chat(X, "Talk in Hivemind using <strong>,a</strong> (e.g. ',a My life for the queen!')")
...
/datum/game_mode/distress/proc/transform_queen(datum/mind/M)
	...
	to_chat(X, "Talk in Hivemind using <strong>,a</strong> (e.g. ',a My life for the hive!')")
