...
/datum/game_mode/bigred/post_setup()
	...
	spawn (50)
		command_announcement.Announce("We've lost contact with the Weyland-Yutani's research facility, Solaris Ridge. The [MAIN_SHIP_NAME] has been dispatched to assist.", "[MAIN_SHIP_NAME]")
