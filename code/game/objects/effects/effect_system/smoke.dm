...
/atom/movable/effect/particle_effect/smoke
	name = "smoke"
	icon_state = "smoke"
	opacity = TRUE
	anchored = TRUE
...
/atom/movable/effect/particle_effect/smoke/Initialize(mapload, range, smoketime, smokecloud)
	. = ..()
	if(smokecloud)
		cloud = smokecloud
	...
	if(range)
		amount = range
		addtimer(CALLBACK(src, /atom/movable/effect/particle_effect/smoke.proc/spread_smoke), expansion_speed)
	create_reagents(500)
...
/atom/movable/effect/particle_effect/smoke/Destroy()
	...
	if(CHECK_BITFIELD(smoke_traits, SMOKE_CHEM) && LAZYLEN(cloud?.smoked_mobs)) //so the whole cloud won't stop working somehow
		var/atom/movable/effect/particle_effect/smoke/neighbor = pick(cloud.smokes - src)
...
/atom/movable/effect/particle_effect/smoke/proc/fade_out(frames = 16)
...
/atom/movable/effect/particle_effect/smoke/process()
	lifetime--
	if(lifetime < 1)
		qdel(src)
		return FALSE
...
/atom/movable/effect/particle_effect/smoke/proc/on_cross(datum/source, atom/movable/O, oldloc, oldlocs)
	SIGNAL_HANDLER
	if(isliving(O))
		O.effect_smoke(src)
		return
...
/atom/movable/effect/particle_effect/smoke/proc/on_exited(datum/source, mob/living/M, direction)
	SIGNAL_HANDLER
	if(CHECK_BITFIELD(smoke_traits, SMOKE_CAMO) && istype(M))
		var/atom/movable/effect/particle_effect/smoke/S = locate() in get_turf(M)
		if(!CHECK_BITFIELD(S?.smoke_traits, SMOKE_CAMO))
			M.smokecloak_off()

/atom/movable/effect/particle_effect/smoke/proc/apply_smoke_effect(turf/T)
	T.effect_smoke(src)
	for(var/V in T)
		var/atom/A = V
		A.effect_smoke(src)

/atom/movable/effect/particle_effect/smoke/proc/pre_chem_effect(mob/living/carbon/C)
	if(!cloud || !reagents)
		return
...
/atom/movable/effect/particle_effect/smoke/proc/chemical_effect()
...
/atom/movable/effect/particle_effect/smoke/proc/spread_smoke()
	...
	for(var/a in get_adjacent_open_turfs(src))
		...
		var/atom/movable/effect/particle_effect/smoke/S = new type(T, null, null, cloud)
...
/atom/movable/effect/particle_effect/smoke/proc/copy_stats(atom/movable/effect/particle_effect/smoke/parent)
...
/atom/movable/effect/particle_effect/smoke/proc/spawn_smoke(list/newsmokes)
	for(var/atom/movable/effect/particle_effect/smoke/SM in newsmokes)
		SM.spread_smoke()

//proc to check if smoke can expand to another turf
/atom/movable/effect/particle_effect/smoke/proc/check_airblock(turf/T)
	for(var/atom/movable/effect/particle_effect/smoke/foundsmoke in T)
...
/datum/effect_system/smoke_spread
	var/range = 3
	var/smoke_type = /atom/movable/effect/particle_effect/smoke
	var/lifetime
	var/list/smokes
...
/atom/movable/effect/particle_effect/smoke/bad
	lifetime = 8
...
/atom/movable/effect/particle_effect/smoke/tactical
	alpha = 40
	opacity = FALSE
...
/atom/movable/effect/particle_effect/smoke/sleepy
...
/atom/movable/effect/particle_effect/smoke/phosphorus
	alpha = 145
	opacity = FALSE
	color = "#DBCBB9"
...
/atom/movable/effect/particle_effect/smoke/plasmaloss
	alpha = 90
	opacity = FALSE
	color = "#791697"
...
/atom/movable/effect/particle_effect/smoke/flashbang
	name = "illumination"
	lifetime = 2
	opacity = FALSE
	icon_state = "sparks"
...
/atom/movable/effect/particle_effect/smoke/satrapine
	color = "#b02828"
	lifetime = 6
	spread_speed = 7
	expansion_speed = 3
...
//Xeno acid smoke.
/atom/movable/effect/particle_effect/smoke/xeno
	lifetime = 6
	spread_speed = 7
	expansion_speed = 3
...
//Xeno acid smoke.
/atom/movable/effect/particle_effect/smoke/xeno/burn
	lifetime = 6
...
/atom/movable/effect/particle_effect/smoke/xeno/burn/light
...
//Xeno neurotox smoke.
/atom/movable/effect/particle_effect/smoke/xeno/neuro
...
/atom/movable/effect/particle_effect/smoke/xeno/neuro/medium
	color = "#ffbf58" //Mustard orange?
...
/atom/movable/effect/particle_effect/smoke/xeno/neuro/light
	alpha = 60
	opacity = FALSE
...
/atom/movable/effect/particle_effect/smoke/xeno/hemodile
	smoke_can_spread_through = TRUE
	color = "#0287A1"
	smoke_traits = SMOKE_XENO|SMOKE_XENO_HEMODILE|SMOKE_GASP

/atom/movable/effect/particle_effect/smoke/xeno/transvitox
	smoke_can_spread_through = TRUE
	color = "#abf775"
	smoke_traits = SMOKE_XENO|SMOKE_XENO_TRANSVITOX|SMOKE_COUGH

//Toxic smoke when the Defiler successfully uses Defile
/atom/movable/effect/particle_effect/smoke/xeno/sanguinal
...
/atom/movable/effect/particle_effect/smoke/xeno/ozelomelyn
...
/datum/effect_system/smoke_spread/bad
	smoke_type = /atom/movable/effect/particle_effect/smoke/bad

datum/effect_system/smoke_spread/tactical
	smoke_type = /atom/movable/effect/particle_effect/smoke/tactical

/datum/effect_system/smoke_spread/sleepy
	smoke_type = /atom/movable/effect/particle_effect/smoke/sleepy

/datum/effect_system/smoke_spread/phosphorus
	smoke_type = /atom/movable/effect/particle_effect/smoke/phosphorus

/datum/effect_system/smoke_spread/plasmaloss
	smoke_type = /atom/movable/effect/particle_effect/smoke/plasmaloss

/datum/effect_system/smoke_spread/satrapine
	smoke_type = /atom/movable/effect/particle_effect/smoke/satrapine

/datum/effect_system/smoke_spread/xeno
	smoke_type = /atom/movable/effect/particle_effect/smoke/xeno
	var/strength = 1

/datum/effect_system/smoke_spread/xeno/start()
	if(QDELETED(location) && !QDELETED(holder))
		location = get_turf(holder)
	var/atom/movable/effect/particle_effect/smoke/xeno/S = new smoke_type(location, range, lifetime, src)
	S.strength = strength

/datum/effect_system/smoke_spread/xeno/acid
	smoke_type = /atom/movable/effect/particle_effect/smoke/xeno/burn

/datum/effect_system/smoke_spread/xeno/acid/light
	smoke_type = /atom/movable/effect/particle_effect/smoke/xeno/burn/light

/datum/effect_system/smoke_spread/xeno/neuro
	smoke_type = /atom/movable/effect/particle_effect/smoke/xeno/neuro

/datum/effect_system/smoke_spread/xeno/neuro/medium
	smoke_type = /atom/movable/effect/particle_effect/smoke/xeno/neuro/medium

/datum/effect_system/smoke_spread/xeno/neuro/light
	smoke_type = /atom/movable/effect/particle_effect/smoke/xeno/neuro/light

/datum/effect_system/smoke_spread/xeno/hemodile
	smoke_type = /atom/movable/effect/particle_effect/smoke/xeno/hemodile

/datum/effect_system/smoke_spread/xeno/transvitox
	smoke_type = /atom/movable/effect/particle_effect/smoke/xeno/transvitox

/datum/effect_system/smoke_spread/xeno/sanguinal
	smoke_type = /atom/movable/effect/particle_effect/smoke/xeno/sanguinal

/datum/effect_system/smoke_spread/xeno/ozelomelyn
	smoke_type = /atom/movable/effect/particle_effect/smoke/xeno/ozelomelyn

/////////////////////////////////////////////
// Chem smoke
/////////////////////////////////////////////
/atom/movable/effect/particle_effect/smoke/chem
	lifetime = 10
	smoke_traits = SMOKE_CHEM

/atom/movable/effect/particle_effect/smoke/chem/copy_stats(atom/movable/effect/particle_effect/smoke/parent)
	icon = parent.icon
	return ..()

/datum/effect_system/smoke_spread/chem
	var/obj/chemholder
	smoke_type = /atom/movable/effect/particle_effect/smoke/chem
...
/datum/effect_system/smoke_spread/chem/start()
	...
	if(QDELETED(location) && !QDELETED(holder))
		location = get_turf(holder)
	var/atom/movable/effect/particle_effect/smoke/chem/S = new smoke_type(location, range, lifetime, src)
