...
/obj/effect/landmark/weapon_spawn/proc/spawn_associated_ammo(obj/item/weapon/gun/gun_to_spawn)
	...
	if(istype(gun_to_spawn, /obj/item/weapon/gun/launcher/grenade/m92) || istype(gun_to_spawn, /obj/item/weapon/gun/launcher/grenade/m81))
		new /obj/item/storage/box/visual/grenade/frag (get_turf(src))
		return

	if(istype(gun_to_spawn, /obj/item/weapon/gun/launcher/grenade/m81/flare))
