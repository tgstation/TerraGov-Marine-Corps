...
/obj/item/reagent_containers/food/snacks/protein_pack
	...
	var/static/list/flavor_list = list(
		FACTION_TERRAGOV = list(
			...
			list("mystery NTC protein bar","Some say they have tasted one of these and tasted their favorite childhood meal, especially for Squad Operatives. Most say this tastes like crayons, though it fills like any other protein bar you've seen.","#ffffff",list("crayons" = 1)),
			...
			list("chicken NTC protein bar","Protein bar covered with chicken powder one might find in ramen. Get some extra sodium with your protein.","#cccc00",list= ("powdered chicken")),
