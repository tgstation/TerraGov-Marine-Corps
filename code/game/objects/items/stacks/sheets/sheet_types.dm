...
GLOBAL_LIST_INIT(metal_recipes, list ( \
	...
	new/datum/stack_recipe("machine frame", /obj/machinery/constructable_frame/machine, 5, time = 25, max_per_turf = STACK_RECIPE_ONE_PER_TILE, on_floor = TRUE, skill_req = SKILL_CONSTRUCTION_MASTER), \
	null, \
