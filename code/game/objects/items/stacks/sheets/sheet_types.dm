...
GLOBAL_LIST_INIT(metal_recipes, list ( \
	...
	new/datum/stack_recipe("spike trap", /obj/item/stack/spiketrap, 4, 2, 20, time = 5 SECONDS, skill_req = SKILL_CONSTRUCTION_METAL), \
	new/datum/stack_recipe("spear trap", /obj/item/stack/speartrap, 4, 2, 20, time = 5 SECONDS, skill_req = SKILL_CONSTRUCTION_METAL), \
	null, \
