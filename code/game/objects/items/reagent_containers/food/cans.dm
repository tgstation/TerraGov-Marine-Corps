...
/obj/item/reagent_container/food/drinks/cans/souto/cherry/diet
	...
	list_reagents = list(/datum/reagent/consumable/drink/suoto/cherry = 25, /datum/reagent/water = 25)
...
/obj/item/reagent_container/food/drinks/cans/aspen
	...
	icon_state = "6_pack_1"
	center_of_mass = list("x"=16, "y"=10)
	list_reagents = list(/datum/reagent/consumable/ethanol/beer/light = 50)
