...
/obj/item/reagent_containers/food/snacks/cubancarp
	...
	bitesize = 3
	list_reagents = list(/datum/reagent/consumable/nutriment = 2, /datum/reagent/consumable/nutriment/protein = 6,  /datum/reagent/consumable/capsaicin = 1, /datum/reagent/consumable/nutriment/vitamin = 4)
...
/obj/item/reagent_containers/food/snacks/fishmeat/carp/Initialize(mapload)
	. = ..()
	if(cell_line)
...
/obj/item/reagent_containers/food/snacks/fishmeat/moonfish/MakeGrillable()
	AddComponent(/datum/component/grillable, /obj/item/reagent_containers/food/snacks/grilled_moonfish, rand(40 SECONDS, 50 SECONDS), TRUE, TRUE)
...
/obj/item/reagent_containers/food/snacks/fishfingers
	...
	list_reagents = list(/datum/reagent/consumable/nutriment = 2, /datum/reagent/consumable/nutriment/protein = 5, /datum/reagent/consumable/nutriment/vitamin = 2)
	bitesize = 1
...
/obj/item/reagent_containers/food/snacks/cornedbeef
	...
	list_reagents = list(/datum/reagent/consumable/nutriment = 2, /datum/reagent/consumable/nutriment/protein = 6, /datum/reagent/consumable/nutriment/vitamin = 4)
...
/obj/item/reagent_containers/food/snacks/bearsteak
	...
	list_reagents = list(/datum/reagent/consumable/nutriment = 4, /datum/reagent/consumable/nutriment/vitamin = 9, /datum/reagent/consumable/ethanol/manly_dorf = 5)
...
/obj/item/reagent_containers/food/snacks/raw_meatball/MakeProcessable()
...
/obj/item/reagent_containers/food/snacks/sausage/MakeProcessable()
	AddElement(/datum/element/processable, TOOL_KNIFE, /obj/item/reagent_containers/food/snacks/salami, 6, 30, table_required = TRUE)
	AddElement(/datum/element/processable, TOOL_KNIFE, /obj/item/reagent_containers/food/snacks/sausage/american, 1, 30, table_required = TRUE)
...
/obj/item/reagent_containers/food/snacks/sausage/american/MakeProcessable()
	return
...
/obj/item/reagent_containers/food/snacks/meatbun
	...
	icon_state = "meatbun"
	list_reagents = list(/datum/reagent/consumable/nutriment = 7, /datum/reagent/consumable/nutriment/vitamin = 4)
...
/obj/item/reagent_containers/food/snacks/monkeycube/suicide_act(mob/living/user)
...
/obj/item/reagent_containers/food/snacks/monkeycube/proc/finish_suicide(mob/living/user) ///internal proc called by a monkeycube's suicide_act using a timer and callback. takes as argument the mob/living who activated the suicide
...
/obj/item/reagent_containers/food/snacks/stewedsoymeat
	...
	list_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/consumable/nutriment/protein = 6, /datum/reagent/consumable/nutriment/vitamin = 2)
...
/obj/item/reagent_containers/food/snacks/boiledspiderleg
	...
	list_reagents = list(/datum/reagent/consumable/nutriment/protein = 4, /datum/reagent/consumable/capsaicin = 4, /datum/reagent/consumable/nutriment/vitamin = 2)
...
/obj/item/reagent_containers/food/snacks/sashimi
	...
	icon_state = "sashimi"
	list_reagents = list(/datum/reagent/consumable/nutriment/protein = 10, /datum/reagent/consumable/capsaicin = 9, /datum/reagent/consumable/nutriment/vitamin = 4)
...
/obj/item/reagent_containers/food/snacks/pigblanket
	...
	list_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/consumable/nutriment/protein = 5, /datum/reagent/consumable/nutriment/vitamin = 2)
...
/obj/item/reagent_containers/food/snacks/meatclown
	...
	list_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/consumable/nutriment/vitamin = 1, /datum/reagent/consumable/banana = 2)
...
/obj/item/reagent_containers/food/snacks/kebab
	icon_state = "kebab"
	list_reagents = list(/datum/reagent/consumable/nutriment/protein = 14)
	tastes = list("meat" = 3, "metal" = 1)

/obj/item/reagent_containers/food/snacks/kebab/human
	name = "human-kebab"
	desc = "A human meat, on a stick."
	list_reagents = list(/datum/reagent/consumable/nutriment/protein = 16, /datum/reagent/consumable/nutriment/vitamin = 6)
	tastes = list("tender meat" = 3, "metal" = 1)

/obj/item/reagent_containers/food/snacks/kebab/monkey
	name = "meat-kebab"
	desc = "Delicious meat, on a stick."
	list_reagents = list(/datum/reagent/consumable/nutriment/protein = 16, /datum/reagent/consumable/nutriment/vitamin = 2)
	tastes = list("meat" = 3, "metal" = 1)

/obj/item/reagent_containers/food/snacks/kebab/tofu
	name = "tofu-kebab"
	desc = "Vegan meat, on a stick."
	list_reagents = list(/datum/reagent/consumable/nutriment/protein = 15)
	tastes = list("tofu" = 3, "metal" = 1)

/obj/item/reagent_containers/food/snacks/kebab/tail
	name = "lizard-tail kebab"
	desc = "Severed lizard tail on a stick."
	list_reagents = list(/datum/reagent/consumable/nutriment/protein = 30, /datum/reagent/consumable/nutriment/vitamin = 4)
...
/obj/item/reagent_containers/food/snacks/kebab/rat/double
	...
	list_reagents = list(/datum/reagent/consumable/nutriment/protein = 20, /datum/reagent/consumable/nutriment/vitamin = 4, /datum/reagent/iron = 2)

/obj/item/reagent_containers/food/snacks/kebab/fiesta
	name = "fiesta skewer"
	icon_state = "fiestaskewer"
	tastes = list("tex-mex" = 3, "cumin" = 2)
	list_reagents = list(/datum/reagent/consumable/nutriment/protein = 12, /datum/reagent/consumable/nutriment/vitamin = 6, /datum/reagent/consumable/capsaicin = 3)
...
/obj/item/reagent_containers/food/snacks/meat/slab/Initialize(mapload)
	. = ..()
...
/obj/item/reagent_containers/food/snacks/meat/slab/MakeProcessable()
	AddElement(/datum/element/processable, TOOL_KNIFE,  /obj/item/reagent_containers/food/snacks/meat/rawcutlet/plain, 3, 30, table_required = TRUE)
...
/obj/item/reagent_containers/food/snacks/meat/slab/human/MakeGrillable()
	AddComponent(/datum/component/grillable, /obj/item/reagent_containers/food/snacks/meat/steak/plain/human, rand(30 SECONDS, 90 SECONDS), TRUE, TRUE) //Add medium rare later maybe?

/obj/item/reagent_containers/food/snacks/meat/slab/human/MakeProcessable()
	AddElement(/datum/element/processable, TOOL_KNIFE,  /obj/item/reagent_containers/food/snacks/meat/rawcutlet/plain/human, 3, 30, table_required = TRUE)
...
/obj/item/reagent_containers/food/snacks/meat/slab/human/mutant/skeleton/MakeProcessable()
...
/obj/item/reagent_containers/food/snacks/meat/slab/human/mutant/ethereal
	...
	list_reagents = list(/datum/reagent/consumable/liquidelectricity/enriched = 10)
...
/obj/item/reagent_containers/food/snacks/meat/slab/synthmeat/MakeGrillable()
	AddComponent(/datum/component/grillable, /obj/item/reagent_containers/food/snacks/meat/steak/plain/synth, rand(30 SECONDS, 90 SECONDS), TRUE, TRUE)
...
/obj/item/reagent_containers/food/snacks/meat/slab/mouse/Initialize(mapload)
	. = ..()
...
/obj/item/reagent_containers/food/snacks/meat/slab/corgi/Initialize(mapload)
	. = ..()
...
/obj/item/reagent_containers/food/snacks/meat/slab/pug/Initialize(mapload)
	. = ..()
...
/obj/item/reagent_containers/food/snacks/meat/slab/killertomato/MakeProcessable()
	AddElement(/datum/element/processable, TOOL_KNIFE, /obj/item/reagent_containers/food/snacks/meat/rawcutlet/killertomato, 3, 30, table_required = TRUE)
...
/obj/item/reagent_containers/food/snacks/meat/slab/bear/MakeProcessable()
	AddElement(/datum/element/processable, TOOL_KNIFE, /obj/item/reagent_containers/food/snacks/meat/rawcutlet/bear, 3, 30, table_required = TRUE)
...
/obj/item/reagent_containers/food/snacks/meat/slab/bear/Initialize(mapload)
	. = ..()
...
/obj/item/reagent_containers/food/snacks/meat/slab/xeno/MakeProcessable()
	AddElement(/datum/element/processable, TOOL_KNIFE, /obj/item/reagent_containers/food/snacks/meat/rawcutlet/xeno, 3, 30, table_required = TRUE)
...
/obj/item/reagent_containers/food/snacks/meat/slab/spider/MakeProcessable()
	AddElement(/datum/element/processable, TOOL_KNIFE, /obj/item/reagent_containers/food/snacks/meat/rawcutlet/spider, 3, 30, table_required = TRUE)
...
/obj/item/reagent_containers/food/snacks/meat/bacon
	...
	list_reagents = list(/datum/reagent/consumable/nutriment/protein = 2, /datum/reagent/consumable/nutriment/vitamin = 1, /datum/reagent/consumable/cooking_oil = 2)
	tastes = list("bacon" = 1)
	foodtypes = MEAT | BREAKFAST
	burns_on_grill = TRUE
...
/obj/item/reagent_containers/food/snacks/meat/slab/gondola
	...
	list_reagents = list(/datum/reagent/consumable/nutriment/protein = 4, /datum/reagent/gondola_mutation_toxin = 5, /datum/reagent/consumable/cooking_oil = 3)
	tastes = list("meat" = 4, "tranquility" = 1)
	foodtypes = RAW | MEAT

/obj/item/reagent_containers/food/snacks/meat/slab/gondola/MakeProcessable()
	AddElement(/datum/element/processable, TOOL_KNIFE, /obj/item/reagent_containers/food/snacks/meat/rawcutlet/gondola, 3, 30, table_required = TRUE)
...
/obj/item/reagent_containers/food/snacks/meat/slab/penguin/MakeProcessable()
	. = ..()
	AddElement(/datum/element/processable, TOOL_KNIFE, /obj/item/reagent_containers/food/snacks/meat/rawcutlet/penguin, 3, 30, table_required = TRUE)
...
/obj/item/reagent_containers/food/snacks/meat/slab/rawcrab/MakeGrillable()
	AddComponent(/datum/component/grillable, /obj/item/reagent_containers/food/snacks/meat/crab, rand(30 SECONDS, 90 SECONDS), TRUE, TRUE) //Add medium rare later maybe?

/obj/item/reagent_containers/food/snacks/meat/crab
	name = "crab meat"
	desc = "Some deliciously cooked crab meat."
	icon_state = "crabmeat"
	list_reagents = list(/datum/reagent/consumable/nutriment = 2, /datum/reagent/consumable/nutriment/vitamin = 2, /datum/reagent/consumable/cooking_oil = 2)
	tastes = list("crab" = 1)
	foodtypes = SEAFOOD
	burns_on_grill = TRUE
...
/obj/item/reagent_containers/food/snacks/meat/slab/chicken/MakeProcessable()
	AddElement(/datum/element/processable, TOOL_KNIFE, /obj/item/reagent_containers/food/snacks/meat/rawcutlet/chicken, 3, 30, table_required = TRUE)

/obj/item/reagent_containers/food/snacks/meat/slab/chicken/MakeGrillable()
	AddComponent(/datum/component/grillable, /obj/item/reagent_containers/food/snacks/meat/steak/chicken, rand(30 SECONDS, 90 SECONDS), TRUE, TRUE) //Add medium rare later maybe? (no this is chicken)

/obj/item/reagent_containers/food/snacks/meat/slab/chicken/Initialize(mapload)
	. = ..()
...
/obj/item/reagent_containers/food/snacks/meat/steak/Initialize(mapload)
	. = ..()
	RegisterSignal(src, COMSIG_ITEM_MICROWAVE_COOKED, .proc/OnMicrowaveCooked)


/obj/item/reagent_containers/food/snacks/meat/steak/proc/OnMicrowaveCooked(datum/source, obj/item/source_item, cooking_efficiency = 1)
	SIGNAL_HANDLER
...
/obj/item/reagent_containers/food/snacks/meat/steak/plain/human/OnMicrowaveCooked(datum/source, obj/item/source_item, cooking_efficiency = 1)
	. = ..()
	if(istype(source_item, /obj/item/reagent_containers/food/snacks/meat))
		var/obj/item/reagent_containers/food/snacks/meat/origin_meat = source_item
...
/obj/item/reagent_containers/food/snacks/meat/rawcutlet/MakeGrillable()
...
/obj/item/reagent_containers/food/snacks/meat/rawcutlet/OnCreatedFromProcessing(mob/living/user, obj/item/item, list/chosen_option, atom/original_atom)
	..()
	if(!istype(original_atom, /obj/item/reagent_containers/food/snacks/meat/slab))
		return
	var/obj/item/reagent_containers/food/snacks/meat/slab/original_slab = original_atom
...
/obj/item/reagent_containers/food/snacks/meat/rawcutlet/plain/human/MakeGrillable()
...
/obj/item/reagent_containers/food/snacks/meat/rawcutlet/plain/human/OnCreatedFromProcessing(mob/living/user, obj/item/item, list/chosen_option, atom/original_atom)
	. = ..()
	if(!istype(original_atom, /obj/item/reagent_containers/food/snacks/meat))
		return
	var/obj/item/reagent_containers/food/snacks/meat/origin_meat = original_atom
	subjectname = origin_meat.subjectname
	subjectjob = origin_meat.subjectjob
	if(subjectname)
...
/obj/item/reagent_containers/food/snacks/meat/rawcutlet/killertomato/MakeGrillable()
...
/obj/item/reagent_containers/food/snacks/meat/rawcutlet/bear/Initialize(mapload)
	. = ..()
	AddElement(/datum/element/swabable, CELL_LINE_TABLE_BEAR, CELL_VIRUS_TABLE_GENERIC_MOB)

/obj/item/reagent_containers/food/snacks/meat/rawcutlet/bear/MakeGrillable()
...
/obj/item/reagent_containers/food/snacks/meat/rawcutlet/xeno/MakeGrillable()
...
/obj/item/reagent_containers/food/snacks/meat/rawcutlet/spider/MakeGrillable()
...
/obj/item/reagent_containers/food/snacks/meat/rawcutlet/gondola/MakeGrillable()
...
/obj/item/reagent_containers/food/snacks/meat/rawcutlet/penguin/MakeGrillable()
...
/obj/item/reagent_containers/food/snacks/meat/rawcutlet/chicken/MakeGrillable()
...
/obj/item/reagent_containers/food/snacks/meat/rawcutlet/chicken/Initialize(mapload)
	. = ..()
	AddElement(/datum/element/swabable, CELL_LINE_TABLE_CHICKEN, CELL_VIRUS_TABLE_GENERIC_MOB)
...
/obj/item/reagent_containers/food/snacks/meat/cutlet/Initialize(mapload)
	. = ..()
	RegisterSignal(src, COMSIG_ITEM_MICROWAVE_COOKED, .proc/OnMicrowaveCooked)

///This proc handles setting up the correct meat name for the cutlet, this should definitely be changed with the food rework.
/obj/item/reagent_containers/food/snacks/meat/cutlet/proc/OnMicrowaveCooked(datum/source, atom/source_item, cooking_efficiency)
	SIGNAL_HANDLER
	if(istype(source_item, /obj/item/reagent_containers/food/snacks/meat/rawcutlet))
		var/obj/item/reagent_containers/food/snacks/meat/rawcutlet/original_cutlet = source_item
...
/obj/item/reagent_containers/food/snacks/meat/cutlet/plain/human/OnMicrowaveCooked(datum/source, atom/source_item, cooking_efficiency)
	. = ..()
	if(istype(source_item, /obj/item/reagent_containers/food/snacks/meat))
		var/obj/item/reagent_containers/food/snacks/meat/origin_meat = source_item
		if(subjectname)
...
/obj/item/reagent_containers/food/snacks/beef_stroganoff
	...
	list_reagents = list(/datum/reagent/consumable/nutriment/protein = 16, /datum/reagent/consumable/nutriment/vitamin = 4)
...
/obj/item/reagent_containers/food/snacks/beef_wellington
...
/obj/item/reagent_containers/food/snacks/beef_wellington/MakeProcessable()
	AddElement(/datum/element/processable, TOOL_KNIFE,  /obj/item/reagent_containers/food/snacks/beef_wellington_slice, 3, 30, table_required = TRUE)

/obj/item/reagent_containers/food/snacks/beef_wellington_slice
...
/obj/item/reagent_containers/food/snacks/full_english
