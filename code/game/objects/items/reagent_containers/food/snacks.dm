...
/obj/item/reagent_container/food/snacks/mysterysoup/Initialize()
	...
	switch(mysteryselect)
		if(1)
			list_reagents = list(/datum/reagent/consumable/nutriment = 6, /datum/reagent/consumable/capsaicin = 3, /datum/reagent/consumable/drink/tomatojuice = 2)
		if(2)
			list_reagents = list(/datum/reagent/consumable/nutriment = 6, /datum/reagent/consumable/frostoil = 3, /datum/reagent/consumable/drink/tomatojuice = 2)
		if(3)
			list_reagents = list(/datum/reagent/consumable/nutriment = 6, /datum/reagent/water = 5, /datum/reagent/medicine/tricordrazine = 5)
		if(4)
			list_reagents = list(/datum/reagent/consumable/nutriment = 6, /datum/reagent/water = 10)
		if(5)
			list_reagents = list(/datum/reagent/consumable/nutriment = 2, /datum/reagent/consumable/drink/banana = 10)
		if(6)
			list_reagents = list(/datum/reagent/consumable/nutriment = 6, /datum/reagent/blood = 10)
		if(7)
			list_reagents = list(/datum/reagent/carbon = 10, /datum/reagent/toxin = 10)
		if(8)
			list_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/consumable/drink/tomatojuice = 10)
		if(9)
			list_reagents = list(/datum/reagent/consumable/nutriment = 6, /datum/reagent/consumable/drink/tomatojuice = 5, /datum/reagent/medicine/imidazoline = 5)
	return ..()
...
/obj/item/reagent_container/food/snacks/wishsoup/Initialize()
	...
	if(wish)
		...
		list_reagents = list(/datum/reagent/consumable/nutriment = 8, /datum/reagent/water = 10)
	return ..()
