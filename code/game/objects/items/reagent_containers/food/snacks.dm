...
/obj/item/reagent_containers/food/snacks/packaged_meal/proc/determinetype(newflavor)
	...
	switch(newflavor)
		if("boneless pork ribs", "grilled chicken", "pizza square", "spaghetti", "chicken tenders")
			icon_state = "entree"
			list_reagents = list(/datum/reagent/consumable/nutriment = 15, /datum/reagent/consumable/sodiumchloride = 1)
		...
		if("spiced apples", "chocolate brownie", "sugar cookie", "choco bar", "crayon")
			icon_state = "dessert"
			list_reagents = list(/datum/reagent/consumable/nutriment = 11, /datum/reagent/consumable/sugar = 1)
