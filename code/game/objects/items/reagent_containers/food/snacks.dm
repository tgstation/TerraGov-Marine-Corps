...
//	 list_reagents = list(/datum/reagent/consumable/nutriment = 2, /datum/reagent/xenomicrobes = 10)	//what is in the food item.
//	 tastes = list("dough" = 2, "heresy" = 1)								//This is the flavour of the food, nutriment is necessary for this to work.
...
/obj/item/reagent_container/food/snacks/donkpocket/proc/cooltime()
	reagents.remove_reagent(/datum/reagent/medicine/tricordrazine, 5)
...
/obj/item/reagent_container/food/snacks/badrecipe
	...
	list_reagents = list(/datum/reagent/toxin = 1, /datum/reagent/carbon = 3)
	bitesize = 2
...
/obj/item/reagent_container/food/snacks/mysterysoup/Initialize()
	...
	switch(mysteryselect)
		if(1)
			list_reagents = (/datum/reagent/consumable/nutriment = 6, /datum/reagent/consumable/capsaicin = 3, /datum/reagent/consumable/drink/tomatojuice = 2)
		if(2)
			list_reagents = (/datum/reagent/consumable/nutriment = 6, /datum/reagent/consumable/frostoil = 3, /datum/reagent/consumable/drink/tomatojuice = 2)
		if(3)
			list_reagents = (/datum/reagent/consumable/nutriment = 6, /datum/reagent/water = 5, /datum/reagent/medicine/tricordrazine = 5)
		if(4)
			list_reagents = (/datum/reagent/consumable/nutriment = 6, /datum/reagent/water = 10)
		if(5)
			list_reagents = (/datum/reagent/consumable/nutriment = 2, /datum/reagent/consumable/drink/banana = 10)
		if(6)
			list_reagents = (/datum/reagent/consumable/nutriment = 6, /datum/reagent/blood = 10)
		if(7)
			list_reagents = (/datum/reagent/carbon = 10, /datum/reagent/toxin = 10)
		if(8)
			list_reagents = (/datum/reagent/consumable/nutriment = 5, /datum/reagent/consumable/drink/tomatojuice = 10)
		if(9)
			list_reagents = (/datum/reagent/consumable/nutriment = 6, /datum/reagent/consumable/drink/tomatojuice = 5, /datum/reagent/medicine/imidazoline = 5)
	return ..()
...
/obj/item/reagent_container/food/snacks/wishsoup/Initialize()
	...
	if(wish)
		...
		list_reagents = (/datum/reagent/consumable/nutriment = 8, /datum/reagent/water = 10)
	return ..()
...
/obj/item/reagent_container/food/snacks/wrapped/barcardine
	...
	list_reagents = list(/datum/reagent/consumable/nutriment = 3, /datum/reagent/consumable/coco = 2, /datum/reagent/medicine/tramadol = 1, /datum/reagent/medicine/bicaridine = 1)
