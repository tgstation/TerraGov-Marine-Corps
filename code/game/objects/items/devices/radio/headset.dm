...
/obj/item/radio/headset/attackby(obj/item/W, mob/user, params)
	...
	if(W.tool_behaviour == TOOL_SCREWDRIVER)
		if(keyslot || keyslot2)
			...
			recalculateChannels()
			to_chat(user, "<span class='notice'>I pop out the encryption keys in the headset.</span>")
...
/obj/item/radio/headset/AltClick(mob/living/user)
	...
	if (command)
		...
		to_chat(user, "<span class='notice'>I toggle high-volume mode [use_command ? "on" : "off"].</span>")
