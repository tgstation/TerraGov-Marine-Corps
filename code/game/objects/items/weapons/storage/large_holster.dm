...
/obj/item/weapon/storage/large_holster
...
/obj/item/weapon/storage/large_holster/equipped(mob/user, slot)
	if(slot == WEAR_BACK || slot == WEAR_WAIST)
		mouse_opacity = 2 //so it's easier to click when properly equipped.
	..()

/obj/item/weapon/storage/large_holster/dropped(mob/user)
	mouse_opacity = initial(mouse_opacity)
	..()

/obj/item/weapon/storage/large_holster/attack_hand(mob/user)
...
/obj/item/weapon/storage/large_holster/handle_item_insertion(obj/item/W, prevent_warning = 0)
	. = ..()
	if(. && drawSound)
...
/obj/item/weapon/storage/large_holster/remove_from_storage(obj/item/W, atom/new_location)
	. = ..()
	if(. && drawSound)
		playsound(src,drawSound, 15, 1)
	return 1
...
/obj/item/weapon/storage/large_holster/m37
...
/obj/item/weapon/storage/large_holster/m37/New()
	select_gamemode_skin(/obj/item/weapon/storage/large_holster/m37)
	base_icon = icon_state
	..()


/obj/item/weapon/storage/large_holster/m37/full/New()
	..()
...
/obj/item/weapon/storage/large_holster/katana
...
/obj/item/weapon/storage/large_holster/m39/full/New()
	..()
