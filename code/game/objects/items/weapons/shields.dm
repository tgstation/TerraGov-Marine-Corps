...
/obj/item/weapon/shield/proc/set_shield()
	AddComponent(/datum/component/shield, SHIELD_PARENT_INTEGRITY, shield_cover = list("melee" = 80, "bullet" = 60, "laser" = 60, "energy" = 60, "bomb" = 80, "bio" = 30, "rad" = 0, "fire" = 70, "acid" = 80))
