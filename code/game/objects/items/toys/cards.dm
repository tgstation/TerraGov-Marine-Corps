...
/obj/item/toy/deck/verb/deal_card()
	...
	var/mob/living/M = tgui_input_list(usr, "Who do you wish to deal a card?", players)
...
/obj/item/toy/handcard/verb/discard()
	...
	for(var/datum/playingcard/P in cards)
		to_discard[P.name] = P
	var/discarding = tgui_input_list(usr, "Which card do you wish to put down?", to_discard)
