/obj/item/storage/surgical_tray
	...
	OOC_info = "Contains all the tools required for surgery, check the OOC information for each individual tool. You can keep this on the table and open its inventory by clicking and dragging its sprite onto yours."
	flags_atom = CONDUCT
