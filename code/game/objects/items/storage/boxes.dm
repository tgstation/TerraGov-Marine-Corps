...
/obj/item/storage/box/explosive_mines
	...
	icon_state = "minebox"
	w_class = WEIGHT_CLASS_NORMAL
	spawn_number = 5	//Just for the sake of not repeating it in all the subtypes; does nothing with no spawn_type
...
/obj/item/storage/box/explosive_mines/claymore/large
	name = "\improper M20 claymore jumbo box"
	desc = "A large secure box holding anti-personel claymore mines, with twice the storage space."
	spawn_number = 10

/obj/item/storage/box/explosive_mines/claymore/large/Initialize(mapload, ...)
	. = ..()
