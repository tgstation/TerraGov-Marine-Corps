...
/obj/item/minigun_powerpack
	...
	desc = "A heavy reinforced backpack with support equipment, power cells, and spare rounds for the T-100 Minigun.\nClick the icon in the top left to reload your M56."
...
/obj/item/minigun_powerpack/attack_self(mob/living/carbon/human/user, automatic = FALSE)
	...
	reloading = TRUE
	if(!automatic)
		user.visible_message("[user.name] begins feeding an ammo belt into the M56 minigun.","You begin feeding a fresh ammo belt into the T-100 Minigun. Don't move or you'll be interrupted.")
	else
		user.visible_message("[user.name]'s powerpack servos begin automatically feeding an ammo belt into the M56 minigun.","The powerpack servos begin automatically feeding a fresh ammo belt into the T-100 Minigun.")
