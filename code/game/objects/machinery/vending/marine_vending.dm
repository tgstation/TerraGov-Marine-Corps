...
/obj/machinery/vending/MarineMed
	...
	products = list(
		...
		"Auto Injector" = list(
			...
			/obj/item/reagent_containers/hypospray/autoinjector/dylovene = 50,
			/obj/item/reagent_containers/hypospray/autoinjector/combat = 20,
			/obj/item/reagent_containers/hypospray/autoinjector/oxycodone = 40,
			/obj/item/reagent_containers/hypospray/autoinjector/inaprovaline = 50,
			/obj/item/reagent_containers/hypospray/autoinjector/hypervene = 30,
			/obj/item/reagent_containers/hypospray/autoinjector/alkysine = 30,
			/obj/item/reagent_containers/hypospray/autoinjector/imidazoline = 30,
			...
			/obj/item/reagent_containers/hypospray/autoinjector/peridaxon = 30,
			/obj/item/reagent_containers/hypospray/autoinjector/medicalnanites = 50,
