...
/obj/machinery/vending/valhalla_seasonal_req
	...
	products = list(
		...
		"PMC" = list(
			...
			/obj/item/weapon/gun/pistol/vp90 = -1,
			/obj/item/ammo_magazine/pistol/vp90 = -1,
			/obj/item/ammo_magazine/pistol/vp90/extended = -1,
			/obj/item/weapon/gun/pistol/vp100_gyrojet = -1,
			/obj/item/ammo_magazine/pistol/vp100_gyrojet = -1,
		),
		"Freelancers" = list(
