...
/obj/machinery/vending/armor_supply
	...
	products = list(
		...
		"Jaeger modules" = list(
			...
			/obj/item/armor_module/welding = -1,
			/obj/item/armor_module/binoculars = -1,
			/obj/item/armor_module/tyr_head = -1,
			/obj/item/armor_module/antenna = -1,
			/obj/item/armor_module/mimir_environment_protection/mark1 = -1,
			/obj/item/armor_module/mimir_environment_protection/mimir_helmet/mark1 = -1,
			/obj/item/armor_module/tyr_extra_armor/mark1 = -1,
			/obj/item/armor_module/ballistic_armor = -1,
			/obj/item/armor_module/better_shoulder_lamp = -1,
			/obj/item/armor_module/chemsystem = -1,
		),
	)
