...
/obj/machinery/vending/armor_supply
	...
	products = list(
		...
		"Visors" = list(
			/obj/item/armor_module/armor/visor/marine = -1,
			/obj/item/armor_module/armor/visor/metal/marine = -1,
			/obj/item/armor_module/armor/visor/marine/skirmisher = -1,
			/obj/item/armor_module/armor/visor/metal/marine/skirmisher = -1,
			/obj/item/armor_module/armor/visor/marine/assault = -1,
			/obj/item/armor_module/armor/visor/metal/marine/assault = -1,
			/obj/item/armor_module/armor/visor/marine/eva = -1,
			/obj/item/armor_module/armor/visor/metal/marine/eva = -1,
			/obj/item/armor_module/armor/visor/marine/eod = -1,
			/obj/item/armor_module/armor/visor/metal/marine/eod = -1,
			/obj/item/armor_module/armor/visor/marine/scout = -1,
			/obj/item/armor_module/armor/visor/metal/marine/scout = -1,
		),
