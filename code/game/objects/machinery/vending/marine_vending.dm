/obj/machinery/vending/weapon
	...
	products = list(
		...
		"Shotgun" = list(
			...
			/obj/item/weapon/gun/shotgun/pump/dijitar = -1,
			/obj/item/ammo_magazine/dijitar_base_slug = -1,
			/obj/item/ammo_magazine/dijitar_base_slug/dijitar_incendiary = -1,
			/obj/item/ammo_magazine/dijitar_base_slug/dijitar_buckshot = -1,
			/obj/item/ammo_magazine/dijitar_base_slug/dijitar_flechette = -1,
