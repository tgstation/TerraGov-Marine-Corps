/obj/machinery/vending/weapon
	...
	products = list(
		...
		"Bulk Ammunition" = list(
			...
			/obj/item/big_ammo_box/c10x265mm = -1,
			/obj/item/big_ammo_box/c10x27mm = -1,
			/obj/item/big_ammo_box/c10x25mm = -1,
			/obj/item/big_ammo_box/c492x34mm = -1,
			/obj/item/big_ammo_box/c86x70mm = -1,
			/obj/item/big_ammo_box/cstandardautoshotgun = -1,
			/obj/item/big_ammo_box/cstandardautoshotgun/flechette = -1,
			/obj/item/big_ammo_box/c9mm = -1,
			/obj/item/big_ammo_box/cmagnum = -1,
			/obj/item/big_ammo_box/cacp = -1,
			/obj/item/big_ammo_box/c9mmap = -1,
			/obj/item/big_ammo_box/c4570 = -1,
			/obj/item/big_ammo_box/cthreeightyacp = -1,
