...
/obj/machinery/vending/uniform_supply
	...
	products = list(
		"Standard" = list(
			...
			/obj/item/clothing/under/marine/squad/delta = -1,
			/obj/item/clothing/under/marine/squad/charile = -1,
			/obj/item/clothing/under/marine/squad/bravo = -1,
			/obj/item/clothing/under/marine/squad/alpha = -1,
