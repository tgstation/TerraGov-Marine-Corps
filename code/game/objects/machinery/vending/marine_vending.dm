/obj/machinery/vending/weapon
	...
	products = list(
		...
		"Specialized" = list(
			...
			/obj/item/weapon/gun/stream_flamethrower = 3,
			/obj/item/ammo_magazine/flamer_tank/stream = -1,
...
/obj/machinery/vending/weapon/valhalla
	...
	products = list(
		...
		"Specialized" = list(
			...
			/obj/item/weapon/gun/stream_flamethrower = -1,
			/obj/item/ammo_magazine/flamer_tank/stream = -1,
			/obj/item/ammo_magazine/flamer_tank/stream_backtank = -1,
