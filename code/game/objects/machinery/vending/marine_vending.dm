...
/obj/machinery/vending/marine
	...
	products = list(
		/obj/item/weapon/gun/pistol/rt3 = 25,
		/obj/item/ammo_magazine/pistol = 30,
		/obj/item/weapon/gun/pistol/highpower = 10,
		/obj/item/ammo_magazine/pistol/highpower = 25,
		/obj/item/weapon/gun/pistol/heavy = 15,
		/obj/item/ammo_magazine/pistol/heavy = 25,
		/obj/item/weapon/gun/smg/skorpion = 20,
		/obj/item/ammo_magazine/smg/skorpion = 30,
		/obj/item/weapon/gun/smg/ppsh = 20,
		/obj/item/ammo_magazine/smg/ppsh = 30,
		/obj/item/weapon/gun/rifle/standard_assaultrifle/som = 25,
		/obj/item/ammo_magazine/rifle/standard_assaultrifle/som = 25,
		/obj/item/weapon/gun/rifle/standard_br/som = 10,
		/obj/item/ammo_magazine/rifle/standard_br/som = 25,
		/obj/item/weapon/gun/shotgun/pump/bolt = 20,
		/obj/item/ammo_magazine/rifle/bolt = 20,
		/obj/item/weapon/gun/shotgun/pump/t35/som = 10,
		/obj/item/ammo_magazine/shotgun = 10,
		/obj/item/ammo_magazine/shotgun/buckshot = 10,
		/obj/item/ammo_magazine/shotgun/flechette = 10,
		/obj/item/explosive/grenade/frag/stick = 30,
...
/obj/machinery/vending/marine/cargo_guns
	...
	products = list(
		/obj/item/weapon/gun/pistol/rt3 = 25,
		/obj/item/weapon/gun/pistol/highpower = 10,
		/obj/item/weapon/gun/pistol/heavy = 10,
		/obj/item/weapon/gun/smg/ppsh = 10,
		/obj/item/weapon/gun/smg/skorpion = 10,
		/obj/item/weapon/gun/rifle/standard_assaultrifle/som = 10,
		/obj/item/weapon/gun/rifle/standard_br/som = 10,
		/obj/item/weapon/gun/shotgun/pump/t35/som = 10,
		/obj/item/weapon/gun/shotgun/pump/cmb = 5,
		/obj/item/weapon/gun/shotgun/pump/bolt = 10,
		/obj/item/weapon/gun/flamer/marinestandard = 2,
		/obj/item/explosive/mine = 5,
		/obj/item/explosive/grenade/frag/stick = 25,
		/obj/item/explosive/grenade/incendiary/molotov = 25,
...
/obj/machinery/vending/marine/cargo_ammo
	...
	products = list(
		...
		/obj/item/ammo_magazine/rifle/standard_assaultrifle/som = 50,
		/obj/item/ammo_magazine/rifle/standard_br/som = 50,
		/obj/item/ammo_magazine/rifle/bolt = 50,
