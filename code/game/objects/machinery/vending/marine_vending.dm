...
/obj/machinery/vending/MarineMed
	...
	products = list(
		"Pill Bottle" = list(
			/obj/item/storage/pill_bottle/bicaridine = 24,
			/obj/item/storage/pill_bottle/kelotane = 24,
			/obj/item/storage/pill_bottle/tramadol = 24,
			/obj/item/storage/pill_bottle/tricordrazine = 24,
			/obj/item/storage/pill_bottle/inaprovaline = 24,
			/obj/item/storage/pill_bottle/dexalin = 24,
			/obj/item/storage/pill_bottle/dylovene = 24,
			/obj/item/storage/pill_bottle/spaceacillin = 24,
			/obj/item/storage/pill_bottle/alkysine = 24,
			/obj/item/storage/pill_bottle/imidazoline = 24,
