/obj/machinery/vending/weapon
	...
	products = list(
		...
		"SMGs" = list(
			...
			/obj/item/weapon/gun/smg/standard_stormsmg = -1,
			/obj/item/ammo_magazine/smg/standard_stormsmg = -1,
			/obj/item/ammo_magazine/smg/standard_stormsmg/drum = 4,
		),
		"Marksman" = list(
...
/obj/machinery/vending/weapon/valhalla
	...
	products = list(
		...
		"SMGs" = list(
			...
			/obj/item/weapon/gun/smg/standard_stormsmg = -1,
			/obj/item/ammo_magazine/smg/standard_stormsmg = -1,
			/obj/item/ammo_magazine/smg/standard_stormsmg/drum = -1,
		),
		"Marksman" = list(
			/obj/item/weapon/gun/rifle/standard_dmr = -1,
			/obj/item/ammo_magazine/rifle/standard_dmr = -1,
