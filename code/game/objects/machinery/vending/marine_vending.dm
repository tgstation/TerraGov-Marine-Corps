...
/obj/machinery/vending/cargo_supply
	...
	products = list(
		...
		"Supply Crates" = list(
			/obj/structure/closet/crate/vendable_crates =-1,
			/obj/structure/closet/crate/vendable_crates/alpha = -1,
			/obj/structure/closet/crate/vendable_crates/bravo = -1,
			/obj/structure/closet/crate/vendable_crates/charlie = -1,
			/obj/structure/closet/crate/vendable_crates/delta = -1,
			/obj/structure/closet/crate/vendable_crates/ammo = -1,
			/obj/structure/closet/crate/vendable_crates/weapon = -1,
			/obj/structure/closet/crate/vendable_crates/medical = -1,
			/obj/structure/closet/crate/vendable_crates/construction = -1,
			/obj/structure/closet/crate/vendable_crates/explosives = -1,
			/obj/structure/closet/crate/vendable_crates/supply = -1,
		),
		"Mecha Ammo" = list(
