...
/obj/machinery/vending/marine
	...
	products = list(
		...
		/obj/item/weapon/gun/grenade_launcher/multinade_launcher = 10,
		/obj/item/weapon/gun/grenade_launcher/single_shot = 15,
...
/obj/machinery/vending/uniform_supply
	...
	products = list(
		"Clothing" = list(
			...
			/obj/item/clothing/under/marine/sniper =-1,
			/obj/item/clothing/under/marine/tanker =-1,
			/obj/item/clothing/under/marine/mp =-1,
			/obj/item/clothing/under/marine/officer =-1,
			/obj/item/clothing/under/marine/officer/warden =-1,
			/obj/item/clothing/under/marine/officer/hos =-1,
			/obj/item/clothing/under/marine/officer/technical =-1,
			/obj/item/clothing/under/marine/officer/logistics =-1,
			/obj/item/clothing/under/marine/officer/pilot =-1,
			/obj/item/clothing/under/marine/officer/tanker =-1,
