...
/obj/machinery/vending/mech_vendor
	...
	products = list(
		"Weapon" = list(
			...
			/obj/item/mecha_parts/mecha_equipment/weapon/ballistic/smartgun = -1,
			/obj/item/mecha_parts/mecha_equipment/weapon/energy/volkite = -1,
		),
		"Ammo" = list(
			/obj/item/mecha_ammo/vendable/lmg = -1,
			/obj/item/mecha_ammo/vendable/rifle = -1,
			...
			/obj/item/mecha_ammo/vendable/grenade = -1,
			/obj/item/mecha_ammo/vendable/flamer = -1,
			/obj/item/mecha_ammo/vendable/smartgun = -1,
		),
		"Equipment" = list(
...
/obj/machinery/vending/mech_vendor/tgmc
	name = "\improper TGMC Mech equipment vendor"
	desc = "An automated rack hooked up to a colossal storage of items."
	icon_state = "requisitionop"
	resistance_flags = INDESTRUCTIBLE
	use_power = NO_POWER_USE
...
/obj/machinery/vending/mech_vendor/som
	name = "\improper SOM Mech equipment vendor"
	desc = "An automated rack hooked up to a colossal storage of items."
	icon_state = "requisitionop"
	resistance_flags = INDESTRUCTIBLE
	use_power = NO_POWER_USE
