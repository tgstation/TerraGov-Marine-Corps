/obj/machinery/vending/weapon
	...
	products = list(
		...
		"Specialized Ammunition" = list(
			...
			/obj/item/ammo_magazine/rifle/standard_assaultrifle/incendiary = -1,
			/obj/item/ammo_magazine/rifle/standard_assaultrifle/cryogenic = -1,
			/obj/item/ammo_magazine/rifle/standard_assaultrifle/ricochet = -1,
			/obj/item/ammo_magazine/rifle/standard_assaultrifle/wallpierce = -1,
			/obj/item/ammo_magazine/rifle/standard_carbine/squashhead = -1,
			/obj/item/ammo_magazine/rifle/standard_carbine/flak = -1,
			/obj/item/ammo_magazine/rifle/standard_carbine/depleteduranium = -1,
			/obj/item/ammo_magazine/rifle/standard_carbine/incendiary = -1,
			/obj/item/ammo_magazine/rifle/standard_carbine/cryogenic = -1,
			/obj/item/ammo_magazine/rifle/standard_carbine/ricochet = -1,
			/obj/item/ammo_magazine/rifle/standard_carbine/wallpierce = -1,
			/obj/item/ammo_magazine/standard_lmg/squashhead = -1,
			/obj/item/ammo_magazine/standard_lmg/flak = -1,
			/obj/item/ammo_magazine/standard_lmg/depleteduranium = -1,
			/obj/item/ammo_magazine/standard_lmg/incendiary = -1,
			/obj/item/ammo_magazine/standard_lmg/cryogenic = -1,
			/obj/item/ammo_magazine/standard_lmg/ricochet = -1,
			/obj/item/ammo_magazine/standard_lmg/wallpierce = -1,
		),
	)
