...
/obj/machinery/vending/cargo_supply
	...
	products = list(
		...
		"Supply Crates" = list(
			...
			/obj/structure/closet/crate/alpha = -1,
			/obj/structure/closet/crate/bravo = -1,
			/obj/structure/closet/crate/charlie = -1,
			/obj/structure/closet/crate/delta = -1,
			/obj/structure/closet/crate/ammo = -1,
			/obj/structure/closet/crate/weapon = -1,
			/obj/structure/closet/crate/medical = -1,
			/obj/structure/closet/crate/construction = -1,
			/obj/structure/closet/crate/explosives = -1,
			/obj/structure/closet/crate/supply = -1,
		),
		"Mecha Ammo" = list(
