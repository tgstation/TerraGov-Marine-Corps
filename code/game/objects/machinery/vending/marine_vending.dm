...
/obj/machinery/vending/uniform_supply
	...
	products = list(
		...
		"Backpacks" = list(
			...
			/obj/item/storage/holster/t35 = -1,
		),
		"Instruments" = list(
...
/obj/machinery/vending/weapon/som
	...
	products = list(
		"Rifles" = list(
			...
			/obj/item/ammo_magazine/rifle/som = -1,
			/obj/item/ammo_magazine/rifle/som/ap = 15,
		...
		"SMGs" = list(
			/obj/item/weapon/gun/smg/som = -1,
			/obj/item/ammo_magazine/smg/som = -1,
			/obj/item/ammo_magazine/smg/som/ap = 15,
...
/obj/machinery/vending/som/armor_supply
	...
	products = list(
		...
		"Armor modules" = list(
			...
			/obj/item/armor_module/module/fire_proof_helmet = 3,
