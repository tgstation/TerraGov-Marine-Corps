...
/obj/machinery/marine_selector/clothes/medic
	...
	listed_products = list(
		...
		/obj/item/storage/pouch/autoinjector/full = list(CAT_POU, "Autoinjector pouch", 0, "black"),
		/obj/item/storage/pouch/shotgun = list(CAT_POU, "Shotgun shell pouch", 0, "black"),
		/obj/item/storage/pouch/magazine = list(CAT_POU, "Magazine pouch", 0, "black"),
		/obj/item/storage/pouch/general/medium = list(CAT_POU, "Medium general pouch", 0, "black"),
		/obj/item/storage/pouch/flare/full = list(CAT_POU, "Flare pouch", 0, "black"),
...
/obj/machinery/marine_selector/gear/medic
	...
	listed_products = list(
		...
		/obj/item/storage/pill_bottle/tricordrazine = list(CAT_MEDSUP, "Pillbottle (Tricordrazine)", 16, "orange"),
		/obj/item/storage/pill_bottle/paracetamol = list(CAT_MEDSUP, "Pillbottle (Paracetamol)", 15, "black"),
		...
		/obj/item/reagent_containers/glass/bottle/alkysine = list(CAT_MEDSUP, "60u Alkysine", 5, "black"),
		/obj/item/reagent_containers/glass/bottle/synaptizine = list(CAT_MEDSUP, "60u Synaptizine", 5, "black"),
		/obj/item/reagent_containers/hypospray/autoinjector/hyperzine = list(CAT_MEDSUP, "Injector (Hyperzine)", 6, "orange"),
		/obj/item/reagent_containers/hypospray/autoinjector/synaptizine = list(CAT_MEDSUP, "Injector (Synaptizine)", 7, "orange"),
		/obj/item/reagent_containers/hypospray/autoinjector/neuraline = list(CAT_MEDSUP, "Injector (Neuraline)", 10, "orange"),
