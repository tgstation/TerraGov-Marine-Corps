...
/obj/machinery/marine_selector/clothes/engi
	...
	listed_products = list(
							...
							/obj/effect/essentials_set/basic_engineer = list(xxx, "Standard Kit", 0, MARINE_CAN_BUY_UNIFORM, "white"),
							null = list(xxx, "ARMOR (choose 1)", 0, null, null),
							/obj/item/clothing/suit/storage/marine = list(xxx, "Regular Armor", 0, MARINE_CAN_BUY_ARMOR, "orange"),
							/obj/item/clothing/suit/storage/marine/M3HB = list(xxx, "Heavy Armor", 0, MARINE_CAN_BUY_ARMOR, "black"),
							/obj/item/clothing/suit/storage/marine/M3LB = list(xxx, "Light Armor", 0, MARINE_CAN_BUY_ARMOR, "black"),
							/obj/item/clothing/suit/storage/marine/M3P = list(xxx, "Ballistic Armor", 0, MARINE_CAN_BUY_ARMOR, "black"),
							/obj/item/clothing/suit/storage/marine/M3IS = list(xxx, "Integrated Storage Armor", 0, MARINE_CAN_BUY_ARMOR, "black"),
							/obj/item/clothing/suit/storage/marine/M3E = list(xxx, "Edge Melee Armor", 0, MARINE_CAN_BUY_ARMOR, "black"),
							/obj/item/clothing/suit/storage/marine/harness = list(xxx, "Harness", 0, MARINE_CAN_BUY_ARMOR, "black"),
							null = list(xxx, "BACKPACK (choose 1)", 0, null, null),
							/obj/item/storage/backpack/marine/satchel/tech = list(xxx, "Satchel", 0, MARINE_CAN_BUY_BACKPACK, "orange"),
							/obj/item/storage/backpack/marine/tech = list(xxx, "Backpack", 0, MARINE_CAN_BUY_BACKPACK, "black"),
							...
							/obj/item/storage/backpack/marine/engineerpack = list(xxx, "Welderpack", 0, MARINE_CAN_BUY_BACKPACK, "black"),
							null = list(xxx, "WEBBING (choose 1)", 0, null, null),
							/obj/item/clothing/tie/storage/brown_vest = list(xxx, "Tactical Brown Vest", 0, MARINE_CAN_BUY_WEBBING, "orange"),
							...
							/obj/item/storage/belt/utility/full = list(xxx, "Tool belt", 0, MARINE_CAN_BUY_BELT, "orange"),
							...
							/obj/item/storage/pouch/construction = list(xxx, "Construction pouch", 0, (MARINE_CAN_BUY_R_POUCH|MARINE_CAN_BUY_L_POUCH), "orange"),
							/obj/item/storage/pouch/explosive = list(xxx, "Explosive pouch", 0, (MARINE_CAN_BUY_R_POUCH|MARINE_CAN_BUY_L_POUCH), "black"),
							/obj/item/storage/pouch/tools/full = list(xxx, "Tools pouch", 0, (MARINE_CAN_BUY_R_POUCH|MARINE_CAN_BUY_L_POUCH), "black"),
							/obj/item/storage/pouch/electronics/full = list(xxx, "Electronics pouch", 0, (MARINE_CAN_BUY_R_POUCH|MARINE_CAN_BUY_L_POUCH), "black"),
							/obj/item/storage/pouch/magazine = list(xxx, "Magazine pouch", 0, (MARINE_CAN_BUY_R_POUCH|MARINE_CAN_BUY_L_POUCH), "black"),
							...
							/obj/item/storage/pouch/firstaid/full = list(xxx, "Firstaid pouch", 0, (MARINE_CAN_BUY_R_POUCH|MARINE_CAN_BUY_L_POUCH), "orange"),
							...
							/obj/item/clothing/mask/gas = list(xxx, "Gas mask", 0, MARINE_CAN_BUY_MASK, "black"),
							/obj/item/clothing/mask/rebreather/scarf = list(xxx, "Heat absorbent coif", 0, MARINE_CAN_BUY_MASK, "black"),
							/obj/item/clothing/mask/rebreather = list(xxx, "Rebreather", 0, MARINE_CAN_BUY_MASK, "black"),
							)
...
/obj/machinery/marine_selector/clothes/medic
	...
	listed_products = list(
							null = list(xxx, "STANDARD EQUIPMENT (take all)", 0, null, null),
							/obj/effect/essentials_set/basic_medic = list(xxx, "Standard Kit", 0, MARINE_CAN_BUY_UNIFORM, "white"),
							null = list(xxx, "ARMOR (choose 1)", 0, null, null),
							/obj/item/clothing/suit/storage/marine = list(xxx, "Regular Armor", 0, MARINE_CAN_BUY_ARMOR, "orange"),
							/obj/item/clothing/suit/storage/marine/M3HB = list(xxx, "Heavy Armor", 0, MARINE_CAN_BUY_ARMOR, "black"),
							/obj/item/clothing/suit/storage/marine/M3LB = list(xxx, "Light Armor", 0, MARINE_CAN_BUY_ARMOR, "black"),
							...
							/obj/item/clothing/suit/storage/marine/harness = list(xxx, "Harness", 0, MARINE_CAN_BUY_ARMOR, "black"),
							null = list(xxx, "BACKPACK (choose 1)", 0, null, null),
							/obj/item/storage/backpack/marine/satchel/corpsman = list(xxx, "Satchel", 0, MARINE_CAN_BUY_BACKPACK, "orange"),
							/obj/item/storage/backpack/marine/corpsman = list(xxx, "Backpack", 0, MARINE_CAN_BUY_BACKPACK, "black"),
							null = list(xxx, "WEBBING (choose 1)", 0, null, null),
							/obj/item/clothing/tie/storage/brown_vest = list(xxx, "Tactical Brown Vest", 0, MARINE_CAN_BUY_WEBBING, "orange"),
							/obj/item/clothing/tie/storage/white_vest/medic = list(xxx, "Corpsman White Vest", 0, MARINE_CAN_BUY_WEBBING, "black"),
							/obj/item/clothing/tie/storage/webbing = list(xxx, "Tactical Webbing", 0, MARINE_CAN_BUY_WEBBING, "black"),
							/obj/item/clothing/tie/holster = list(xxx, "Shoulder Handgun Holster", 0, MARINE_CAN_BUY_WEBBING, "black"),
							null = list(xxx, "BELT (choose 1)", 0, null, null),
							/obj/item/storage/belt/combatLifesaver = list(xxx, "Lifesaver belt", 0, MARINE_CAN_BUY_BELT, "orange"),
							/obj/item/storage/belt/medical = list(xxx, "Medical belt", 0, MARINE_CAN_BUY_BELT, "black"),
							null = list(xxx, "POUCHES (choose 2)", 0, null, null),
							/obj/item/storage/pouch/medical = list(xxx, "Medical pouch", 0, (MARINE_CAN_BUY_R_POUCH|MARINE_CAN_BUY_L_POUCH), "orange"),
							/obj/item/storage/pouch/medkit = list(xxx, "Medkit pouch", 0, (MARINE_CAN_BUY_R_POUCH|MARINE_CAN_BUY_L_POUCH), "orange"),
...
/obj/machinery/marine_selector/clothes/smartgun
	...
	listed_products = list(
							null = list(xxx, "STANDARD EQUIPMENT (take all)", 0, null, null),
							/obj/effect/essentials_set/basic_smartgunner = list(xxx, "Standard Kit", 0, MARINE_CAN_BUY_UNIFORM, "white"),
							null = list(xxx, "WEBBING (choose 1)", 0, null, null),
							/obj/item/clothing/tie/storage/black_vest = list(xxx, "Tactical Black Vest", 0, MARINE_CAN_BUY_WEBBING, "orange"),
							/obj/item/clothing/tie/storage/webbing = list(xxx, "Tactical Webbing", 0, MARINE_CAN_BUY_WEBBING, "black"),
							/obj/item/clothing/tie/holster = list(xxx, "Shoulder Handgun Holster", 0, MARINE_CAN_BUY_WEBBING, "black"),
							null = list(xxx, "BELT (choose 1)", 0, null, null),
							/obj/item/storage/large_holster/m39 = list(xxx, "M39 holster belt", 0, MARINE_CAN_BUY_BELT, "orange"),
							...
							/obj/item/storage/pouch/magazine = list(xxx, "Magazine pouch", 0, (MARINE_CAN_BUY_R_POUCH|MARINE_CAN_BUY_L_POUCH), "black"),
							/obj/item/storage/pouch/general/medium = list(xxx, "Medium general pouch", 0, (MARINE_CAN_BUY_R_POUCH|MARINE_CAN_BUY_L_POUCH), "black"),
							/obj/item/storage/pouch/flare/full = list(xxx, "Flare pouch", 0, (MARINE_CAN_BUY_R_POUCH|MARINE_CAN_BUY_L_POUCH), "orange"),
							/obj/item/storage/pouch/firstaid/full = list(xxx, "Firstaid pouch", 0, (MARINE_CAN_BUY_R_POUCH|MARINE_CAN_BUY_L_POUCH), "orange"),
							/obj/item/storage/pouch/magazine/pistol/large = list(xxx, "Large pistol magazine pouch", 0, (MARINE_CAN_BUY_R_POUCH|MARINE_CAN_BUY_L_POUCH), "black"),
							/obj/item/storage/pouch/pistol = list(xxx, "Sidearm pouch", 0, (MARINE_CAN_BUY_R_POUCH|MARINE_CAN_BUY_L_POUCH), "black"),
							null = list(xxx, "MASKS", 0, null, null),
...
/obj/machinery/marine_selector/clothes/specialist
	...
	listed_products = list(
							null = list(xxx, "STANDARD EQUIPMENT (take all)", 0, null, null),
							/obj/effect/essentials_set/basic_specialist = list(xxx, "Standard Kit", 0, MARINE_CAN_BUY_UNIFORM, "white"),
							null = list(xxx, "BACKPACK (choose 1)", 0, null, null),
...
/obj/machinery/marine_selector/clothes/synth
	...
	listed_products = list(
							...
							null = list(xxx, "MASKS", 0, null, null),
							/obj/item/clothing/mask/surgical = list(xxx, "Sterile mask", 0, MARINE_CAN_BUY_MASK, "black"),
							/obj/item/clothing/mask/rebreather = list(xxx, "Rebreather", 0, MARINE_CAN_BUY_MASK, "black"),
							/obj/item/clothing/mask/rebreather/scarf = list(xxx, "Heat absorbent coif", 0, MARINE_CAN_BUY_MASK, "black"),
							/obj/item/clothing/mask/gas = list(xxx, "Gas mask", 0, MARINE_CAN_BUY_MASK, "black"),
							)
