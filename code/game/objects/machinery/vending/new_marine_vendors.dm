...
/obj/machinery/marine_selector/gear/medic
	...
	listed_products = list(
		...
		/obj/item/storage/pill_bottle/bicamera = list(CAT_MEDSUP, "BicaMera pills", 20, "orange"),
		/obj/item/storage/pill_bottle/keloderm = list(CAT_MEDSUP, "KeloDerm pills", 20, "orange"),
		/obj/item/storage/pill_bottle/paracetamol = list(CAT_MEDSUP, "Paracetamol pills", 5, "black"),
		/obj/item/storage/pill_bottle/bicaridine = list(CAT_MEDSUP, "Bicaridine pills", 7, "black"),
		/obj/item/storage/pill_bottle/kelotane = list(CAT_MEDSUP, "Kelotane pills", 7, "black"),
		/obj/item/storage/pill_bottle/tramadol = list(CAT_MEDSUP, "Tramadol pills", 5, "orange"),
		/obj/item/storage/pill_bottle/tricordrazine = list(CAT_MEDSUP, "Tricordrazine", 7, "black"),
		/obj/item/storage/syringe_case/meralyne = list(CAT_MEDSUP, "syringe Case (120u Meralyne)", 22, "black"),
		/obj/item/storage/syringe_case/meralyne/half = list(CAT_MEDSUP, "syringe Case (60u Meralyne)", 10, "black"), //half the units of the mera case half the price
		/obj/item/reagent_containers/hypospray/advanced/meralyne = list(CAT_MEDSUP, "hypospray (60u Meralyne)", 13, "black"),
		/obj/item/storage/syringe_case/dermaline = list(CAT_MEDSUP, "syringe Case (120u Dermaline)", 22, "orange"),
		/obj/item/storage/syringe_case/dermaline/half = list(CAT_MEDSUP, "syringe Case (60u Dermaline)", 10, "orange"), //half the units of the derm case half the price
		/obj/item/reagent_containers/hypospray/advanced/dermaline = list(CAT_MEDSUP, "hypospray (60u dermaline)", 13, "orange"),
		/obj/item/storage/syringe_case/meraderm = list(CAT_MEDSUP, "syringe Case (120u Meraderm)", 24, "orange"),
		/obj/item/storage/syringe_case/meraderm/half = list(CAT_MEDSUP, "syringe Case (60u Meraderm)", 12, "black"), //half the units of the meraderm case half the price
		/obj/item/reagent_containers/hypospray/advanced/meraderm = list(CAT_MEDSUP, "hypospray (60u Meraderm)", 15, "orange"),
		...
		/obj/item/storage/syringe_case/tricordrazine = list(CAT_MEDSUP, "syringe Case (120u Tricordrazine)", 8, "black"),
		/obj/item/storage/syringe_case/tricordrazine/half = list(CAT_MEDSUP, "syringe Case (60u Tricordrazine)", 4, "black"),
		/obj/item/reagent_containers/hypospray/advanced/tricordrazine = list(CAT_MEDSUP, "hypospray (60u Tricordrazine)", 6, "black"),
