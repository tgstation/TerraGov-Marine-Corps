...
/obj/machinery/marine_selector/clothes
	...
	listed_products = list(
		...
		/obj/item/clothing/suit/storage/marine/lightpasvest = list(CAT_AMR, "Light armor", 0, "orange"),
		/obj/item/clothing/suit/storage/marine/pasvest = list(CAT_AMR, "Classic armor", 0, "orange"),
		/obj/item/clothing/suit/storage/marine/heavypasvest = list(CAT_AMR, "Heavy armor", 0, "orange"),
