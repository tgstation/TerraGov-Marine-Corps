...
/obj/effect/vendor_bundle/commander/fancyswordandstuff
	gear_to_spawn = list(
		/obj/item/storage/holster/belt/pistol/m4a3/fieldcommander,
		/obj/item/hud_tablet/fieldcommand,
		/obj/item/storage/pouch/general/large/command,
		/obj/item/storage/holster/blade/officer/full,
	)
