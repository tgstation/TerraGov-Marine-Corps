...
/obj/machinery/marine_selector/gear/leader
	...
	listed_products = list(
		...
		/obj/item/weapon/gun/rifle/lmg = list(CAT_LEDSUP, "M41AE2 heavy pulse rifle", 10, "orange"),
		/obj/item/ammo_magazine/lmg = list(CAT_LEDSUP, "M41AE2 magazine", 3, "black"),
		/obj/item/ammo_magazine/lmg/ap = list(CAT_LEDSUP, "M41AE2 AP magazine", 5, "black"),
		/obj/item/ammo_magazine/lmg/incendiary = list(CAT_LEDSUP, "M41AE2 incendiary magazine", 10, "black"),
