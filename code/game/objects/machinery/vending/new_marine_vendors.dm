...
/obj/machinery/marine_selector/clothes/commander/Initialize()
	...
	listed_products = list(
		...
		/obj/item/clothing/suit/modular/pas11x = list(CAT_AMR, "PAS flak armor", 0, "orange"),
		/obj/item/clothing/suit/modular/pas11x/xenonautenl = list(CAT_AMR, "Xenonauten-L pattern armor", 0, "orange"),
		/obj/item/clothing/suit/modular/pas11x/xenonautenm = list(CAT_AMR, "Xenonauten-M pattern armor", 0, "orange"),
		/obj/item/clothing/suit/modular/pas11x/xenonautenh = list(CAT_AMR, "Xenonauten-H pattern armor", 0, "orange"),
