...
/obj/machinery/marine_selector/clothes/commander/Initialize()
	...
	listed_products = list(
		...
		/obj/item/armor_module/module/welding = list(CAT_HEL, "Xenoanuten welding module", 0, "orange"),
		/obj/item/armor_module/module/binoculars =  list(CAT_HEL, "Xenoanuten binoculars module", 0, "orange"),
		/obj/item/armor_module/module/antenna = list(CAT_HEL, "Xenoanuten Antenna module", 0, "orange"),
