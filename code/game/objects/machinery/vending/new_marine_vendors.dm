...
/obj/machinery/marine_selector/gear/leader
	...
	listed_products = list(
		...
		/obj/item/weapon/gun/rifle/standard_lmg = list(CAT_LEDSUP, "T-42 LMG", 12, "orange"),
		/obj/item/ammo_magazine/standard_lmg = list(CAT_LEDSUP, "T-42 LMG magazine", 4, "black"),
