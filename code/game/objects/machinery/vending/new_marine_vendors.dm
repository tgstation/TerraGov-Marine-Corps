...
/obj/machinery/marine_selector/clothes
	...
	listed_products = list(
		...
		/obj/effect/essentials_set/tyr = list(CAT_ARMMOD, "Mark 1 Tyr extra armor module", 0,"black"),
...
/obj/effect/essentials_set/tyr
	desc = "A set of general resistance armor setup to protect one from damaging threats."
	spawned_gear_list = list(
