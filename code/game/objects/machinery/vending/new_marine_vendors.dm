...
/obj/machinery/marine_selector/clothes/synth
	...
	listed_products = list(
		...
		/obj/item/clothing/under/marine/officer/logistics = list(CAT_STD, "Logistics officer uniform", 0, "black"),
		/obj/item/clothing/under/marine/officer/warrant = list(CAT_STD, "Warrant Officer uniform", 0, "black"),
		...
		/obj/item/clothing/under/rank/warden = list(CAT_STD, "Security Suit", 0, "black"),
		/obj/item/clothing/under/rank/chef/altchef = list(CAT_STD, "Alt Chef uniform", 0, "black"),
		/obj/item/clothing/under/rank/vice = list(CAT_STD, "Vice Officer's uniform", 0, "black"),
		/obj/item/clothing/under/rank/security/mallcop = list(CAT_STD, "Mall Cop uniform", 0, "black"),
		...
		/obj/item/clothing/under/suit_jacket/red = list(CAT_STD, "Red Suit Jacket", 0, "black"),
		/obj/item/clothing/under/suit_jacket/navy = list(CAT_STD, "Navy Suit Jacket", 0, "black"),
		/obj/item/clothing/under/suit_jacket/female = list(CAT_STD, "Executive's Suit", 0, "black"),
		/obj/item/clothing/under/suit_jacket/checkered = list(CAT_STD, "Checkered Suit Jacket", 0, "black"),
		/obj/item/clothing/under/suit_jacket/burgundy = list(CAT_STD, "Burgundy Suit Jacket", 0, "black"),
		/obj/item/clothing/under/suit_jacket/charcoal = list(CAT_STD, "Charcoal Suit Jacket", 0, "black"),
		...
		/obj/item/clothing/suit/poncho = list(CAT_AMR, "Poncho", 0, "black"),
		/obj/item/clothing/suit/poncho/green = list(CAT_AMR, "Green Poncho", 0, "black"),
		/obj/item/clothing/suit/poncho/red = list(CAT_AMR, "Red Poncho", 0, "black"),
		...
		/obj/item/clothing/suit/chaplain_hoodie = list(CAT_AMR, "Chaplain Hoodie", 0, "black"),
		/obj/item/storage/backpack/marine/satchel = list(CAT_BAK, "Satchel", 0, "black"),
		...
		/obj/item/clothing/head/mailman = list(CAT_HEL, "Mailman's hat", 0, "black"),
