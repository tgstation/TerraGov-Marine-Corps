...
/obj/machinery/marine_selector/clothes/commander/Initialize()
	...
	listed_products = list(
		...
		/obj/item/clothing/suit/modular/pas11x = list(CAT_AMR, "PAS-11X flak vest", 0, "orange"),
		/obj/item/clothing/suit/modular/pas11x/xenonautenl=list(CAT_AMR, "Xenonauten-Light Pattern Armor", 0, "orange"),
		/obj/item/clothing/suit/modular/pas11x/xenonautenm=list(CAT_AMR, "Xenonauten-Medium Pattern Armor", 0, "orange"),
		/obj/item/clothing/suit/modular/pas11x/xenonautenh=list(CAT_AMR, "Xenonauten-Heavy Pattern Armor", 0, "orange"),
