...
/obj/machinery/vending/medical/rebel
	...
	products = list(
		...
		"Reagent Bottle" = list(
			/obj/item/reagent_containers/glass/bottle/bicaridine = 10,
			/obj/item/reagent_containers/glass/bottle/dylovene = 10,
			/obj/item/reagent_containers/glass/bottle/inaprovaline = 10,
			/obj/item/reagent_containers/glass/bottle/sleeptoxin = 2,
			/obj/item/reagent_containers/glass/bottle/spaceacillin = 10,
			/obj/item/reagent_containers/glass/bottle/peridaxon = 6,
			/obj/item/reagent_containers/glass/bottle/kelotane = 10,
			/obj/item/reagent_containers/glass/bottle/dexalin = 10,
			/obj/item/reagent_containers/glass/bottle/tramadol = 10,
			/obj/item/reagent_containers/glass/bottle/oxycodone = 10,
			/obj/item/reagent_containers/glass/bottle/polyhexanide = 12,
			/obj/item/reagent_containers/glass/bottle/medicalnanites = 12,
		),
		"Pill Bottle" = list(
