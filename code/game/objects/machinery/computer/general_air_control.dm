...
/obj/machinery/computer/general_air_control/large_tank_control/return_text()
	...
	if(input_info)
		...
		output += "<B>Input</B>: [power?("Injecting"):("On Hold")] <A href='byond://?src=[text_ref(src)];in_refresh_status=1'>Refresh</A><BR>Flow Rate Limit: [volume_rate] L/s<BR>"
		output += "Command: <A href='byond://?src=[text_ref(src)];in_toggle_injector=1'>Toggle Power</A> <A href='byond://?src=[text_ref(src)];in_set_flowrate=1'>Set Flow Rate</A><BR>"

	else
		output += "<FONT color='red'>ERROR: Can not find input port</FONT> <A href='byond://?src=[text_ref(src)];in_refresh_status=1'>Search</A><BR>"

	output += "Flow Rate Limit: <A href='byond://?src=[text_ref(src)];adj_input_flow_rate=-100'>-</A> <A href='byond://?src=[text_ref(src)];adj_input_flow_rate=-10'>-</A> <A href='byond://?src=[text_ref(src)];adj_input_flow_rate=-1'>-</A> <A href='byond://?src=[text_ref(src)];adj_input_flow_rate=-0.1'>-</A> [round(input_flow_setting, 0.1)] L/s <A href='byond://?src=[text_ref(src)];adj_input_flow_rate=0.1'>+</A> <A href='byond://?src=[text_ref(src)];adj_input_flow_rate=1'>+</A> <A href='byond://?src=[text_ref(src)];adj_input_flow_rate=10'>+</A> <A href='byond://?src=[text_ref(src)];adj_input_flow_rate=100'>+</A><BR>"
	...
	if(output_info)
		...
		output += {"<B>Output</B>: [power?("Open"):("On Hold")] <A href='byond://?src=[text_ref(src)];out_refresh_status=1'>Refresh</A><BR>
Max Output Pressure: [output_pressure] kPa<BR>"}
		output += "Command: <A href='byond://?src=[text_ref(src)];out_toggle_power=1'>Toggle Power</A> <A href='byond://?src=[text_ref(src)];out_set_pressure=1'>Set Pressure</A><BR>"

	else
		output += "<FONT color='red'>ERROR: Can not find output port</FONT> <A href='byond://?src=[text_ref(src)];out_refresh_status=1'>Search</A><BR>"

	output += "Max Output Pressure Set: <A href='byond://?src=[text_ref(src)];adj_pressure=-1000'>-</A> <A href='byond://?src=[text_ref(src)];adj_pressure=-100'>-</A> <A href='byond://?src=[text_ref(src)];adj_pressure=-10'>-</A> <A href='byond://?src=[text_ref(src)];adj_pressure=-1'>-</A> [pressure_setting] kPa <A href='byond://?src=[text_ref(src)];adj_pressure=1'>+</A> <A href='byond://?src=[text_ref(src)];adj_pressure=10'>+</A> <A href='byond://?src=[text_ref(src)];adj_pressure=100'>+</A> <A href='byond://?src=[text_ref(src)];adj_pressure=1000'>+</A><BR>"
...
/obj/machinery/computer/general_air_control/supermatter_core/return_text()
	...
	if(input_info)
		var/power = (input_info["power"])
		var/volume_rate = round(input_info["volume_rate"], 0.1)
		output += "<B>Coolant Input</B>: [power?("Injecting"):("On Hold")] <A href='byond://?src=[text_ref(src)];in_refresh_status=1'>Refresh</A><BR>Flow Rate Limit: [volume_rate] L/s<BR>"
		output += "Command: <A href='byond://?src=[text_ref(src)];in_toggle_injector=1'>Toggle Power</A> <A href='byond://?src=[text_ref(src)];in_set_flowrate=1'>Set Flow Rate</A><BR>"
	...
	if(output_info)
		...
		output += {"<B>Core Outpump</B>: [power?("Open"):("On Hold")] <A href='byond://?src=[text_ref(src)];out_refresh_status=1'>Refresh</A><BR>
Min Core Pressure: [pressure_limit] kPa<BR>"}
	...
	output += "Min Core Pressure Set: <A href='byond://?src=[text_ref(src)];adj_pressure=-100'>-</A> <A href='byond://?src=[text_ref(src)];adj_pressure=-50'>-</A> <A href='byond://?src=[text_ref(src)];adj_pressure=-10'>-</A> <A href='byond://?src=[text_ref(src)];adj_pressure=-1'>-</A> [pressure_setting] kPa <A href='byond://?src=[text_ref(src)];adj_pressure=1'>+</A> <A href='byond://?src=[text_ref(src)];adj_pressure=10'>+</A> <A href='byond://?src=[text_ref(src)];adj_pressure=50'>+</A> <A href='byond://?src=[text_ref(src)];adj_pressure=100'>+</A><BR>"
...
/obj/machinery/computer/general_air_control/fuel_injection/return_text()
	...
	if(device_info)
		...
		output += {"Status: [power?("Injecting"):("On Hold")] <A href='byond://?src=[text_ref(src)];refresh_status=1'>Refresh</A><BR>
Rate: [volume_rate] L/sec<BR>"}

		if(automation)
			output += "Automated Fuel Injection: <A href='byond://?src=[text_ref(src)];toggle_automation=1'>Engaged</A><BR>"
			output += "Injector Controls Locked Out<BR>"
		else
			output += "Automated Fuel Injection: <A href='byond://?src=[text_ref(src)];toggle_automation=1'>Disengaged</A><BR>"
			output += "Injector: <A href='byond://?src=[text_ref(src)];toggle_injector=1'>Toggle Power</A> <A href='byond://?src=[text_ref(src)];injection=1'>Inject (1 Cycle)</A><BR>"

	else
		output += "<FONT color='red'>ERROR: Can not find device</FONT> <A href='byond://?src=[text_ref(src)];refresh_status=1'>Search</A><BR>"
