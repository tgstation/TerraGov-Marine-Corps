...
<th>Criminal Status</th>
				...
				if(3.0)
					...
					if ((istype(active2, /datum/data/record) && GLOB.datacore.security.Find(active2)))
						dat += "<BR>\n<CENTER><B>Security Data</B></CENTER><BR>\nCriminal Status: <A href='?src=\ref[src];choice=Edit Field;field=criminal'>[active2.fields["criminal"]]</A><BR>\n<BR>\nMinor Crimes: <A href='?src=\ref[src];choice=Edit Field;field=mi_crim'>[active2.fields["mi_crim"]]</A><BR>\nDetails: <A href='?src=\ref[src];choice=Edit Field;field=mi_crim_d'>[active2.fields["mi_crim_d"]]</A><BR>\n<BR>\nMajor Crimes: <A href='?src=\ref[src];choice=Edit Field;field=ma_crim'>[active2.fields["ma_crim"]]</A><BR>\nDetails: <A href='?src=\ref[src];choice=Edit Field;field=ma_crim_d'>[active2.fields["ma_crim_d"]]</A><BR>\n<BR>\nImportant Notes:<BR>\n\t<A href='?src=\ref[src];choice=Edit Field;field=notes'>[decode(active2.fields["notes"])]</A><BR>\n<BR>\n<CENTER><B>Comments/Log</B></CENTER><BR>"
						var/counter = 1
						while(active2.fields["com_[counter]"])
							dat += "[active2.fields["com_[counter]"]]<BR><A href='?src=\ref[src];choice=Delete Entry;del_c=[counter]'>Delete Entry</A><BR><BR>"
							counter++
