...
/obj/machinery/bioprinter
	...
	var/list/products = list(
		"biotic left arm (125 - Metal)" =  list(/obj/item/robot_parts/biotic/l_arm,  0, LIMB_METAL_AMOUNT, LIMB_PRINTING_TIME),
		"biotic right arm (125 - Metal)" = list(/obj/item/robot_parts/biotic/r_arm,  0, LIMB_METAL_AMOUNT, LIMB_PRINTING_TIME),
		"biotic left leg (125 - Metal)" =  list(/obj/item/robot_parts/biotic/l_leg,  0, LIMB_METAL_AMOUNT, LIMB_PRINTING_TIME),
		"biotic right leg (125 - Metal)" = list(/obj/item/robot_parts/biotic/r_leg,  0, LIMB_METAL_AMOUNT, LIMB_PRINTING_TIME),
