...
/obj/machinery/roomba
	...
	var/static/list/sentences = list(
		...
		"Cmon hurry up, I know you got ships to trash.",
		"Damn, here I was minding my own business, just enjoying my clean station and you people have to trash the place up on me.",
