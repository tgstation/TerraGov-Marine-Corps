...
/obj/structure/barricade/guardrail
	...
	coverage = 25
	max_integrity = 150
	soft_armor = list("melee" = 0, "bullet" = 50, "laser" = 50, "energy" = 50, "bomb" = 15, "bio" = 100, "rad" = 100, BURN = 100, "acid" = 10)
	climbable = FALSE
...
/obj/structure/barricade/metal
	...
	icon_state = "metal_0"
	max_integrity = 200
	soft_armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 100, "rad" = 0, BURN = 80, "acid" = 40)
	coverage = 128
