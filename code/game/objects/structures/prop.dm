...
/obj/structure/prop/mainship/mapping_computer
	...
	desc = "The Common Mapping Production System version II allows for sensory imput from satellites and ship systems to derive planetary maps in a standardized fashion for all NTC pilots."
	icon = 'icons/Marine/mainship_props.dmi'
...
/obj/structure/prop/mainship/ship_memorial
	...
	desc = "A ship memorial dedicated to the triumphs of the NTC and the fallen marines of this ship. On the left there are grand tales of victory etched into the slab. On the right there is a list of famous marines who have fallen in combat serving the NTC."
