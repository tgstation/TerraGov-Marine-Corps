/obj/structure/somcas
	...
	desc = "The premier CAS VTOL of the SOM. Outmatches the NTC Condor in speed and firepower with it's twin S-15 fusion engines, albeit very costly to produce. It can reach an AO and lay heavy fire support within a short length of time."
