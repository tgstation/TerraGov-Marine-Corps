/obj/structure/patrol_point
	...
	var/atom/movable/effect/landmarkpatrol_point/linked_point = null
...
/obj/structure/patrol_point/proc/create_link()
	for(var/atom/movable/effect/landmarkpatrol_point/exit_point AS in GLOB.patrol_point_list)
		if(exit_point.id == id)
