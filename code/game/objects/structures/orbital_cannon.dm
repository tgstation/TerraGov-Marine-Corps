...
/obj/structure/orbital_cannon/proc/fire_ob_cannon(turf/T, mob/user)
	...
	addtimer(CALLBACK(src, /obj/structure/orbital_cannon.proc/impact_callback, target, inaccurate_fuel), WARHEAD_FLY_TIME * (GLOB.orbital_mechanics.current_orbit/3))
