...
/obj/structure/orbital_cannon/proc/fire_ob_cannon(turf/T, mob/user)
	...
	playsound_z_humans(2, 'sound/effects/OB_warning_announce.ogg', 100, FALSE, 20, 4) //for marines on ground
	playsound(target, 'sound/effects/OB_warning_noVO.ogg', 100, FALSE, 20, 4) //for xenomorphs and anyone nearby on ground. can probably be polished to only play to xenos instead
