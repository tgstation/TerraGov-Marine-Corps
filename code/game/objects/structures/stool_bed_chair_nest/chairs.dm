...
/obj/structure/bed/chair/office/Bump(atom/A)
	...
	occupant.apply_effect(modify_by_armor(6, MELEE, def_zone = def_zone), STUN)
	occupant.apply_effect(modify_by_armor(6, MELEE, def_zone = def_zone), WEAKEN)
	occupant.apply_effect(modify_by_armor(6, MELEE, def_zone = def_zone), STUTTER)
	occupant.apply_damage(modify_by_armor(10, MELEE, def_zone = def_zone), BRUTE, def_zone)
	UPDATEHEALTH(occupant)
	playsound(src.loc, 'sound/weapons/punch1.ogg', 25, 1)
	if(isliving(A))
		var/mob/living/victim = A
		def_zone = ran_zone()
		victim.apply_effect(modify_by_armor(6, MELEE, def_zone = def_zone), STUN)
		victim.apply_effect(modify_by_armor(6, MELEE, def_zone = def_zone), WEAKEN)
		victim.apply_effect(modify_by_armor(6, MELEE, def_zone = def_zone), STUTTER)
		victim.apply_damage(modify_by_armor(10, MELEE, def_zone = def_zone), BRUTE, def_zone)
		UPDATEHEALTH(victim)
