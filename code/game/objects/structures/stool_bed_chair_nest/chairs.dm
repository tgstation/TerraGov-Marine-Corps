...
/obj/structure/bed/chair/office/Bump(atom/A)
	...
	if(propelled)
		...
		occupant.apply_effect(6, STUN, blocked, FALSE)
		occupant.apply_effect(6, WEAKEN, blocked, FALSE)
		occupant.apply_effect(6, STUTTER, blocked, FALSE)
		...
		if(isliving(A))
			...
			victim.apply_effect(6, STUN, blocked, FALSE)
			victim.apply_effect(6, WEAKEN, blocked, FALSE)
			victim.apply_effect(6, STUTTER, blocked, FALSE)
