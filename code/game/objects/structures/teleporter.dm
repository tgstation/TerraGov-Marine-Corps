...
/obj/item/teleporter_kit
	...
	desc = "A bluespace telepad for moving personnel and equipment across small distances to another prelinked teleporter. Right Click on a tile to deploy, use a wrench to undeploy, use a crowbar to remove the power cell."
