...
/obj/structure/dropship_equipment/rappel_system/proc/attack_rappel(mob/living/carbon/xenomorph/attacker)
	...
	if(!do_after(attacker, 5 SECONDS, TRUE, src, BUSY_ICON_DANGER, BUSY_ICON_HOSTILE))
		rappel_condition = RAPPEL_CONDITION_GOOD
		rappel_state = RAPPEL_STATE_USABLE
		update_icon_state()
...
/obj/structure/dropship_equipment/rappel_system/proc/break_rappel(mob/living/carbon/xenomorph/attacker)
