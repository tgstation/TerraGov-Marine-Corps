...
/obj/structure/jungle/variable/grass
	name = "jungle grass"
...
/obj/structure/jungle/variable/grass/thin
	icon_state = "grass_thin"

/obj/structure/jungle/variable/large_bush
	name = "large plant"
