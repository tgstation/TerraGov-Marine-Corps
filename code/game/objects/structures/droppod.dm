...
GLOBAL_LIST_INIT(blocked_droppod_tiles, typecacheof(list(/turf/open/space/transit, /turf/open/space, /turf/open/ground/empty, /turf/open/ground/water/sea/deep, /turf/open/lavaland/lava))) // Don't drop at these tiles.
