...
GLOBAL_LIST_INIT(radiochannels, list(
	RADIO_CHANNEL_COMMON = PUB_FREQ,
	RADIO_CHANNEL_REQUISITIONS = SUP_FREQ,
	RADIO_CHANNEL_COMMAND = COMM_FREQ,
	RADIO_CHANNEL_MEDICAL = MED_FREQ,
	RADIO_CHANNEL_ENGINEERING = ENG_FREQ,
	RADIO_CHANNEL_POLICE = SEC_FREQ,
	RADIO_CHANNEL_ALPHA = ALPHA_FREQ,
	RADIO_CHANNEL_BRAVO = BRAVO_FREQ,
	RADIO_CHANNEL_CHARLIE = CHARLIE_FREQ,
	RADIO_CHANNEL_DELTA = DELTA_FREQ,
	RADIO_CHANNEL_COLONIST = COL_FREQ,
	RADIO_CHANNEL_PMC = PMC_FREQ,
	RADIO_CHANNEL_UPP = UPP_FREQ,
	RADIO_CHANNEL_DEATHSQUAD = DTH_FREQ,
	RADIO_CHANNEL_IMPERIAL = IMP_FREQ
))

GLOBAL_LIST_INIT(reverseradiochannels, list(
	"[PUB_FREQ]" = RADIO_CHANNEL_COMMON,
	"[SUP_FREQ]" = RADIO_CHANNEL_REQUISITIONS,
	"[COMM_FREQ]" = RADIO_CHANNEL_COMMAND,
	"[MED_FREQ]" = RADIO_CHANNEL_MEDICAL,
	"[ENG_FREQ]" = RADIO_CHANNEL_ENGINEERING,
	"[SEC_FREQ]" = RADIO_CHANNEL_POLICE,
	"[ALPHA_FREQ]" = RADIO_CHANNEL_ALPHA,
	"[BRAVO_FREQ]" = RADIO_CHANNEL_BRAVO,
	"[CHARLIE_FREQ]" = RADIO_CHANNEL_CHARLIE,
	"[DELTA_FREQ]" = RADIO_CHANNEL_DELTA,
	"[COL_FREQ]" = RADIO_CHANNEL_COLONIST,
	"[PMC_FREQ]" = RADIO_CHANNEL_PMC,
	"[UPP_FREQ]" = RADIO_CHANNEL_UPP,
	"[DTH_FREQ]" = RADIO_CHANNEL_DEATHSQUAD,
	"[IMP_FREQ]" = RADIO_CHANNEL_IMPERIAL
))
...
/datum/radio_frequency/proc/post_signal(obj/source as obj|null, datum/signal/signal, filter, range)
