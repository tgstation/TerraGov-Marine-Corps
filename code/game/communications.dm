...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_THETA = FREQ_THETA,
	RADIO_CHANNEL_OMEGA = FREQ_OMEGA,
	RADIO_CHANNEL_GAMMA = FREQ_GAMMA,
	RADIO_CHANNEL_SIGMA = FREQ_SIGMA,
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_THETA]" = RADIO_CHANNEL_THETA,
	"[FREQ_OMEGA]" = RADIO_CHANNEL_OMEGA,
	"[FREQ_GAMMA]" = RADIO_CHANNEL_GAMMA,
	"[FREQ_SIGMA]" = RADIO_CHANNEL_SIGMA,
