...
/mob/living/carbon/human/med_hud_set_status()
	...
	if(stat != DEAD)
		...
		var/sanguinal_amount = reagents.get_reagent_amount(/datum/reagent/toxin/xeno_sanguinal) + reagents.get_reagent_amount(/datum/reagent/toxin/xeno_light_sanguinal)
