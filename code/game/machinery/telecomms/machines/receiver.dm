...
/obj/machinery/telecomms/receiver/preset_left
	...
	freq_listening = list(MED_FREQ, SUP_FREQ, ALPHA_FREQ, BRAVO_FREQ, CHARLIE_FREQ, DELTA_FREQ, COMM_FREQ, ENG_FREQ, SEC_FREQ, PMC_FREQ, COL_FREQ, UPP_FREQ, DTH_FREQ, IMP_FREQ)
