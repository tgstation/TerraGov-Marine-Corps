...
<th>Criminal Status</th>
				...
				if(3.0)
					...
					if ((istype(active1, /datum/data/record) && GLOB.crew_datacore.general.Find(active1)))
					...
					if ((istype(active2, /datum/data/record) && GLOB.crew_datacore.security.Find(active2)))
...
/obj/machinery/computer/secure_data/Topic(href, href_list)
	if(..())
		return
	if (!( GLOB.crew_datacore.general.Find(active1) ))
		active1 = null
	if (!( GLOB.crew_datacore.security.Find(active2) ))
		active2 = null
