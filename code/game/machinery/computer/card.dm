...
/obj/machinery/computer/card/ui_interact(mob/user, ui_key="main", var/datum/nanoui/ui = null, var/force_open = 1)
	...
	data["manifest"] = GLOB.crew_datacore ? GLOB.crew_datacore.get_manifest(0) : null
...
/obj/machinery/computer/card/Topic(href, href_list)
	...
	switch(href_list["choice"])
		if ("modify")
			if (modify)
				GLOB.crew_datacore.manifest_modify(modify.registered_name, modify.assignment, modify.rank)
				...
				spawn(50)
					...
					if (mode)
						...
						P.info = {"<h4>Crew Manifest</h4>
							<br>
							[GLOB.crew_datacore ? GLOB.crew_datacore.get_manifest(0) : ""]
						"}
					else if (modify)
