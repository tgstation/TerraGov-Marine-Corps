...
/obj/machinery/computer/card/ui_interact(mob/user, ui_key="main", var/datum/nanoui/ui = null, var/force_open = 1)
	...
	data["manifest"] = GLOB.crew_datacore.get_manifest()
...
/obj/machinery/computer/card/Topic(href, href_list)
	...
	switch(href_list["choice"])
		if ("modify")
			if (modify)
				GLOB.crew_datacore.manifest_update(null, null, modify.assignment, modify.rank, "name", modify.registered_name)
				...
				spawn(50)
					...
					if (mode)
						...
						P.info = {"<h4>Crew Manifest</h4>
							<br>
							[GLOB.crew_datacore.get_manifest()]
						"}
					else if (modify)
