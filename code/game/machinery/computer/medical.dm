...
"}
				if(2.0)
					...
					if(!isnull(GLOB.crew_datacore.general))
						for(var/datum/data/record/R in sortRecord(GLOB.crew_datacore.general))
				...
				if(4.0)
					...
					if ((istype(src.active1, /datum/data/record) && GLOB.crew_datacore.general.Find(src.active1)))
					...
					if ((istype(src.active2, /datum/data/record) && GLOB.crew_datacore.medical.Find(src.active2)))
...
/obj/machinery/computer/med_data/Topic(href, href_list)
	...
	if (!( GLOB.crew_datacore.general.Find(src.active1) ))
		src.active1 = null

	if (!( GLOB.crew_datacore.medical.Find(src.active2) ))
		src.active2 = null
