...
/obj/machinery/bot/mulebot
	...
	req_access = list(ACCESS_MARINE_ENGINEERING) // added robotics access so assembly line drop-off works properly -veyveyr //I don't think so, Tim. You need to add it to the MULE's hidden robot ID card. -NEO
	var/path[] = new()
