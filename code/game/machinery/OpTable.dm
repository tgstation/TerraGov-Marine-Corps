/obj/machinery/optable
	...
	OOC_info = "This is the operating table. Shift+click on it will show if it contains an anesthetic tank. Put a patient on it by 1. grabbing them on grab intent (or CTRL+click), 2. clicking the Operating Table. Then you can connect your patient to the anesthetic tank by clicking and dragging their sprite to the table. Click the table once you are done to remove the anesthetic from your patient."
	density = 1
	layer = TABLE_LAYER
	anchored = 1
	unacidable = 1
