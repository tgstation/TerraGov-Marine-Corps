...
/datum/job/pmc/proc/generate_random_pmc_primary(shuffle = rand(1,20))
	var/L[] = list(
				...
				WEAR_IN_JACKET = /obj/item/weapon/grenade/explosive/PMC
				)
	switch(shuffle)
		if(1 to 11)
			L += list(
...
/datum/job/pmc/support_specialist_triage
	...
	generate_stored_equipment()
		. = list(
				...
				WEAR_IN_BACK = /obj/item/weapon/storage/pill_bottle/inaprovaline,
				WEAR_IN_BACK = /obj/item/weapon/storage/pill_bottle/tramadol
				)
...
/datum/job/pmc/elite_responder/gunner
	title = "PMC Gunner"
	skills_list = list("cqc"=SKILL_CQC_DEFAULT,"endurance"=0,"engineer"=SKILL_ENGINEER_METAL,"firearms"=SKILL_FIREARMS_DEFAULT,"smartgun"=SKILL_SMART_TRAINED,"heavy_weapons"=SKILL_HEAVY_DEFAULT,"leadership"=SKILL_LEAD_BINOCS,"medical"=SKILL_MEDICAL_DEFAULT,"melee_weapons"=SKILL_MELEE_DEFAULT,"pilot"=SKILL_PILOT_NONE,"pistols"=SKILL_PISTOLS_DEFAULT,"police"=SKILL_POLICE_DEFAULT,"powerloader"=SKILL_POWERLOADER_DEFAULT)
	...
	generate_stored_equipment()
		. = list(
				...
				WEAR_IN_JACKET = /obj/item/weapon/reagent_containers/hypospray/autoinjector/quickclot,
				WEAR_IN_JACKET = /obj/item/weapon/reagent_containers/hypospray/autoinjector/Oxycodone
				)

/datum/job/pmc/elite_responder/sharpshooter
	title = "PMC Sharpshooter"
	flags_startup_parameters = ROLE_ADD_TO_DEFAULT
	skills_list = list("cqc"=SKILL_CQC_DEFAULT,"endurance"=0,"engineer"=SKILL_ENGINEER_METAL,"firearms"=SKILL_FIREARMS_DEFAULT,"smartgun"=SKILL_SMART_TRAINED,"heavy_weapons"=SKILL_HEAVY_TRAINED,"leadership"=SKILL_LEAD_BINOCS,"medical"=SKILL_MEDICAL_DEFAULT,"melee_weapons"=SKILL_MELEE_DEFAULT,"pilot"=SKILL_PILOT_NONE,"pistols"=SKILL_PISTOLS_DEFAULT,"police"=SKILL_POLICE_DEFAULT,"powerloader"=SKILL_POWERLOADER_DEFAULT)
...
/datum/job/pmc/elite_responder/ninja
	title = "PMC Ninja"
	flags_startup_parameters = ROLE_ADD_TO_DEFAULT
	skills_list = list("cqc"=SKILL_CQC_MASTER,"endurance"=0,"engineer"=SKILL_ENGINEER_METAL,"firearms"=SKILL_FIREARMS_DEFAULT,"smartgun"=SKILL_SMART_DEFAULT,"heavy_weapons"=SKILL_HEAVY_DEFAULT,"leadership"=SKILL_LEAD_BINOCS,"medical"=SKILL_MEDICAL_CHEM,"melee_weapons"=SKILL_MELEE_SUPER,"pilot"=SKILL_PILOT_NONE,"pistols"=SKILL_PISTOLS_DEFAULT,"police"=SKILL_POLICE_DEFAULT,"powerloader"=SKILL_POWERLOADER_DEFAULT)
...
/datum/job/pmc/elite_responder/commando
	...
	generate_wearable_equipment()
		. = list(
				...
				SLOW_WAIST = /obj/item/weapon/storage/belt/grenade,
				...
				WEAR_BACK = /obj/item/weapon/storage/backpack/commando
				)
...
/datum/job/pmc/team_leader
	...
	generate_stored_equipment()
		. = list(
				...
				WEAR_IN_ACCESSORY = /obj/item/weapon/grenade/smokebomb,
				WEAR_IN_JACKET = /obj/item/weapon/reagent_containers/hypospray/autoinjector/quickclot,
				WEAR_IN_JACKET = /obj/item/weapon/reagent_containers/hypospray/autoinjector/Bicard
				)