...
/datum/job/military_police
	...
	access = list(access_marine_iff_tag, access_sulaco_brig, access_sulaco_bridge, access_sulaco_pilot, access_sulaco_logistics)
	minimal_access = list(access_marine_iff_tag, access_sulaco_brig, access_sulaco_bridge, access_sulaco_pilot, access_sulaco_logistics)
