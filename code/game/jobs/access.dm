...
#define PAYGRADES_MARINE list("C","E1","E2","E3","E4","E5","E6","E7","E8","E8E","E9","E9E","O1","O2","O3","O4","O5","PO","CPO","WO","CWO","MAJ")
#define PAYGRADES_OFFICER list("O1","O2","O3","O4","O5","O6","CPO","WO","CWO","MAJ")
