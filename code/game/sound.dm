...
/proc/get_sfx(S)
	...
	switch(S)
		...
		if("alien_shrikeroar")
			S = pick('sound/voice/alien_cena.ogg','sound/voice/alien_AAAAAAA.ogg')
		if("alien_roar_larva")
		...
		if("queen_screech")
			S = pick('sound/voice/alien_queen_screech.ogg', 'sound/voice/alien_queen_boomsfx.ogg')
		if("alien_ventpass")
		...
		if("robot_warcry")
			S = pick('sound/voice/robot/robot_warcry1.ogg', 'sound/voice/robot/robot_warcry2.ogg', 'sound/voice/robot/robot_warcry3.ogg', 'sound/voice/robot/robot_warcry4.ogg')
	return S
