...
/proc/get_sfx(S)
	...
	switch(S)
		...
		if("gun_t12")
			S = pick('sound/april_fools/fire.ogg')
		if("shotgun_som")
		...
		// Xeno
		if("acid_hit")
			S = pick('sound/april_fools/boowomp.ogg')
		if("acid_bounce")
			S = pick('sound/april_fools/boowomp.ogg')
		if("alien_claw_flesh")
			S = pick('sound/april_fools/slap.ogg')
		if("alien_claw_metal")
			S = pick('sound/april_fools/violin.ogg')
		if("alien_bite")
		...
		if("alien_growl")
			S = pick('sound/april_fools/scoob.ogg')
		if("alien_hiss")
			S = pick('sound/april_fools/guuh.ogg')
		if("alien_tail_swipe")
		...
		if("alien_roar")
			S = pick('sound/april_fools/stalk_scream.ogg')
		if("alien_roar_larva")
		...
		if("alien_ventpass")
			S = pick('sound/april_fools/sus.ogg')
		...
		if("male_warcry")
			S = pick('sound/april_fools/cope.ogg')
		if("female_scream")
		...
		if("male_gasp")
			S = pick('sound/april_fools/sheesh.ogg')
		if("female_gasp")
			S = pick('sound/april_fools/sheesh.ogg')
		if("male_cough")
		...
		//robot race
		if("robot_scream")
			S =  pick('sound/april_fools/dialup_scream1.ogg')
		if("robot_pain")
			S = pick('sound/april_fools/dialup_scream2.ogg')
		if("robot_warcry")
			S = pick('sound/april_fools/dialup_scream3.ogg')
	return S
