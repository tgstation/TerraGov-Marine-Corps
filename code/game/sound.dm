...
/proc/get_sfx(S)
	if(istext(S))
		switch(S)
			...
			// Human
			if("male_scream")
				S = pick('sound/voice/human_male_scream_1.ogg','sound/voice/human_male_scream_2.ogg','sound/voice/human_male_scream_3.ogg','sound/voice/human_male_scream_4.ogg',5;'sound/voice/human_male_scream_5.ogg','sound/voice/human_male_scream_6.ogg' , 'sound/voice/human_male_scream_7.ogg' , 'sound/voice/human_male_scream_8.ogg')
			if("male_pain")
				S = pick('sound/voice/human_male_pain_1.ogg','sound/voice/human_male_pain_2.ogg','sound/voice/human_male_pain_3.ogg','sound/voice/human_male_scream_6.ogg' , 'sound/voice/human_male_pain_4.ogg' , 'sound/voice/human_male_pain_5.ogg')
			if("male_fragout")
