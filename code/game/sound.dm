...
var/list/scream_male_sound = list('sound/voice/scream_male_1.ogg','sound/voice/scream_male_2.ogg','sound/voice/scream_male_3.ogg','sound/voice/scream_male_4.ogg','sound/voice/scream_male_5.ogg')
var/list/scream_female_sound = list('sound/voice/scream_female_1.ogg','sound/voice/scream_female_2.ogg','sound/voice/scream_female_3.ogg','sound/voice/scream_female_4.ogg','sound/voice/scream_female_5.ogg')
...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if ("scream_male") soundin = pick(scream_male_sound)
			if ("scream_female") soundin = pick(scream_female_sound)
	return soundin
