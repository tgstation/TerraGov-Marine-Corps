...
/proc/get_sfx(S)
	if(istext(S))
		switch(S)
			...
			if("ballistic_miss")
				S = pick('sound/bullets/Bullet_Flyby.ogg','sound/bullets/Bullet_Flyby2.ogg','sound/bullets/Bullet_Flyby3.ogg','sound/bullets/Bullet_Flyby4.ogg','sound/bullets/Bullet_Flyby5.ogg')
			if("ballistic_bounce")
				S = pick('sound/bullets/bullet_ricochet1.ogg','sound/bullets/bullet_ricochet2.ogg','sound/bullets/bullet_ricochet3.ogg','sound/bullets/bullet_ricochet4.ogg','sound/bullets/bullet_ricochet5.ogg','sound/bullets/bullet_ricochet6.ogg','sound/bullets/bullet_ricochet7.ogg','sound/bullets/bullet_ricochet8.ogg','sound/bullets/bullet_ricochet9.ogg')
			if("rocket_bounce")
			...
			if("male_gasp")
				S = pick("sound/voice/human_male_gasp1.ogg", 'sound/voice/human_male_gasp2.ogg')
			if("female_gasp")
