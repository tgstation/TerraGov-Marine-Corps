...
/obj/machinery/computer/navigation/proc/do_change_orbit(current_orbit, direction)
	...
	var/message = "Arriving at new orbital level. Buckle immediately and prepare for engine ignition and stabilization."
	addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(minor_announce), message, "Orbit Change", FALSE), 290 SECONDS)
