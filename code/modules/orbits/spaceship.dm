...
/obj/machinery/computer/navigation/Topic(href, href_list)
	...
	if (href_list["UP"])
		...
		var/choice = alert(usr, "This will end the round. Are you certain you wish to leave any groundside marines behind? A poor reason can result in a jobban from any command roll.", "Escape Velocity", "Cancel", "Yes", "Cancel")
		if(choice != "Yes")
			return
