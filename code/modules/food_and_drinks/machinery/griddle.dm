/obj/machinery/griddle
	...
	density = TRUE
	pass_flags_self = PASSSMALLSTRUCT | PASSTABLE| PASSTHROW // It's roughly the height of a table.
...
/obj/machinery/griddle/proc/on_storage_dump(datum/source, obj/item/storage_source, mob/user)
	...
	for(var/obj/item/to_dump in storage_source)
		...
		to_dump.pixel_y = initial(to_dump.pixel_y) + rand(-5, 5) //to_dump.base_pixel_y
