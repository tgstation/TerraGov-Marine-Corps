/atom/movable/effect/ai_node/spawner/human
	name = "AI human spawner node"
	use_postspawn = TRUE //Gotta equip those AI you know

/atom/movable/effect/ai_node/spawner/human/deathsquad
	spawntypes = /mob/living/carbon/human/node_pathing
	spawnamount = 4
	spawndelay = 10 SECONDS
	maxamount = 10

/atom/movable/effect/ai_node/spawner/human/deathsquad/postspawn(list/squad)
