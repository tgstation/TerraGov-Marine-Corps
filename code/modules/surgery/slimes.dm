...
/datum/surgery_step/slime/cut_flesh/begin_step(mob/user, mob/living/carbon/slime/target, target_zone, obj/item/tool)
	user.visible_message("<span class='notice'>[user] starts cutting through [target]'s flesh with \the [tool].</span>", \
	"<span class='notice'>You start cutting through [target]'s flesh with \the [tool].</span>")
...
/datum/surgery_step/slime/cut_innards/begin_step(mob/user, mob/living/carbon/slime/target, target_zone, obj/item/tool)
	user.visible_message("<span class='notice'>[user] starts cutting [target]'s silky innards apart with \the [tool].</span>", \
	"<span class='notice'>You start cutting [target]'s silky innards apart with \the [tool].</span>")
...
/datum/surgery_step/slime/saw_core/begin_step(mob/user, mob/living/carbon/slime/target, target_zone, obj/item/tool)
	user.visible_message("<span class='notice'>[user] starts cutting out one of [target]'s cores with \the [tool].</span>", \
	"<span class='notice'>You start cutting out one of [target]'s cores with \the [tool].</span>")
