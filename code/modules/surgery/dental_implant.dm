...
/datum/surgery_step/insert_pill/preop(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
	display_results(user, target, "<span class='notice'>I begin to wedge [tool] in [target]'s [parse_zone(target_zone)]...</span>",
...
/datum/surgery_step/insert_pill/success(mob/user, mob/living/carbon/target, target_zone, obj/item/reagent_containers/pill/tool, datum/surgery/surgery)
	...
	display_results(user, target, "<span class='notice'>I wedge [tool] into [target]'s [parse_zone(target_zone)].</span>",
...
/datum/action/item_action/hands_free/activate_pill/Trigger()
	if(!..())
		return FALSE
	to_chat(owner, "<span class='notice'>I grit your teeth and burst the implanted [target.name]!</span>")
