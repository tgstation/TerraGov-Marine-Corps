/datum/codex_entry/wrench
	associated_paths = list(/obj/item/tool/wrench)
...
/datum/codex_entry/screwdriver
	associated_paths = list(/obj/item/tool/screwdriver)
...
/datum/codex_entry/wirecutters
	associated_paths = list(/obj/item/tool/wirecutters)
...
/datum/codex_entry/welder
	associated_paths = list(/obj/item/tool/weldingtool)
...
/datum/codex_entry/crowbar
	associated_paths = list(/obj/item/tool/crowbar)
