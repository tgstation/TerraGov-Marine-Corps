GLOBAL_LIST_INIT(dream_topics, list(
	...
	"a blue light","an abandoned colony","NTC","blood","a bandage","fear","a stiff corpse","military fleet","a cloud of smoke", \
	...
	"a synthetic person","meat","a planet","the USL","Ninetails","tools","a mercenary","a promise","betrayal","acid","unbearable pain" \
))
