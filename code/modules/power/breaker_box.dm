...
/obj/machinery/power/breakerbox/attack_ai(mob/user)
	...
	if(do_after(user, 50, FALSE, src)) //5s for AI as AIs can manipulate electronics much faster.
		set_state(!on)
...
/obj/machinery/power/breakerbox/attack_hand(mob/user)
	...
	if(do_after(user, 300, FALSE, src)) // 30s for non-AIs as humans have to manually reprogram it and rapid switching may cause some lag / powernet updates flood. If AIs spam it they can be easily traced.
		set_state(!on)
