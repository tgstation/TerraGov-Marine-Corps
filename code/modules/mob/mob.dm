...
/mob/proc/draw_from_slot_if_possible(slot)
	...
	if(slot == SLOT_IN_HOLSTER && (!(istype(I, /obj/item/storage/holster) || istype(I, /obj/item/weapon) || istype(I, /obj/item/storage/holster/belt))))
		return FALSE
	if(slot == SLOT_IN_S_HOLSTER && (!(istype(I, /obj/item/storage/holster) || istype(I, /obj/item/weapon) || istype(I, /obj/item/storage/holster/belt) || istype(I, /obj/item/storage/belt/knifepouch))))
		return FALSE
