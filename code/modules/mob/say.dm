...
/mob/proc/say_dead(message)
	...
	for(var/i in GLOB.player_list)
		...
		var/rendered = "[M != src ? FOLLOW_LINK(M, src) : ""] <span class='game deadsay'><span class='prefix'>DEAD:</span> <span class='name'>[name]</span> says, <span class='message emojify'>\"[message]\"</span></span>"
