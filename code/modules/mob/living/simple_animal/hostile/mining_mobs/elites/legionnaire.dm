...
/datum/action/innate/elite_attack/legionnaire_charge
	...
	chosen_message = "<span class='boldwarning'>I will attempt to grab my opponent and throw them.</span>"
	chosen_attack_num = LEGIONNAIRE_CHARGE

/datum/action/innate/elite_attack/head_detach
	name = "Release Head"
	button_icon_state = "head_detach"
	chosen_message = "<span class='boldwarning'>I will now detach my head or kill it if it is already released.</span>"
	chosen_attack_num = HEAD_DETACH

/datum/action/innate/elite_attack/bonfire_teleport
	name = "Bonfire Teleport"
	button_icon_state = "bonfire_teleport"
	chosen_message = "<span class='boldwarning'>I will leave a bonfire.  Second use will let you swap positions with it indefintiely.  Using this move on the same tile as my active bonfire removes it.</span>"
	chosen_attack_num = BONFIRE_TELEPORT

/datum/action/innate/elite_attack/spew_smoke
	name = "Spew Smoke"
	button_icon_state = "spew_smoke"
	chosen_message = "<span class='boldwarning'>My head will spew smoke in an area, wherever it may be.</span>"
...
/mob/living/simple_animal/hostile/asteroid/elite/legionnaire/proc/legionnaire_charge_2(var/move_dir, var/times_ran)
	...
	for(var/mob/living/L in T.contents - hit_things - src)
		...
		to_chat(L, "<span class='danger'>[src] grabs you and throws you with much force!</span>")
