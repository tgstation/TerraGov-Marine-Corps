...
/mob/living/carbon/human/Initialize()
	...
	RegisterSignal(src, COMSIG_KB_QUICKEQUIP, .proc/quick_equip)
	RegisterSignal(src, COMSIG_KB_HOLSTER, .proc/holster)
	RegisterSignal(src, COMSIG_KB_UNIQUEACTION, .proc/unique_action)
