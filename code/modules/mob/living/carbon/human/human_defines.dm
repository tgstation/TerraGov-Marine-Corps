/mob/living/carbon/human
	...
	hud_possible = list(HEALTH_HUD, STATUS_HUD_SIMPLE, STATUS_HUD, XENO_EMBRYO_HUD, XENO_REAGENT_HUD, WANTED_HUD, SQUAD_HUD_LOYALIST, SQUAD_HUD_REBEL, ORDER_HUD, PAIN_HUD)
