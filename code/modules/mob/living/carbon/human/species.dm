...
/datum/species/machine
	...
	species_flags = NO_BREATHE|NO_SCAN|NO_BLOOD|NO_POISON|NO_PAIN|IS_SYNTHETIC|NO_CHEM_METABOLIZATION|NO_HUNGER
...
/datum/species/zombie
	...
	taste_sensitivity = TASTE_DULL
	species_flags = NO_PAIN|NO_BREATHE|NO_SCAN|NO_POISON|NO_OVERDOSE|NO_HUNGER
