...
/datum/species/synthetic
	...
	species_flags = NO_BREATHE|NO_SCAN|NO_BLOOD|NO_POISON|NO_PAIN|IS_SYNTHETIC|NO_CHEM_METABOLIZATION|NO_STAMINA|DETACHABLE_HEAD|HAS_SKIN_TONE|HAS_LIPS|HAS_UNDERWEAR|ROBOTIC_LIMBS|GREYSCALE_BLOOD
