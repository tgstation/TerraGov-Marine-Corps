...
/datum/species/robot
	...
	screams = list(MALE = "robot_scream", FEMALE = "robot_scream", NEUTER = "robot_scream", PLURAL = "robot_scream")
	paincries = list(MALE = "robot_pain", FEMALE = "robot_pain", NEUTER = "robot_pain", PLURAL = "robot_pain")
	goredcries = list(MALE = "robot_scream", FEMALE = "robot_scream", NEUTER = "robot_scream", PLURAL = "robot_scream")
	warcries = list(MALE = "robot_warcry", FEMALE = "robot_warcry", NEUTER = "robot_warcry", PLURAL = "robot_warcry")
