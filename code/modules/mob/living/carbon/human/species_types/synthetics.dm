/datum/species/synthetic
	...
	species_flags = NO_BREATHE|NO_SCAN|NO_BLOOD|NO_POISON|NO_PAIN|IS_SYNTHETIC|NO_CHEM_METABOLIZATION|DETACHABLE_HEAD|HAS_LIPS|HAS_SKIN_COLOR|ROBOTIC_LIMBS|GREYSCALE_BLOOD
