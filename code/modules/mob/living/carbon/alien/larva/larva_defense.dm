	...
	if(..())
		...
		if (prob(90))
			...
			visible_message("<span class='danger'>[M] kicks [src]!</span>", \
							"<span class='danger'>[M] kicks you!</span>", "<span class='hear'>I hear a sickening sound of flesh hitting flesh!</span>", COMBAT_MESSAGE_RANGE, M)
			to_chat(M, "<span class='danger'>I kick [src]!</span>")
			...
			visible_message("<span class='danger'>[M]'s kick misses [src]!</span>", \
							"<span class='danger'>I avoid [M]'s kick!</span>", "<span class='hear'>I hear a swoosh!</span>", COMBAT_MESSAGE_RANGE, M)
			to_chat(M, "<span class='warning'>My kick misses [src]!</span>")
