...
/mob/living/carbon/proc/update_handcuffed(obj/item/restraints/handcuffs/restraints)
	if(restraints)
		...
		handcuffed.RegisterSignal(src, COMSIG_LIVING_DO_RESIST, /obj/item/restraints/resisted_against)
	else if(handcuffed)
...
/mob/living/carbon/proc/update_legcuffed(obj/item/restraints/legcuffs/restraints)
	if(restraints)
		...
		legcuffed.RegisterSignal(src, COMSIG_LIVING_DO_RESIST, /obj/item/restraints/resisted_against)
