...
/mob/living/carbon/xenomorph/proc/handle_aura_receiver()
	...
	if(warding_aura > 0)
		armor_pheromone_bonus = warding_aura * 1 //Bonus armor from pheromones, no matter what the armor was previously.
...
/mob/living/carbon/xenomorph/proc/set_frenzy_aura(new_aura)
	...
	if(frenzy_aura)
		add_movespeed_modifier(MOVESPEED_ID_FRENZY_AURA, TRUE, 0, NONE, TRUE, -frenzy_aura * 0.04)
		return
