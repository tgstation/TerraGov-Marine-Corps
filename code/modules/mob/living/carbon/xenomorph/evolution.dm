...
/mob/living/carbon/xenomorph/ui_interact(mob/user, datum/tgui/ui)
	// Xeno only screen
	if(!isxeno(user))
		return
...
/mob/living/carbon/xenomorph/ui_static_data(mob/living/carbon/xenomorph/xeno)
	. = list()
...
/mob/living/carbon/xenomorph/ui_data(mob/living/carbon/xenomorph/xeno)
	. = list()
...
/mob/living/carbon/xenomorph/ui_act(action, list/params)
	. = ..()
	if(.)
		return
