/datum/xeno_caste/queen
	...
	// *** Defense *** //
	soft_armor = list("melee" = 50, "bullet" = 50, "laser" = 50, "energy" = 50, "bomb" = XENO_BOMB_RESIST_3, "bio" = 45, "rad" = 45, BURN = 100, "acid" = 45)
...
/datum/xeno_caste/queen/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 55, "bullet" = 55, "laser" = 55, "energy" = 55, "bomb" = XENO_BOMB_RESIST_3, "bio" = 50, "rad" = 50, BURN = 100, "acid" = 50)
...
/datum/xeno_caste/queen/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 60, "bullet" = 60, "laser" = 60, "energy" = 60, "bomb" = XENO_BOMB_RESIST_3, "bio" = 55, "rad" = 55, BURN = 100, "acid" = 55)
...
/datum/xeno_caste/queen/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 65, "bullet" = 65, "laser" = 65, "energy" = 65, "bomb" = XENO_BOMB_RESIST_3, "bio" = 60, "rad" = 60, BURN = 100, "acid" = 60)
