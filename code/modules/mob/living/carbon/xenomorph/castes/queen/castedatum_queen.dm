/datum/xeno_caste/queen
	...
	actions = list(
		...
		/datum/action/ability/xeno_action/activable/secrete_resin,
		/datum/action/ability/xeno_action/blessing_menu,
		/datum/action/ability/xeno_action/place_acidwell,
		/datum/action/ability/xeno_action/call_of_the_burrowed,
		/datum/action/ability/xeno_action/activable/screech,
		/datum/action/ability/xeno_action/bulwark,
		/datum/action/ability/xeno_action/activable/larval_growth_sting,
		/datum/action/ability/xeno_action/activable/corrosive_acid/strong,
		/datum/action/ability/xeno_action/activable/xeno_spit,
		/datum/action/ability/xeno_action/activable/psychic_cure/queen_give_heal,
		/datum/action/ability/xeno_action/activable/neurotox_sting/ozelomelyn,
		...
		/datum/action/ability/xeno_action/activable/queen_give_plasma,
		/datum/action/ability/xeno_action/hive_message,
		/datum/action/ability/xeno_action/rally_hive,
		/datum/action/ability/xeno_action/activable/command_minions,
	)
