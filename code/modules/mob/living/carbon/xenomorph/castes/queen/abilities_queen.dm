	...
	for(var/mob/living/carbon/xenomorph/X AS in Q.hive.get_all_xenos())
		switch(Q.caste_base_type)
			if(/mob/living/carbon/xenomorph/queen)
				...
				to_chat(X, "<meta charset='UTF-8'><span class='faction_alert'>[span_faction_alert_title("The words of the Queen reverberate in your head...")]<br><span class='faction_alert_container'>[span_faction_alert_text("[html_encode(input)]")]</span></span>")
			if(/mob/living/carbon/xenomorph/king)
				SEND_SOUND(X, king_sound)
				to_chat(X, "<meta charset='UTF-8'><span class='faction_alert'>[span_faction_alert_title("The words of the King reverberate in your head...")]<br><span class='faction_alert_container'>[span_faction_alert_text("[html_encode(input)]")]</span></span>")
			if(/mob/living/carbon/xenomorph/shrike)
				SEND_SOUND(X, queen_sound)
				to_chat(X, "<meta charset='UTF-8'><span class='faction_alert'>[span_faction_alert_title("The words of the Shrike reverberate in your head...")]<br><span class='faction_alert_container'>[span_faction_alert_text("[html_encode(input)]")]</span></span>")
