	...
	for(var/mob/living/carbon/xenomorph/X AS in Q.hive.get_all_xenos())
		switch(Q.caste_base_type)
			if(/mob/living/carbon/xenomorph/queen)
				...
				to_chat(X, "<span class='announce_header'><br><br>The words of the Queen reverberate in your head...</span><br><br>[span_announce_body(input)]<br><br>")
			if(/mob/living/carbon/xenomorph/king)
				SEND_SOUND(X, king_sound)
				to_chat(X, "<span class='announce_header'><br><br>The words of the King reverberate in your head...</span><br><br>[span_announce_body(input)]<br><br>")
			if(/mob/living/carbon/xenomorph/shrike)
				SEND_SOUND(X, queen_sound)
				to_chat(X, "<span class='announce_header'><br><br>The words of the Shrike reverberate in your head...</span><br><br>[span_announce_body(input)]<br><br>")
