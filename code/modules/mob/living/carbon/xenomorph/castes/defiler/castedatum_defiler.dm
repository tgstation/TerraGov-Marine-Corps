/datum/xeno_caste/defiler
	...
	// *** Defense *** //
	soft_armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 30, "bomb" = 30, "bio" = 30, "rad" = 30, "fire" = 25, "acid" = 30)
...
/datum/xeno_caste/defiler/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 35, "bomb" = 35, "bio" = 35, "rad" = 35, "fire" = 30, "acid" = 35)
...
/datum/xeno_caste/defiler/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 40, "bomb" = 40, "bio" = 38, "rad" = 38, "fire" = 35, "acid" = 38)
...
/datum/xeno_caste/defiler/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 45, "bullet" = 45, "laser" = 45, "energy" = 45, "bomb" = 45, "bio" = 40, "rad" = 40, "fire" = 40, "acid" = 40)
