/datum/xeno_caste/defiler
	...
	actions = list(
		...
		/datum/action/ability/xeno_action/activable/defile,
		/datum/action/ability/xeno_action/lay_egg,
		/datum/action/ability/xeno_action/activable/inject_egg_neurogas,
...
/datum/xeno_caste/defiler/primordial
	...
	actions = list(
		...
		/datum/action/ability/xeno_action/pheromones/emit_warding,
		/datum/action/ability/xeno_action/pheromones/emit_frenzy,
		/datum/action/ability/xeno_action/activable/tentacle,
	)
