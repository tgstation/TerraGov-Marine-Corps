/datum/xeno_caste/bull
	...
	actions = list(
		...
		/datum/action/ability/xeno_action/activable/bull_charge,
		/datum/action/ability/xeno_action/activable/bull_charge/headbutt,
		/datum/action/ability/xeno_action/activable/bull_charge/gore,
	)
