/datum/xeno_caste/bull
	...
	// *** Defense *** //
	soft_armor = list("melee" = 30, "bullet" = 40, "laser" = 30, "energy" = 30, "bomb" = XENO_BOMB_RESIST_0, "bio" = 30, "rad" = 30, "fire" = 40, "acid" = 30)
...
/datum/xeno_caste/bull/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 35, "bullet" = 45, "laser" = 35, "energy" = 35, "bomb" = XENO_BOMB_RESIST_0, "bio" = 35, "rad" = 35, "fire" = 45, "acid" = 35)
...
/datum/xeno_caste/bull/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 40, "bullet" = 50, "laser" = 40, "energy" = 40, "bomb" = XENO_BOMB_RESIST_0, "bio" = 40, "rad" = 40, "fire" = 50, "acid" = 40)
...
/datum/xeno_caste/bull/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 45, "bullet" = 55, "laser" = 45, "energy" = 45, "bomb" = XENO_BOMB_RESIST_0, "bio" = 45, "rad" = 45, "fire" = 55, "acid" = 45)
