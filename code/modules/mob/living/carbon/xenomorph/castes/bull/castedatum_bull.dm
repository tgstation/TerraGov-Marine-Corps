/datum/xeno_caste/bull
	...
	// *** Defense *** //
	soft_armor = list("melee" = 25, "bullet" = 35, "laser" = 25, "energy" = 25, "bomb" = 25, "bio" = 25, "rad" = 25, "fire" = 35, "acid" = 25)
...
/datum/xeno_caste/bull/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 30, "bullet" = 40, "laser" = 30, "energy" = 30, "bomb" = 30, "bio" = 28, "rad" = 28, "fire" = 40, "acid" = 28)
...
/datum/xeno_caste/bull/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 35, "bullet" = 45, "laser" = 35, "energy" = 35, "bomb" = 35, "bio" = 30, "rad" = 30, "fire" = 45, "acid" = 30)
...
/datum/xeno_caste/bull/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 40, "bullet" = 50, "laser" = 40, "energy" = 40, "bomb" = 40, "bio" = 33, "rad" = 33, "fire" = 50, "acid" = 33)
