...
/datum/action/ability/activable/xeno_action/ravage/slow/ai_should_use(atom/target)
	. = ..()
	if(!.)
		return
	action_activate()
...
/datum/action/ability/activable/xeno_action/ravage/slow/proc/decrease_do_action(atom/target)
