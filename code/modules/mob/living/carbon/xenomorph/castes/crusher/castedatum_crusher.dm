/datum/xeno_caste/crusher
	...
	// *** Defense *** //
	armor = list("melee" = 70, "bullet" = 40, "laser" = 40, "energy" = 40, "bomb" = XENO_BOMB_RESIST_3, "bio" = 80, "rad" = 80, "fire" = 0, "acid" = 80)
...
/datum/xeno_caste/crusher/mature
	...
	// *** Defense *** //
	armor = list("melee" = 75, "bullet" = 45, "laser" = 45, "energy" = 45, "bomb" = XENO_BOMB_RESIST_3, "bio" = 90, "rad" = 90, "fire" = 0, "acid" = 90)
...
/datum/xeno_caste/crusher/elder
	...
	// *** Defense *** //
	armor = list("melee" = 80, "bullet" = 50, "laser" = 50, "energy" = 95, "bomb" = XENO_BOMB_RESIST_3, "bio" = 95, "rad" = 95, "fire" = 0, "acid" = 95)
...
/datum/xeno_caste/crusher/ancient
	...
	// *** Defense *** //
	armor = list("melee" = 90, "bullet" = 55, "laser" = 55, "energy" = 100, "bomb" = XENO_BOMB_RESIST_3, "bio" = 100, "rad" = 100, "fire" = 0, "acid" = 100)
