/datum/xeno_caste/crusher
	...
	// *** Defense *** //
	soft_armor = list("melee" = 70, "bullet" = 60, "laser" = 60, "energy" = 60, "bomb" = XENO_BOMB_RESIST_3, "bio" = 80, "rad" = 80, BURN = 60, "acid" = 80)
...
/datum/xeno_caste/crusher/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 75, "bullet" = 65, "laser" = 65, "energy" = 65, "bomb" = XENO_BOMB_RESIST_3, "bio" = 90, "rad" = 90, BURN = 65, "acid" = 90)
...
/datum/xeno_caste/crusher/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 80, "bullet" = 70, "laser" = 70, "energy" = 70, "bomb" = XENO_BOMB_RESIST_3, "bio" = 95, "rad" = 95, BURN = 70, "acid" = 95)
...
/datum/xeno_caste/crusher/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 90, "bullet" = 75, "laser" = 75, "energy" = 75, "bomb" = XENO_BOMB_RESIST_3, "bio" = 100, "rad" = 100, BURN = 75, "acid" = 100)
	// *** Abilities *** //
	stomp_damage = 60
