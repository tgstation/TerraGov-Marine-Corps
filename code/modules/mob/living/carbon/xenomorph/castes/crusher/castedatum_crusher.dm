/datum/xeno_caste/crusher
	...
	// *** Defense *** //
	soft_armor = list("melee" = 70, "bullet" = 60, "laser" = 60, "energy" = 60, "bomb" = 95, "bio" = 80, "rad" = 80, "fire" = 60, "acid" = 80)
...
/datum/xeno_caste/crusher/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 80, "bullet" = 70, "laser" = 70, "energy" = 70, "bomb" = 105, "bio" = 95, "rad" = 95, "fire" = 70, "acid" = 95)
...
/datum/xeno_caste/crusher/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 90, "bullet" = 75, "laser" = 75, "energy" = 75, "bomb" = 110, "bio" = 100, "rad" = 100, "fire" = 75, "acid" = 100)
	// *** Abilities *** //
	stomp_damage = 60
