/datum/xeno_caste/crusher
	...
	// *** Defense *** //
	armor = list("melee" = 70, "bullet" = 60, "laser" = 50, "energy" = 45, "bomb" = XENO_BOMB_RESIST_3, "bio" = 80, "rad" = 80, "fire" = 0, "acid" = 80)
...
/datum/xeno_caste/crusher/mature
	...
	// *** Defense *** //
	armor = list("melee" = 75, "bullet" = 65, "laser" = 55, "energy" = 50, "bomb" = XENO_BOMB_RESIST_3, "bio" = 90, "rad" = 90, "fire" = 0, "acid" = 90)
...
/datum/xeno_caste/crusher/elder
	...
	// *** Defense *** //
	armor = list("melee" = 80, "bullet" = 70, "laser" = 60, "energy" = 55, "bomb" = XENO_BOMB_RESIST_3, "bio" = 95, "rad" = 95, "fire" = 0, "acid" = 95)
...
/datum/xeno_caste/crusher/ancient
	...
	// *** Defense *** //
	armor = list("melee" = 90, "bullet" = 75, "laser" = 65, "energy" = 60, "bomb" = XENO_BOMB_RESIST_3, "bio" = 100, "rad" = 100, "fire" = 0, "acid" = 100)
