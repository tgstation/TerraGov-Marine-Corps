/datum/xeno_caste/hivelord
	...
	// *** Defense *** //
	soft_armor = list("melee" = 15, "bullet" = 15, "laser" = 15, "energy" = 15, "bomb" = 15, "bio" = 10, "rad" = 10, "fire" = 15, "acid" = 10)
...
/datum/xeno_caste/hivelord/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 20, "bullet" = 20, "laser" = 20, "energy" = 20, "bomb" = 20, "bio" = 15, "rad" = 15, "fire" = 20, "acid" = 15)
...
/datum/xeno_caste/hivelord/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 25, "bullet" = 25, "laser" = 25, "energy" = 25, "bomb" = 25, "bio" = 18, "rad" = 18, "fire" = 25, "acid" = 18)
...
/datum/xeno_caste/hivelord/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 30, "bomb" = 30, "bio" = 20, "rad" = 20, "fire" = 30, "acid" = 20)
