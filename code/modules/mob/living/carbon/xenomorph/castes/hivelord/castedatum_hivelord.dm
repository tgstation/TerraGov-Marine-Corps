...
/datum/xeno_caste/hivelord/mature
	...
	// *** Defense *** //
	armor = list("melee" = 17, "bullet" = 17, "laser" = 17, "energy" = 17, "bomb" = XENO_BOMB_RESIST_0, "bio" = 15, "rad" = 15, "fire" = 15, "acid" = 15)
...
/datum/xeno_caste/hivelord/elder
	...
	// *** Defense *** //
	armor = list("melee" = 19, "bullet" = 19, "laser" = 19, "energy" = 19, "bomb" = XENO_BOMB_RESIST_0, "bio" = 18, "rad" = 18, "fire" = 18, "acid" = 18)
...
/datum/xeno_caste/hivelord/ancient
	...
	// *** Defense *** //
	armor = list("melee" = 21, "bullet" = 21, "laser" = 21, "energy" = 21, "bomb" = XENO_BOMB_RESIST_0, "bio" = 20, "rad" = 20, "fire" = 20, "acid" = 20)
