/datum/xeno_caste/hivelord
	...
	actions = list(
		...
		/datum/action/ability/xeno_action/activable/healing_infusion,
		/datum/action/ability/xeno_action/place_acidwell,
		/datum/action/ability/xeno_action/activable/larval_growth_sting,
		/datum/action/ability/xeno_action/activable/secrete_resin/hivelord,
		/datum/action/ability/xeno_action/blessing_menu,
		/datum/action/ability/xeno_action/activable/transfer_plasma/improved,
		...
		/datum/action/ability/xeno_action/activable/recycle,
	)
