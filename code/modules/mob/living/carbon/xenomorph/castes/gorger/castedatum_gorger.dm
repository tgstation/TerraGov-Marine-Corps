/datum/xeno_caste/gorger
	...
	// *** Defense *** //
	soft_armor = list("melee" = 5, "bullet" = 5, "laser" = 5, "energy" = 5, "bomb" = 50, "bio" = 5, "rad" = 5, "fire" = 5, "acid" = 5)
...
/datum/xeno_caste/gorger/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 10, "bullet" = 10, "laser" = 10, "energy" = 10, "bomb" = 55, "bio" = 10, "rad" = 10, "fire" = 10, "acid" = 10)
...
/datum/xeno_caste/gorger/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 15, "bullet" = 15, "laser" = 15, "energy" = 15, "bomb" = 60, "bio" = 15, "rad" = 15, "fire" = 15, "acid" = 15)
...
/datum/xeno_caste/gorger/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 20, "bullet" = 20, "laser" = 20, "energy" = 20, "bomb" = 65, "bio" = 20, "rad" = 20, "fire" = 20, "acid" = 20)
