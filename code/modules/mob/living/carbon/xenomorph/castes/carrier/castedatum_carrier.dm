/datum/xeno_caste/carrier
	...
	// *** Defense *** //
	soft_armor = list("melee" = 15, "bullet" = 15, "laser" = 15, "energy" = 15, "bomb" = 15, "bio" = 5, "rad" = 5, "fire" = 15, "acid" = 5)
...
/datum/xeno_caste/carrier/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 20, "bullet" = 20, "laser" = 20, "energy" = 20, "bomb" = 20, "bio" = 5, "rad" = 5, "fire" = 20, "acid" = 5)
...
/datum/xeno_caste/carrier/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 25, "bullet" = 25, "laser" = 25, "energy" = 25, "bomb" = 25, "bio" = 7, "rad" = 7, "fire" = 25, "acid" = 7)
...
/datum/xeno_caste/carrier/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 30, "bomb" = 30, "bio" = 10, "rad" = 10, "fire" = 30, "acid" = 10)
