...
/datum/xeno_caste/carrier/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 20, "bullet" = 20, "laser" = 20, "energy" = 20, "bomb" = XENO_BOMB_RESIST_0, "bio" = 5, "rad" = 5, BURN = 20, "acid" = 5)
...
/datum/xeno_caste/carrier/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 25, "bullet" = 25, "laser" = 25, "energy" = 25, "bomb" = XENO_BOMB_RESIST_0, "bio" = 7, "rad" = 7, BURN = 25, "acid" = 7)
...
/datum/xeno_caste/carrier/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 30, "bomb" = XENO_BOMB_RESIST_0, "bio" = 10, "rad" = 10, BURN = 30, "acid" = 10)
