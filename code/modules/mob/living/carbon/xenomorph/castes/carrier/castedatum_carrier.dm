...
/datum/xeno_caste/carrier/primordial
	...
	caste_desc = "A xeno barely recognizable from the swarm of huggers crawling over it."
	upgrade = XENO_UPGRADE_FOUR
	primordial_upgrade_name = PRIMORDIAL_CARRIER
	primordial_message = "Our form has reached perfection. We shall carry entire hives on our backs."
