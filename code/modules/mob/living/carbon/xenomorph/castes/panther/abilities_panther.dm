...
// *********** Savage
// ***************************************
//This code is disabled because I do not believe the caste needs it at the moment. If you feel like re-enabling it, be aware the caste was not designed for it
...
/datum/action/xeno_action/activable/pounce
	...
	mechanics_text = "Leap at your target, knocking them to the ground for a short time"
	ability_name = "pounce"
	plasma_cost = 10
	var/range = 6
