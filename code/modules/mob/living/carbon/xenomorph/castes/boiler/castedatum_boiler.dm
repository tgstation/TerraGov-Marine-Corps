/datum/xeno_caste/boiler
	...
	// *** Defense *** //
	soft_armor = list("melee" = 40, "bullet" = 10, "laser" = 10, "energy" = 40, "bomb" = XENO_BOMB_RESIST_0, "bio" = 30, "rad" = 30, "fire" = 40, "acid" = 30)
...
/datum/xeno_caste/boiler/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 45, "bullet" = 10, "laser" = 10, "energy" = 45, "bomb" = XENO_BOMB_RESIST_0, "bio" = 33, "rad" = 33, "fire" = 45, "acid" = 33)
...
/datum/xeno_caste/boiler/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 45, "bullet" = 10, "laser" = 10 , "energy" = 45, "bomb" = XENO_BOMB_RESIST_0, "bio" = 35, "rad" = 35, "fire" = 45, "acid" = 35)
...
/datum/xeno_caste/boiler/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 45, "bullet" = 10, "laser" = 10, "energy" = 45, "bomb" = XENO_BOMB_RESIST_0, "bio" = 37, "rad" = 37, "fire" = 45, "acid" = 37)
