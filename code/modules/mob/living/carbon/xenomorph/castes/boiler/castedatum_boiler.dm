/datum/xeno_caste/boiler
	...
	// *** Defense *** //
	soft_armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 40, "bomb" = XENO_BOMB_RESIST_0, "bio" = 30, "rad" = 30, BURN = 40, "acid" = 30)
...
/datum/xeno_caste/boiler/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 45, "bullet" = 45, "laser" = 45, "energy" = 45, "bomb" = XENO_BOMB_RESIST_0, "bio" = 33, "rad" = 33, BURN = 45, "acid" = 33)
...
/datum/xeno_caste/boiler/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 45, "bullet" = 45, "laser" = 45 , "energy" = 45, "bomb" = XENO_BOMB_RESIST_0, "bio" = 35, "rad" = 35, BURN = 45, "acid" = 35)
...
/datum/xeno_caste/boiler/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 45, "bullet" = 45, "laser" = 45, "energy" = 45, "bomb" = XENO_BOMB_RESIST_0, "bio" = 37, "rad" = 37, BURN = 45, "acid" = 37)
