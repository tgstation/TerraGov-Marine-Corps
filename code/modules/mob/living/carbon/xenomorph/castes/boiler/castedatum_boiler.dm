...
/datum/xeno_caste/boiler/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 45, "bullet" = 45, "laser" = 45, "energy" = 45, "bomb" = 25, "bio" = 33, "rad" = 33, "fire" = 45, "acid" = 33)
...
/datum/xeno_caste/boiler/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 45, "bullet" = 45, "laser" = 45 , "energy" = 45, "bomb" = 30, "bio" = 35, "rad" = 35, "fire" = 45, "acid" = 35)
...
/datum/xeno_caste/boiler/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 45, "bullet" = 45, "laser" = 45, "energy" = 45, "bomb" = 35, "bio" = 37, "rad" = 37, "fire" = 45, "acid" = 37)
