/datum/xeno_caste/sentinel
	...
	// *** Defense *** //
	soft_armor = list("melee" = 15, "bullet" = 15, "laser" = 15, "energy" = 15, "bomb" = XENO_BOMB_RESIST_0, "bio" = 15, "rad" = 15, BURN = 15, "acid" = 15)
...
/datum/xeno_caste/sentinel/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 20, "bullet" = 20, "laser" = 20, "energy" = 20, "bomb" = XENO_BOMB_RESIST_0, "bio" = 20, "rad" = 20, BURN = 20, "acid" = 20)
...
/datum/xeno_caste/sentinel/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 23, "bullet" = 23, "laser" = 23, "energy" = 23, "bomb" = XENO_BOMB_RESIST_0, "bio" = 23, "rad" = 23, BURN = 23, "acid" = 23)
...
/datum/xeno_caste/sentinel/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 26, "bullet" = 26, "laser" = 26, "energy" = 26, "bomb" = XENO_BOMB_RESIST_0, "bio" = 25, "rad" = 25, BURN = 26, "acid" = 25)
