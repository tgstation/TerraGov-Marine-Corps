...
/datum/xeno_caste/sentinel/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 23, "bullet" = 23, "laser" = 23, "energy" = 23, "bomb" = 23, "bio" = 23, "rad" = 23, "fire" = 23, "acid" = 23)
...
/datum/xeno_caste/sentinel/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 26, "bullet" = 26, "laser" = 26, "energy" = 26, "bomb" = 26, "bio" = 25, "rad" = 25, "fire" = 26, "acid" = 25)
