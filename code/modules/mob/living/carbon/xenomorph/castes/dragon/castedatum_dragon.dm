/datum/xeno_caste/dragon
	...
	// *** Flags *** //
	caste_flags = CASTE_FIRE_IMMUNE|CASTE_IS_INTELLIGENT|CASTE_STAGGER_IMMUNE|CASTE_KNOCKBACK_IMMUNE|CASTE_SLOW_IMMUNE|CASTE_STUN_IMMUNE|CASTE_INSTANT_EVOLUTION|CASTE_LEADER_TYPE
