...
/obj/alien/xeno/hivemindcore/take_damage(damage_amount, damage_type, damage_flag, sound_effect, attack_dir, armour_penetration)
	. = ..()
	if(isnull(parent))
		return
 ...
 */
/obj/alien/xeno/hivemindcore/proc/hivemind_proxy_alert(datum/source, atom/movable/hostile)
	SIGNAL_HANDLER
