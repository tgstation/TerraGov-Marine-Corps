/datum/xeno_caste/hivemind
	...
	// *** Flags *** //
	caste_flags = CASTE_INNATE_PLASMA_REGEN|CASTE_FIRE_IMMUNE|CASTE_IS_BUILDER|CASTE_DO_NOT_ALERT_LOW_LIFE|CASTE_NO_MUTATION
...
/datum/xeno_caste/hivemind/hivemind_manifestation
	...
	// *** Flags *** //
	caste_flags = CASTE_IS_BUILDER|CASTE_FIRE_IMMUNE|CASTE_NO_MUTATION
