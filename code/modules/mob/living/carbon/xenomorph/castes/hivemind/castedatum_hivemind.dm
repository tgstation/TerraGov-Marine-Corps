/datum/xeno_caste/hivemind
	...
	actions = list(
		...
		/datum/action/ability/xeno_action/activable/plant_weeds/ranged,
		/datum/action/ability/xeno_action/activable/psychic_cure/queen_give_heal/hivemind,
		/datum/action/ability/xeno_action/activable/transfer_plasma/hivemind,
		/datum/action/ability/xeno_action/pheromones/hivemind,
		/datum/action/ability/xeno_action/pheromones/emit_recovery,
		/datum/action/ability/xeno_action/pheromones/emit_warding,
		/datum/action/ability/xeno_action/pheromones/emit_frenzy,
		/datum/action/ability/xeno_action/activable/secrete_resin/hivemind,
	)
