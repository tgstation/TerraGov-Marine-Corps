/datum/xeno_caste/praetorian
	...
	// *** Defense *** //
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 35, "bomb" = 35, "bio" = 35, "rad" = 35, "fire" = 35, "acid" = 35)
...
/datum/xeno_caste/praetorian/elder
	...
	// *** Defense *** //
	armor = list("melee" = 43, "bullet" = 43, "laser" = 43, "energy" = 43, "bomb" = 43, "bio" = 43, "rad" = 43, "fire" = 43, "acid" = 43)
...
/datum/xeno_caste/praetorian/ancient
	...
	// *** Defense *** //
	armor = list("melee" = 45, "bullet" = 45, "laser" = 45, "energy" = 45, "bomb" = 45, "bio" = 45, "rad" = 45, "fire" = 45, "acid" = 45)
