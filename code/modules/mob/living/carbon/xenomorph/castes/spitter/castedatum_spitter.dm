/datum/xeno_caste/spitter
	...
	// *** Defense *** //
	soft_armor = list("melee" = 10, "bullet" = 20, "laser" = 20, "energy" = 20, "bomb" = 15, "bio" = 10, "rad" = 10, "fire" = 20, "acid" = 10)
...
/datum/xeno_caste/spitter/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 15, "bullet" = 25, "laser" = 25, "energy" = 25, "bomb" = 20, "bio" = 15, "rad" = 15, "fire" = 25, "acid" = 15)
...
/datum/xeno_caste/spitter/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 20, "bullet" = 30, "laser" = 30, "energy" = 30, "bomb" = 25, "bio" = 18, "rad" = 18, "fire" = 30, "acid" = 18)
...
/datum/xeno_caste/spitter/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 25, "bullet" = 35, "laser" = 35, "energy" = 35, "bomb" = 30, "bio" = 20, "rad" = 20, "fire" = 35, "acid" = 20)
