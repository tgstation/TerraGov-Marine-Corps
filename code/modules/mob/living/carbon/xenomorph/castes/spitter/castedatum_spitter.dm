/datum/xeno_caste/spitter
	...
	spit_types = list(/datum/ammo/xeno/acid/medium, /datum/ammo/xeno/redspit) //Gotta give them their own version of heavy acid; kludgy but necessary as 100 plasma is way too costly.
