/datum/xeno_caste/spitter
	...
	// *** Defense *** //
	soft_armor = list("melee" = 10, "bullet" = 20, "laser" = 20, "energy" = 20, "bomb" = XENO_BOMB_RESIST_0, "bio" = 10, "rad" = 10, BURN = 20, "acid" = 10)
...
/datum/xeno_caste/spitter/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 15, "bullet" = 25, "laser" = 25, "energy" = 25, "bomb" = XENO_BOMB_RESIST_0, "bio" = 15, "rad" = 15, BURN = 25, "acid" = 15)
...
/datum/xeno_caste/spitter/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 20, "bullet" = 30, "laser" = 30, "energy" = 30, "bomb" = XENO_BOMB_RESIST_0, "bio" = 18, "rad" = 18, BURN = 30, "acid" = 18)
...
/datum/xeno_caste/spitter/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 25, "bullet" = 35, "laser" = 35, "energy" = 35, "bomb" = XENO_BOMB_RESIST_0, "bio" = 20, "rad" = 20, BURN = 35, "acid" = 20)
