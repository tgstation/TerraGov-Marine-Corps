/datum/xeno_caste/warrior
	...
	// *** Defense *** //
	soft_armor = list("melee" = 30, "bullet" = 40, "laser" = 40, "energy" = 30, "bomb" = XENO_BOMB_RESIST_2, "bio" = 36, "rad" = 36, BURN = 40, "acid" = 36)
...
/datum/xeno_caste/warrior/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 34, "bullet" = 45, "laser" = 45, "energy" = 34, "bomb" = XENO_BOMB_RESIST_2, "bio" = 36, "rad" = 36, BURN = 45, "acid" = 36)
...
/datum/xeno_caste/warrior/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 38, "bullet" = 50, "laser" = 50, "energy" = 38, "bomb" = XENO_BOMB_RESIST_2, "bio" = 40, "rad" = 40, BURN = 50, "acid" = 40)
...
/datum/xeno_caste/warrior/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 42, "bullet" = 55, "laser" = 55, "energy" = 42, "bomb" = XENO_BOMB_RESIST_2, "bio" = 50, "rad" = 50, BURN = 55, "acid" = 50)
