/datum/xeno_caste/warrior
	...
	// *** Defense *** //
	soft_armor = list("melee" = 30, "bullet" = 40, "laser" = 40, "energy" = 30, "bomb" = 40, "bio" = 36, "rad" = 36, "fire" = 40, "acid" = 36)
...
/datum/xeno_caste/warrior/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 34, "bullet" = 45, "laser" = 45, "energy" = 34, "bomb" = 45, "bio" = 36, "rad" = 36, "fire" = 45, "acid" = 36)
...
/datum/xeno_caste/warrior/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 38, "bullet" = 50, "laser" = 50, "energy" = 38, "bomb" = 50, "bio" = 40, "rad" = 40, "fire" = 50, "acid" = 40)
...
/datum/xeno_caste/warrior/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 42, "bullet" = 55, "laser" = 55, "energy" = 42, "bomb" = 55, "bio" = 50, "rad" = 50, "fire" = 55, "acid" = 50)
