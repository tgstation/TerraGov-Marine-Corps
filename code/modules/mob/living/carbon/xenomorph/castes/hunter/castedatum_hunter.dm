...
/datum/xeno_caste/hunter/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 50, "bullet" = 25, "laser" = 25, "energy" = 25, "bomb" = XENO_BOMB_RESIST_0, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 20)
...
/datum/xeno_caste/hunter/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 55, "bullet" = 30, "laser" = 30, "energy" = 30, "bomb" = XENO_BOMB_RESIST_0, "bio" = 25, "rad" = 25, "fire" = 30, "acid" = 25)
...
/datum/xeno_caste/hunter/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 60, "bullet" = 35, "laser" = 35, "energy" = 35, "bomb" = XENO_BOMB_RESIST_0, "bio" = 30, "rad" = 30, "fire" = 35, "acid" = 30)
