/datum/xeno_caste/hunter
	...
	// *** Defense *** //
	soft_armor = list("melee" = 40, "bullet" = 15, "laser" = 15, "energy" = 15, "bomb" = XENO_BOMB_RESIST_0, "bio" = 10, "rad" = 10, BURN = 15, "acid" = 10)
...
/datum/xeno_caste/hunter/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 45, "bullet" = 20, "laser" = 20, "energy" = 20, "bomb" = XENO_BOMB_RESIST_0, "bio" = 15, "rad" = 15, BURN = 20, "acid" = 15)
...
/datum/xeno_caste/hunter/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 50, "bullet" = 25, "laser" = 25, "energy" = 25, "bomb" = XENO_BOMB_RESIST_0, "bio" = 18, "rad" = 18, BURN = 25, "acid" = 18)
...
/datum/xeno_caste/hunter/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 55, "bullet" = 30, "laser" = 30, "energy" = 30, "bomb" = XENO_BOMB_RESIST_0, "bio" = 18, "rad" = 18, BURN = 30, "acid" = 18)
