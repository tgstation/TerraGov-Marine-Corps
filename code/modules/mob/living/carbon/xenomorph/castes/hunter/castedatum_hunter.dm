/datum/xeno_caste/hunter
	...
	// *** Defense *** //
	soft_armor = list("melee" = 40, "bullet" = 20, "laser" = 20, "energy" = 20, "bomb" = XENO_BOMB_RESIST_0, "bio" = 10, "rad" = 10, "fire" = 15, "acid" = 10)

	// *** Ranged Attack *** //
	charge_type = CHARGE_TYPE_MEDIUM
	pounce_delay = 14 SECONDS
...
/datum/xeno_caste/hunter/elder
	upgrade_name = "Elder"
	caste_desc = "Agile and dangerous, best to avoid when alone."
