/datum/xeno_caste/hunter
	...
	actions = list(
		...
		/datum/action/ability/xeno_action/activable/silence,
		/datum/action/ability/xeno_action/activable/pounce,
		/datum/action/ability/xeno_action/stealth,
		/datum/action/ability/xeno_action/activable/hunter_mark,
