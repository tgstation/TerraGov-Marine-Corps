/datum/xeno_caste/ravager
	...
	// *** Defense *** //
	soft_armor = list("melee" = 35, "bullet" = 40, "laser" = 30, "energy" = 30, "bomb" = XENO_BOMB_RESIST_1, "bio" = 30, "rad" = 30, BURN = 50, "acid" = 30)
...
/datum/xeno_caste/ravager/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 40, "bullet" = 45, "laser" = 40, "energy" = 40, "bomb" = XENO_BOMB_RESIST_1, "bio" = 35, "rad" = 35, BURN = 55, "acid" = 35)
...
/datum/xeno_caste/ravager/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 45, "bullet" = 50, "laser" = 45, "energy" = 45, "bomb" = XENO_BOMB_RESIST_1, "bio" = 38, "rad" = 38, BURN = 65, "acid" = 38)
...
/datum/xeno_caste/ravager/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 50, "bullet" = 55, "laser" = 50, "energy" = 50, "bomb" = XENO_BOMB_RESIST_1, "bio" = 40, "rad" = 40, BURN = 70, "acid" = 40)
