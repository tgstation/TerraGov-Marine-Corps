...
/datum/action/xeno_action/endure/action_activate()
	...
	X.soft_armor = X.soft_armor.modifyRating(bomb = 30) //Improved explosion resistance
...
/datum/action/xeno_action/endure/proc/endure_deactivate()
	...
	X.soft_armor = X.soft_armor.modifyRating(bomb = -30) //Remove resistances/immunities
