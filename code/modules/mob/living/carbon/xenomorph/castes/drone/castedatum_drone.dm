/datum/xeno_caste/drone
	...
	// *** Defense *** //
	soft_armor = list("melee" = 10, "bullet" = 10, "laser" = 10, "energy" = 10, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0)
...
/datum/xeno_caste/drone/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 17, "bullet" = 17, "laser" = 17, "energy" = 17, "bomb" = 17, "bio" = 5, "rad" = 5, "fire" = 17, "acid" = 5)
...
/datum/xeno_caste/drone/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 24, "bullet" = 24, "laser" = 24, "energy" = 24, "bomb" = 24, "bio" = 10, "rad" = 10, "fire" = 24, "acid" = 10)
...
/datum/xeno_caste/drone/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 31, "bullet" = 31, "laser" = 31, "energy" = 31, "bomb" = 31, "bio" = 15, "rad" = 15, "fire" = 31, "acid" = 15)
