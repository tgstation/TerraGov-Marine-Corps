/datum/xeno_caste/drone
	...
	evolves_to = list(/mob/living/carbon/xenomorph/shrike, /mob/living/carbon/xenomorph/trapper, /mob/living/carbon/xenomorph/hivelord, /mob/living/carbon/xenomorph/hivemind)
