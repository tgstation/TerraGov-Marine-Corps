/datum/xeno_caste/drone
	...
	// *** Defense *** //
	armor = list("melee" = 20, "bullet" = 20, "laser" = 20, "energy" = 20, "bomb" = XENO_BOMB_RESIST_0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/datum/xeno_caste/drone/mature
	...
	// *** Defense *** //
	armor = list("melee" = 27, "bullet" = 27, "laser" = 27, "energy" = 27, "bomb" = XENO_BOMB_RESIST_0, "bio" = 5, "rad" = 5, "fire" = 5, "acid" = 5)
...
/datum/xeno_caste/drone/elder
	...
	// *** Defense *** //
	armor = list("melee" = 34, "bullet" = 34, "laser" = 34, "energy" = 34, "bomb" = XENO_BOMB_RESIST_0, "bio" = 10, "rad" = 10, "fire" = 10, "acid" = 10)
...
/datum/xeno_caste/drone/ancient
	...
	// *** Defense *** //
	armor = list("melee" = 41, "bullet" = 41, "laser" = 41, "energy" = 41, "bomb" = XENO_BOMB_RESIST_0, "bio" = 15, "rad" = 15, "fire" = 15, "acid" = 15)
