/datum/xeno_caste/drone
	...
	// *** Defense *** //
	soft_armor = list("melee" = 10, "bullet" = 10, "laser" = 10, "energy" = 10, "bomb" = XENO_BOMB_RESIST_0, "bio" = 0, "rad" = 0, BURN = 10, "acid" = 0)
...
/datum/xeno_caste/drone/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 17, "bullet" = 17, "laser" = 17, "energy" = 17, "bomb" = XENO_BOMB_RESIST_0, "bio" = 5, "rad" = 5, BURN = 17, "acid" = 5)
...
/datum/xeno_caste/drone/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 24, "bullet" = 24, "laser" = 24, "energy" = 24, "bomb" = XENO_BOMB_RESIST_0, "bio" = 10, "rad" = 10, BURN = 24, "acid" = 10)
...
/datum/xeno_caste/drone/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 31, "bullet" = 31, "laser" = 31, "energy" = 31, "bomb" = XENO_BOMB_RESIST_0, "bio" = 15, "rad" = 15, BURN = 31, "acid" = 15)
