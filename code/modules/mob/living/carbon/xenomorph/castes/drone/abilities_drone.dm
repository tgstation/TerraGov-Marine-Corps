...
// *********** Acidic Salve
// ***************************************
/datum/action/ability/xeno_action/activable/psychic_cure/resin_salve
	name = "Resin Salve"
...
/datum/action/xeno_action/activable/psychic_cure/resin_salve/proc/salve_healing(mob/living/target)
	var/datum/action/ability/activable/xeno/essence_link/essence_link_action = owner.actions_by_path[/datum/action/xeno_action/activable/essence_link]
