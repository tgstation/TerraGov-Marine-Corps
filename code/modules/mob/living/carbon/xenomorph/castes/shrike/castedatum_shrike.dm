/datum/xeno_caste/shrike
	...
	// *** Defense *** //
	soft_armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 30, "bomb" = 40, "bio" = 10, "rad" = 10, "fire" = 30, "acid" = 10)
...
/datum/xeno_caste/shrike/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 35, "bomb" = 45, "bio" = 15, "rad" = 15, "fire" = 35, "acid" = 15)
...
/datum/xeno_caste/shrike/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 40, "bomb" = 50, "bio" = 18, "rad" = 18, "fire" = 40, "acid" = 18)
...
/datum/xeno_caste/shrike/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 45, "bullet" = 45, "laser" = 45, "energy" = 45, "bomb" = 55, "bio" = 23, "rad" = 23, "fire" = 45, "acid" = 20)
