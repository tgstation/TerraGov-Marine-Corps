/datum/xeno_caste/shrike
    ...
    /datum/action/ability/xeno_action/psychic_influence,
		...
		/datum/action/ability/xeno_action/activable/psychic_cure,
		/datum/action/ability/xeno_action/activable/transfer_plasma/drone,
		/datum/action/ability/xeno_action/activable/psychic_fling,
		/datum/action/ability/xeno_action/activable/unrelenting_force,
...
/datum/xeno_caste/shrike/primordial
    ...
    /datum/action/ability/xeno_action/psychic_influence,
		...
		/datum/action/ability/xeno_action/rally_minion,
		/datum/action/ability/xeno_action/blessing_menu,
		/datum/action/ability/xeno_action/activable/psychic_vortex,
	)
