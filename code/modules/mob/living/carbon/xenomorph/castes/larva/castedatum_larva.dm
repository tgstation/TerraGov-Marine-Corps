/datum/xeno_caste/larva
	...
	// *** Evolution *** //
	evolves_to = list(/mob/living/carbon/xenomorph/hivemind, /mob/living/carbon/xenomorph/drone, /mob/living/carbon/xenomorph/runner, /mob/living/carbon/xenomorph/sentinel, /mob/living/carbon/xenomorph/defender)
