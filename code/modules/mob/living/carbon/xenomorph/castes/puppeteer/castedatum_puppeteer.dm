/datum/xeno_caste/puppeteer
	...
	actions = list(
		...
		/datum/action/ability/xeno_action/activable/psydrain/free,
		/datum/action/ability/xeno_action/activable/flay,
		/datum/action/ability/xeno_action/activable/pincushion,
		/datum/action/ability/xeno_action/dreadful_presence,
		/datum/action/ability/xeno_action/activable/refurbish_husk,
		/datum/action/ability/xeno_action/activable/puppet,
		/datum/action/ability/xeno_action/activable/organic_bomb,
		/datum/action/ability/xeno_action/puppeteer_orders,
		/datum/action/ability/xeno_action/activable/articulate,
		/datum/action/ability/xeno_action/activable/puppet_blessings,
	)
...
/datum/xeno_caste/puppeteer/primordial
	...
	actions = list(
		...
		/datum/action/ability/xeno_action/activable/puppet,
		/datum/action/ability/xeno_action/activable/organic_bomb,
		/datum/action/ability/xeno_action/activable/tendril_patch,
		/datum/action/ability/xeno_action/puppeteer_orders,
		/datum/action/ability/xeno_action/activable/articulate,
		/datum/action/ability/xeno_action/activable/puppet_blessings,
	)
