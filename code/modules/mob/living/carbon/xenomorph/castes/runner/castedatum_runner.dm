/datum/xeno_caste/runner
	...
	// *** Defense *** //
	soft_armor = list("melee" = 14, "bullet" = 5, "laser" = 5, "energy" = 0, "bomb" = XENO_BOMB_RESIST_0, "bio" = 0, "rad" = 0, BURN = 5, "acid" = 0)
...
/datum/xeno_caste/runner/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 16, "bullet" = 10, "laser" = 10, "energy" = 10, "bomb" = XENO_BOMB_RESIST_0, "bio" = 3, "rad" = 3, BURN = 10, "acid" = 3)
...
/datum/xeno_caste/runner/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 18, "bullet" = 15, "laser" = 15, "energy" = 15, "bomb" = XENO_BOMB_RESIST_0, "bio" = 5, "rad" = 5, BURN = 15, "acid" = 5)
...
/datum/xeno_caste/runner/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 20, "bullet" = 19, "laser" = 19, "energy" = 19, "bomb" = XENO_BOMB_RESIST_0, "bio" = 7, "rad" = 7, BURN = 19, "acid" = 7)
...
/datum/xeno_caste/roony
	...
	// *** Defense *** //
	soft_armor = list("melee" = 5, "bullet" = 5, "laser" = 5, "energy" = 0, "bomb" = XENO_BOMB_RESIST_0, "bio" = 0, "rad" = 0, BURN = 5, "acid" = 0)
...
/datum/xeno_caste/roony/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 10, "bullet" = 10, "laser" = 10, "energy" = 10, "bomb" = XENO_BOMB_RESIST_0, "bio" = 3, "rad" = 3, BURN = 10, "acid" = 3)
...
/datum/xeno_caste/roony/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 15, "bullet" = 15, "laser" = 15, "energy" = 15, "bomb" = XENO_BOMB_RESIST_0, "bio" = 5, "rad" = 5, BURN = 15, "acid" = 5)
...
/datum/xeno_caste/roony/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 19, "bullet" = 19, "laser" = 19, "energy" = 19, "bomb" = XENO_BOMB_RESIST_0, "bio" = 7, "rad" = 7, BURN = 19, "acid" = 7)
