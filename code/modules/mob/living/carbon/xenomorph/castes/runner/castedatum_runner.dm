/datum/xeno_caste/runner
	...
	// *** Defense *** //
	soft_armor = list("melee" = 14, "bullet" = 10, "laser" = 10, "energy" = 10, "bomb" = XENO_BOMB_RESIST_0, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0)
...
/datum/xeno_caste/runner/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 16, "bullet" = 15, "laser" = 15, "energy" = 15, "bomb" = XENO_BOMB_RESIST_0, "bio" = 5, "rad" = 5, "fire" = 15, "acid" = 5)
