/datum/xeno_caste/widow
	...
	actions = list(
		...
		/datum/action/ability/xeno_action/activable/web_spit,
		/datum/action/ability/xeno_action/burrow,
		/datum/action/ability/xeno_action/activable/leash_ball,
		...
		/datum/action/ability/xeno_action/activable/cannibalise,
		/datum/action/ability/xeno_action/activable/spiderling_mark,
	)
...
/datum/xeno_caste/widow/primordial
	...
	actions = list(
		...
		/datum/action/ability/xeno_action/activable/cannibalise,
		/datum/action/ability/xeno_action/activable/spiderling_mark,
		/datum/action/ability/xeno_action/activable/web_hook,
	)
