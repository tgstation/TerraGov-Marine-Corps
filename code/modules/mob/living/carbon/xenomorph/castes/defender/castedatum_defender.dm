/datum/xeno_caste/defender
	...
	// *** Defense *** //
	soft_armor = list("melee" = 30, "bullet" = 30, "laser" = 25, "energy" = 20, "bomb" = XENO_BOMB_RESIST_2, "bio" = 20, "rad" = 20, BURN = 30, "acid" = 20)
...
/datum/xeno_caste/defender/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 33, "bullet" = 33, "laser" = 28, "energy" = 25, "bomb" = XENO_BOMB_RESIST_2, "bio" = 25, "rad" = 25, BURN = 33, "acid" = 25)
...
/datum/xeno_caste/defender/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 35, "bullet" = 35, "laser" = 30, "energy" = 28, "bomb" = XENO_BOMB_RESIST_2, "bio" = 28, "rad" = 28, BURN = 35, "acid" = 28)
...
/datum/xeno_caste/defender/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 40, "bomb" = XENO_BOMB_RESIST_2, "bio" = 30, "rad" = 30, BURN = 40, "acid" = 30)
