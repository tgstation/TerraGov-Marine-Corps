/datum/xeno_caste/king
	...
	// *** Defense *** //
	soft_armor = list("melee" = 50, "bullet" = 50, "laser" = 50, "energy" = 50, "bomb" = 90, "bio" = 45, "rad" = 45, "fire" = 100, "acid" = 45)
...
/datum/xeno_caste/king/mature
	...
	// *** Defense *** //
	soft_armor = list("melee" = 55, "bullet" = 55, "laser" = 55, "energy" = 55, "bomb" = 95, "bio" = 50, "rad" = 50, "fire" = 100, "acid" = 50)
...
/datum/xeno_caste/king/elder
	...
	// *** Defense *** //
	soft_armor = list("melee" = 60, "bullet" = 60, "laser" = 60, "energy" = 60, "bomb" = 100, "bio" = 55, "rad" = 55, "fire" = 100, "acid" = 55)
...
/datum/xeno_caste/king/ancient
	...
	// *** Defense *** //
	soft_armor = list("melee" = 65, "bullet" = 65, "laser" = 65, "energy" = 65, "bomb" = 110, "bio" = 60, "rad" = 60, "fire" = 100, "acid" = 60)
