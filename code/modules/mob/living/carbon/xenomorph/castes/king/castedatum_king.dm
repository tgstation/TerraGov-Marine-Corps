...
*/
	...
	// *** Flags *** //
	caste_flags = CASTE_IS_INTELLIGENT|CASTE_STAGGER_RESISTANT|CASTE_LEADER_TYPE|CASTE_INSTANT_EVOLUTION|CASTE_HAS_WOUND_MASK|CASTE_EVOLUTION_ALLOWED|CASTE_IS_BUILDER //NTF Edit - allow evolution/regression, building
...
/datum/xeno_caste/king/conqueror
	...
	// *** Flags *** //
	caste_flags = CASTE_IS_INTELLIGENT|CASTE_LEADER_TYPE|CASTE_INSTANT_EVOLUTION|CASTE_EVOLUTION_ALLOWED|CASTE_IS_BUILDER //NTF Edit - allow evolution/regression, building
