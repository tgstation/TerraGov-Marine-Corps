...
/mob/living/carbon/Xenomorph/proc/acid_spray_cone(atom/A)
	...
	if(!do_after(src, 5, TRUE, 5, BUSY_ICON_HOSTILE, TRUE))
		return
	...
	add_slowdown(2) //Getting rid of the shit code that allowed Praes to go sonic if they regained temp lost speed during upgrade
