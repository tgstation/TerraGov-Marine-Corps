...
/mob/living/silicon/decoy/ship_ai/Initialize(mapload, ...)
	. = ..()
	desc = "This is the artificial intelligence system for the [SSmapping.configs[SHIP_MAP].map_name]. Like many other military-grade AI systems, this one was manufactured by Ninetails."
