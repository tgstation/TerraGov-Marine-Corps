...
/datum/sprite_accessory
	...
	var/list/species_allowed = list("Human","Human Hero", "Synthetic", "Vat-Grown", "Vatborn") // Restrict some styles to specific species
...
/datum/sprite_accessory/hair
	species_allowed = list("Human","Unathi","Tajara","Skrell","Vox","Machine","Synthetic", "Vat-Grown", "Vatborn")
...
/datum/sprite_accessory/hair_gradient
	...
	gender = NEUTER
	species_allowed = list("Human","Synthetic", "Vat-Grown", "Vatborn")
