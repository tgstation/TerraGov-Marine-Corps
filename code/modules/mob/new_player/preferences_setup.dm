...
//Command
			...
			switch(job_marines_high)
				...
				if(EXECUTIVE)
					clothes_s = new /icon('icons/Marine/marine_armor.dmi', "XO_jumpsuit_s")
					clothes_s.Blend(new /icon('icons/mob/feet.dmi', "brown"), ICON_UNDERLAY)
					switch(backbag)
						if(2)
							clothes_s.Blend(new /icon('icons/mob/back.dmi', "marinepack"), ICON_OVERLAY)
				...
				if(BRIDGE)
					clothes_s = new /icon('icons/Marine/marine_armor.dmi', "BO_jumpsuit_s")
					clothes_s.Blend(new /icon('icons/mob/feet.dmi', "brown"), ICON_UNDERLAY)
					switch(backbag)
						if(2)
							clothes_s.Blend(new /icon('icons/mob/back.dmi', "marinepack"), ICON_OVERLAY)
				...
				if(MPOLICE)
					clothes_s = new /icon('icons/mob/uniform.dmi', "MP_jumpsuit_s")
				...
				if(LIASON)
					clothes_s = new /icon('icons/Marine/marine_armor.dmi', "black_suit_s")
					clothes_s.Blend(new /icon('icons/mob/feet.dmi', "brown"), ICON_UNDERLAY)
					switch(backbag)
						if(2)
							clothes_s.Blend(new /icon('icons/mob/back.dmi', "marinepack"), ICON_OVERLAY)
				...
				if(REQUI)
					clothes_s = new /icon('icons/Marine/marine_armor.dmi', "RO_jumpsuit_s")
					clothes_s.Blend(new /icon('icons/mob/feet.dmi', "brown"), ICON_UNDERLAY)
					switch(backbag)
						if(2)
							clothes_s.Blend(new /icon('icons/mob/back.dmi', "marinepack"), ICON_OVERLAY)
...
//Engineering
				...
				if(SULENG)
					clothes_s = new /icon('icons/mob/uniform.dmi', "E_jumpsuit_s")
					clothes_s.Blend(new /icon('icons/mob/feet.dmi', "brown"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/mob/belt.dmi', "utility"), ICON_OVERLAY)
					switch(backbag)
						if(2)
...
//Medbay
				if(SULCMO)
					clothes_s = new /icon('icons/mob/uniform.dmi', "cmo_s")
					clothes_s.Blend(new /icon('icons/mob/feet.dmi', "brown"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/mob/eyes.dmi', "healthhud"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/mob/items_lefthand.dmi', "firstaid"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/mob/suit.dmi', "labcoat_cmo_open"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/belt.dmi', "medical"), ICON_OVERLAY)
					switch(backbag)
						if(2)
							clothes_s.Blend(new /icon('icons/mob/back.dmi', "medicalpack"), ICON_OVERLAY)
						if(3)
...
//Marines
				if(SQUADLE)
					...
					clothes_s.Blend(new /icon('icons/mob/feet.dmi', "swat"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/mob/hands.dmi', "redgloves"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/mob/belt.dmi', "security"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/Marine/marine_armor.dmi', "7"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/Marine/marine_armor.dmi', "xhelm"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/items_lefthand.dmi', "[pick("m41a-w","m37-w", "m39")]"), ICON_OVERLAY)
					switch(backbag)
						if(2)
							clothes_s.Blend(new /icon('icons/mob/back.dmi', "marinepack"), ICON_OVERLAY)
						if(3)
				...
				if(SQUADME)
					...
					clothes_s.Blend(new /icon('icons/mob/hands.dmi', "redgloves"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/mob/belt.dmi', "medical"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/Marine/marine_armor.dmi', "[pick("1","2","3","4","5","6")]"), ICON_OVERLAY)
				...
				if(SQUADSP)
					...
					clothes_s.Blend(new /icon('icons/Marine/marine_armor.dmi', "[pick("1","2","3","4","5","6")]"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/Marine/marine_armor.dmi', "helmet"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/items_lefthand.dmi', "[pick("rocket","flamer")]"), ICON_OVERLAY)
					switch(backbag)
						if(2)
							clothes_s.Blend(new /icon('icons/mob/back.dmi', "marinepack"), ICON_OVERLAY)
						if(3)
