datum/preferences
	...
	proc/update_preview_icon()		//seriously. This is horrendous.
		...
		if(job_marines_low & ROLE_MARINE_STANDARD)
			clothes_s = new /icon('icons/mob/uniform_0.dmi', "marine_jumpsuit_d_s")
			clothes_s.Blend(new /icon('icons/mob/feet.dmi', "jackboots-1"), ICON_UNDERLAY)
			...
			switch(job_marines_high)
				if(ROLE_MARINE_STANDARD)
					...
					clothes_s.Blend(new /icon('icons/mob/hands.dmi', "s-ninja"), ICON_OVERLAY)
					switch(backbag)
						if(1)
							clothes_s.Blend(new /icon('icons/mob/back.dmi', "m41a"), ICON_OVERLAY)
						if(2)
							clothes_s.Blend(new /icon('icons/mob/back.dmi', "marinepack"), ICON_OVERLAY)
						if(3)
							clothes_s.Blend(new /icon('icons/mob/back.dmi', "marinesat"), ICON_OVERLAY)
						if(4)
							clothes_s.Blend(new /icon('icons/mob/back.dmi', "s_marinesat"), ICON_OVERLAY)
				if(ROLE_MARINE_ENGINEER)
					...
					switch(backbag)
						...
						if(4)
							clothes_s.Blend(new /icon('icons/mob/back.dmi', "s_marinesatt"), ICON_OVERLAY)
				...
				if(ROLE_MARINE_MEDIC)
					clothes_s = new /icon('icons/mob/uniform_0.dmi', "marine_medic_d_s")
					clothes_s.Blend(new /icon('icons/mob/feet.dmi', "jackboots-1"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/Marine/marine_armor.dmi', "lamp-off"), ICON_UNDERLAY)
					...
					switch(backbag)
						...
						if(4)
							clothes_s.Blend(new /icon('icons/mob/back.dmi', "s_marinesatm"), ICON_OVERLAY)
				if(ROLE_MARINE_SPECIALIST)
					clothes_s = new /icon('icons/mob/uniform_0.dmi', "marine_jumpsuit_d_s")
					clothes_s.Blend(new /icon('icons/mob/feet.dmi', "jackboots-1"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/Marine/marine_armor.dmi', "lamp-off"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/Marine/marine_armor.dmi', "8full"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/belt.dmi', "marinebelt"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/hands.dmi', "s-ninja"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/eyes.dmi', "m56_goggles"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/items_righthand_0.dmi', "m56_w"), ICON_OVERLAY)
			...
			switch(job_command_high)
				if(ROLE_COMMANDING_OFFICER)
					...
					switch(backbag)
						if(1)
							clothes_s.Blend(new /icon('icons/marine/marine_armor.dmi', "officer"), ICON_OVERLAY)
						if(2)
							clothes_s.Blend(new /icon('icons/mob/back.dmi', "marinepack"), ICON_OVERLAY)
						if(3)
							clothes_s.Blend(new /icon('icons/mob/back.dmi', "marinesat"), ICON_OVERLAY)
				...
				if(ROLE_CORPORATE_LIAISON)
					clothes_s = new /icon('icons/mob/uniform_0.dmi', "liaison_outing_s")
					clothes_s.Blend(new /icon('icons/mob/feet.dmi', "laceups"), ICON_UNDERLAY)
					switch(backbag)
						if(1)
							clothes_s.Blend(new /icon('icons/mob/mask.dmi', "cigar2on"), ICON_OVERLAY)
						if(2)
			...
			switch(job_medsci_high)
				...
				if(ROLE_CIVILIAN_DOCTOR)
					clothes_s = new /icon('icons/mob/uniform_0.dmi', "scrubsblue_s")
