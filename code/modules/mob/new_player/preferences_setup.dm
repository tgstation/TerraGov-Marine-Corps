...
//			if(organ_data[name] == "amputated") continue
		...
		*/
		...
		if(job_marines_low & ROLE_MARINE_STANDARD)
			...
			clothes_s.Blend(new /icon('icons/obj/clothing/cm_suits.dmi', "lamp-off"), ICON_UNDERLAY)
			clothes_s.Blend(new /icon('icons/obj/clothing/cm_suits.dmi', "2"), ICON_OVERLAY)
			clothes_s.Blend(new /icon('icons/obj/clothing/cm_hats.dmi', "helmet"), ICON_OVERLAY)
			...
			switch(job_marines_high)
				...
				if(ROLE_MARINE_ENGINEER)
					...
					clothes_s.Blend(new /icon('icons/obj/clothing/cm_suits.dmi', "lamp-off"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/obj/clothing/cm_suits.dmi', "6"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/obj/clothing/cm_hats.dmi', "helmet"), ICON_OVERLAY)
				...
				if(ROLE_MARINE_LEADER)
					...
					clothes_s.Blend(new /icon('icons/mob/hands.dmi', "bgloves"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/obj/clothing/cm_suits.dmi', "lamp-off"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/obj/clothing/cm_suits.dmi', "7"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/obj/clothing/cm_hats.dmi', "helmet"), ICON_OVERLAY)
				...
				if(ROLE_MARINE_MEDIC)
					...
					clothes_s.Blend(new /icon('icons/mob/hands.dmi', "bgloves"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/obj/clothing/cm_suits.dmi', "lamp-off"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/obj/clothing/cm_suits.dmi', "1"), ICON_OVERLAY)
				...
				if(ROLE_MARINE_SPECIALIST)
					...
					clothes_s.Blend(new /icon('icons/obj/clothing/cm_suits.dmi', "lamp-off"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/obj/clothing/cm_suits.dmi', "2"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/obj/clothing/cm_hats.dmi', "spec"), ICON_OVERLAY)
				...
				if(ROLE_MARINE_SMARTGUN)
					...
					clothes_s.Blend(new /icon('icons/mob/hands.dmi', "bgloves"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/obj/clothing/cm_suits.dmi', "lamp-off"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/obj/clothing/cm_suits.dmi', "8"), ICON_OVERLAY)
			...
			switch(job_command_high)
				...
				if(ROLE_BRIDGE_OFFICER)
					...
					clothes_s.Blend(new /icon('icons/mob/feet.dmi', "jackboots"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/mob/ears.dmi', "headset"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/obj/clothing/cm_hats.dmi', "rocap"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/back.dmi', "marinesat"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/belt.dmi', "m4a3_holster_g"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/mob.dmi', "id"), ICON_OVERLAY)
				if(ROLE_EXECUTIVE_OFFICER)
					...
					clothes_s.Blend(new /icon('icons/mob/feet.dmi', "jackboots"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/mob/ears.dmi', "headset"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/obj/clothing/cm_hats.dmi', "cap"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/back.dmi', "marinesat"), ICON_OVERLAY)
				...
				if(ROLE_PILOT_OFFICER)
					...
					clothes_s.Blend(new /icon('icons/mob/ears.dmi', "headset"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/obj/clothing/cm_suits.dmi', "pilot"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/eyes.dmi', "sun"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/obj/clothing/cm_hats.dmi', "helmetp"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/back.dmi', "marinesat"), ICON_OVERLAY)
				...
				if(ROLE_MILITARY_POLICE)
					...
					clothes_s.Blend(new /icon('icons/mob/feet.dmi', "jackboots"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/mob/hands.dmi', "bgloves"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/obj/clothing/cm_suits.dmi', "mp"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/ears.dmi', "headset"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/obj/clothing/cm_hats.dmi', "beretred"), ICON_OVERLAY)
				...
				if(ROLE_CHIEF_MP)
					...
					clothes_s.Blend(new /icon('icons/mob/feet.dmi', "jackboots"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/mob/hands.dmi', "bgloves"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/obj/clothing/cm_suits.dmi', "warrant_officer"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/ears.dmi', "headset"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/obj/clothing/cm_hats.dmi', "beretwo"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/eyes.dmi', "sunhud"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/back.dmi', "securitypack"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/belt.dmi', "security"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/mob.dmi', "id"), ICON_OVERLAY)
			...
			switch(job_engi_high)
				...
				if(ROLE_REQUISITION_OFFICER)
					...
					clothes_s.Blend(new /icon('icons/mob/hands.dmi', "lightbrowngloves"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/mob/ears.dmi', "headset"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/obj/clothing/cm_hats.dmi', "cargocap"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/back.dmi', "marinesat"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/belt.dmi', "m44_holster_g"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/mob.dmi', "id"), ICON_OVERLAY)
				if(ROLE_REQUISITION_TECH)
					...
					clothes_s.Blend(new /icon('icons/mob/hands.dmi', "lightbrowngloves"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/mob/ears.dmi', "headset"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/obj/clothing/cm_hats.dmi', "band2"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/back.dmi', "marinesatt"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/belt.dmi', "utility"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/mob.dmi', "id"), ICON_OVERLAY)
