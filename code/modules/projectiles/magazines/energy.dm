...
/obj/item/cell/lasgun/standard_lasrifle
	name = "\improper TX-73 lasrifle battery"
	desc = "A specialized high density battery used to power the TX73 lasgun."
	base_ammo_icon = "tx73"
	icon_state = "tx73"
	gun_type = /obj/item/weapon/gun/energy/lasgun/standard_lasrifle

/obj/item/cell/lasgun/standard_lasrifle/highcap// Large battery
...
/obj/item/cell/lasgun/standard_lasrifle/Initialize()
	. = ..()
	update_icon()

/obj/item/cell/lasgun/standard_lasrifle/update_icon()
	var/remaining = CEILING((charge / max(maxcharge, 1)) * 100, 25)
	icon_state = "[base_ammo_icon]_[remaining]"
