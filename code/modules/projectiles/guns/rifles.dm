...
/obj/item/weapon/gun/rifle/sectoid_rifle/able_to_fire(mob/user)
	...
	if(!(H.species.flags_species & USES_ALIEN_WEAPONS))
...
/obj/item/weapon/gun/rifle/chambered
	...
	flags_reciever = AMMO_RECIEVER_REQUIRES_UNIQUE_ACTION|AMMO_RECIEVER_MAGAZINES|AMMO_RECIEVER_UNIQUE_ACTION_LOCKS|AMMO_RECIEVER_AUTO_EJECT
