...
/obj/item/weapon/gun/standard_atgun
	...
	desc = "The TAT-36 is a light dual purpose anti tank and anti personnel weapon used by the TGMC. Used for light vehicle or bunker busting on a short notice. Best used by two people. It can move around with wheels, and has an ammo rack intergral to the weapon. CANNOT BE UNDEPLOYED ONCE DEPLOYED! It uses several types of 37mm shells boxes. Alt-right click on AT gun to anchor it so that it cannot be moved by anyone, then alt-right click again to unanchor to move it."
	w_class = WEIGHT_CLASS_BULKY
