...
/obj/item/weapon/gun/shotgun/combat/shq6
	...
	desc = "The SH-46, is a semi-automatic, 12 Gauge, gas piston-operated shotgun."
	force = 20 //Has a stock already
	flags_equip_slot = ITEM_SLOT_BACK
	icon = 'icons/Marine/gun64.dmi'
	icon_state = "shq6"
	...
	fire_sound = 		'sound/weapons/guns/fire/tgmc/kinetic/gun_sh46.ogg'
	hand_reload_sound = 'sound/weapons/guns/fire/tgmc/kinetic/gun_sh46_shell.ogg'
	cocked_sound = 		'sound/weapons/guns/fire/tgmc/kinetic/gun_sh46_boltpull.ogg'
