...
/obj/item/weapon/gun/pistol/plasma_pistol
	...
	flags_gun_innate_features = GUN__AUTO_EJECTOR|GUN__CAN_POINTBLANK|GUN__ENERGY|GUN__AMMO_COUNTER|GUN__IS_ATTACHMENT
	actions_types = list()
...
/obj/item/weapon/gun/pistol/chimp
	...
	gun_skill_category = GUN_SKILL_PISTOLS
	attachable_allowed = list()
	flags_gun_innate_features = GUN__AUTO_EJECTOR|GUN__LOAD_INTO_CHAMBER|GUN__AMMO_COUNTER
