...
/obj/item/weapon/gun/pistol/vp90
	...
	desc = "RA-P-90 is a RivArms standard issue pistol for Nanotrasen Contractors, based on MK88. It have Lost it's inbuilt burst fire mode, but in exchange recieved a modified inbuilt barrel charger, greatly increasing firepower of the weapon. Fires 9mm armor piercing rounds."
	icon_state = "90m4"
	...
	reload_sound = 'sound/weapons/guns/interact/vp70_reload.ogg'
	cocked_sound = 'sound/weapons/guns/interact/vp70_cocked.ogg'
	default_ammo_type = /obj/item/ammo_magazine/pistol/vp90
	allowed_ammo_types = list(/obj/item/ammo_magazine/pistol/vp90, /obj/item/ammo_magazine/pistol/vp90/extended)
	force = 8
	attachable_allowed = list(
		/obj/item/attachable/reddot,
		/obj/item/attachable/flashlight,
...
/obj/item/weapon/gun/pistol/vp90/pmc_standard
...
/obj/item/weapon/gun/pistol/vp100_gyrojet
	...
	desc = "RA-JAR-100 is a RivArms exotic, massive and formidable automatic handgun chambered in 15x50mm jet-propelled ammunition. Commonly seen in the hands of wealthy Nanotrasen contractors, not because this weapon is expensive, but mostly because you would like to have a functioning exoskeleton, to not break your hand while firing this thing. The jet-propelled ammunition does not suffer from fall off, meaning it will deal the same damage at the short and long ranges. Due to additional shell rupture in target's body, it also has high chance of causing shrapnel."
	icon_state = "100m5"
	...
	default_ammo_type = /obj/item/ammo_magazine/pistol/vp100_gyrojet
	allowed_ammo_types = list(/obj/item/ammo_magazine/pistol/vp100_gyrojet)
	force = 12
	attachable_allowed = list(,
		/obj/item/attachable/reddot,
		/obj/item/attachable/flashlight,
...
/obj/item/weapon/gun/pistol/vp100_gyrojet/pmc_leader
