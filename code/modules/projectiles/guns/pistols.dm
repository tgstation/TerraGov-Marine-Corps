...
/obj/item/weapon/gun/pistol/plasma_pistol
	...
	flags_gun_innate_features = GUN_AUTO_EJECTOR|GUN_CAN_POINTBLANK|GUN_ENERGY|GUN_AMMO_COUNTER|GUN_IS_ATTACHMENT
	actions_types = list()
...
/obj/item/weapon/gun/pistol/chimp
	...
	gun_skill_category = GUN_SKILL_PISTOLS
	attachable_allowed = list()
	flags_gun_innate_features = GUN_AUTO_EJECTOR|GUN_LOAD_INTO_CHAMBER|GUN_AMMO_COUNTER
