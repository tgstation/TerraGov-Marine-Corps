...
/obj/item/weapon/gun/energy/lasgun/lasrifle
	...
	desc = "A multifunctional laser based rifle with an integrated mode selector, replacing the M43 Sunfury for its extremely modular system. Ideal for any situation. Uses power cells instead of ballistic magazines."
	force = 20 //Large and hefty! Includes stock bonus.
