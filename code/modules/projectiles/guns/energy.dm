...
/obj/item/weapon/gun/energy
	...
	flags_gun_innate_features = GUN_AMMO_COUNTER
...
/obj/item/weapon/gun/energy/taser
	...
	charge_cost = 500
	flags_gun_innate_features = GUN_UNUSUAL_DESIGN|GUN_AMMO_COUNTER|GUN_ALLOW_SYNTHETIC
...
/obj/item/weapon/gun/energy/lasgun
	...
	force = 15
	overcharge = FALSE
	flags_gun_innate_features = GUN_AUTO_EJECTOR|GUN_CAN_POINTBLANK|GUN_ENERGY|GUN_AMMO_COUNTER
	aim_slowdown = 0.75
...
/obj/item/weapon/gun/energy/lasgun/tesla
	...
	flags_gun_innate_features = GUN_AUTO_EJECTOR|GUN_WIELDED_FIRING_ONLY|GUN_ENERGY|GUN_AMMO_COUNTER
...
/obj/item/weapon/gun/energy/lasgun/M43
	...
	flags_gun_innate_features = GUN_AUTO_EJECTOR|GUN_CAN_POINTBLANK|GUN_AMMO_COUNTER|GUN_ENERGY|GUN_AMMO_COUNTER
	...
	if(!active_attachable && cell) //We don't need to check for the mag if an attachment was used to shoot.
		if(cell) //If there is no mag, we can't reload.
			if(overcharge && cell.charge < ENERGY_OVERCHARGE_AMMO_COST && cell.charge >= ENERGY_STANDARD_AMMO_COST) //Revert to standard shot if we don't have enough juice for overcharge, but enough for the standard mode
				cock(user)
				return
			if(cell.charge <= 0 && flags_gun_innate_features & GUN_AUTO_EJECTOR) // This is where the magazine is auto-ejected.
