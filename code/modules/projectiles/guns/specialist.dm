...
/obj/item/weapon/gun/launcher/rocket/m57a4
	name = "\improper T-800 quad thermobaric launcher"
	desc = "The T-800 is posssibly the most destructive man-portable weapon ever made. It is a 4-barreled missile launcher capable of burst-firing 4 thermobaric missiles. Enough said."
	icon_state = "m57a4"
	item_state = "m57a4"
	max_shells = 4 //codex
	caliber = "84mm rockets" //codex
