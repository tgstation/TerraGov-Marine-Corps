...
/mob/living/carbon/xenomorph/bullet_act(obj/item/projectile/P)
	...
	if(warding_aura) //Damage reduction. Every half point of warding decreases damage by 2 %. Maximum is 10 % at 5 pheromone strength.
		damage = round(damage * (1 - (warding_aura * 0.02) ) )
		#if DEBUG_XENO_DEFENSE
