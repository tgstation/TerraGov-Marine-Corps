...
/obj/item/weapon/gun/Initialize(mapload, loc, spawn_empty) //You can pass on spawn_empty to make the sure the gun has no bullets or mag or anything when created.
