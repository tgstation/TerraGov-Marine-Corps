...
/obj/item/weapon/gun/energy/taser/set_gun_config_values()
	...
	scatter = CONFIG_GET(number/mlow_scatter_value)
	scatter_unwielded = CONFIG_GET(number/low_scatter_value)
...
/obj/item/weapon/gun/energy/plasmarifle/set_gun_config_values()
	fire_delay = CONFIG_GET(number/high_fire_delay) * 2
	accuracy_mult = CONFIG_GET(number/base_hit_accuracy_mult) + CONFIG_GET(number/max_hit_accuracy_mult)
	accuracy_mult_unwielded = CONFIG_GET(number/base_hit_accuracy_mult) + CONFIG_GET(number/max_hit_accuracy_mult)
...
/obj/item/weapon/gun/energy/plasma_caster/set_gun_config_values()
	...
	accuracy_mult_unwielded = CONFIG_GET(number/base_hit_accuracy_mult) + CONFIG_GET(number/high_fire_delay)
	scatter = CONFIG_GET(number/med_scatter_value)
	scatter_unwielded = CONFIG_GET(number/med_scatter_value)
	damage_mult = CONFIG_GET(number/base_hit_damage_mult)
...
/obj/item/weapon/gun/energy/plasma_caster/attack_self(mob/living/user)
	switch(mode)
		if(0)
			mode = 1
			charge_cost = 100
			fire_delay = CONFIG_GET(number/med_fire_delay) * 4
		...
		if(1)
			mode = 2
			charge_cost = 300
			fire_delay = CONFIG_GET(number/high_fire_delay) * 20
...
/obj/item/weapon/gun/energy/lasgun/set_gun_config_values()
	...
	accuracy_mult_unwielded = CONFIG_GET(number/base_hit_accuracy_mult) - CONFIG_GET(number/high_hit_accuracy_mult)
	damage_mult = CONFIG_GET(number/base_hit_damage_mult)
	scatter_unwielded = CONFIG_GET(number/max_scatter_value) * 2 //Heavy and unwieldy
	damage_falloff_mult = CONFIG_GET(number/med_damage_falloff_mult)
...
/obj/item/weapon/gun/energy/lasgun/M43/set_gun_config_values()
	fire_delay = CONFIG_GET(number/low_fire_delay)
	accuracy_mult = CONFIG_GET(number/base_hit_accuracy_mult) + CONFIG_GET(number/max_hit_accuracy_mult)
	accuracy_mult_unwielded = CONFIG_GET(number/base_hit_accuracy_mult) - CONFIG_GET(number/max_hit_accuracy_mult) //Heavy and unwieldy; you don't one hand this.
	damage_mult = CONFIG_GET(number/base_hit_damage_mult)
	scatter_unwielded = CONFIG_GET(number/max_scatter_value) * 2.5 //Heavy and unwieldy; you don't one hand this.
	damage_falloff_mult = CONFIG_GET(number/low_damage_falloff_mult)
