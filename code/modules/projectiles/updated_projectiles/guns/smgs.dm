...
/obj/item/weapon/gun/smg/m39/set_gun_config_values()
	fire_delay = CONFIG_GET(number/low_fire_delay)
	burst_delay = CONFIG_GET(number/min_fire_delay)
	...
	accuracy_mult_unwielded = CONFIG_GET(number/base_hit_accuracy_mult) - CONFIG_GET(number/mlow_hit_accuracy_mult)
	...
	recoil_unwielded = CONFIG_GET(number/min_recoil_value)
...
/obj/item/weapon/gun/smg/m39/elite/set_gun_config_values()
	fire_delay = CONFIG_GET(number/low_fire_delay)
	burst_delay = CONFIG_GET(number/min_fire_delay)
	burst_amount = CONFIG_GET(number/high_burst_value)
	accuracy_mult = CONFIG_GET(number/base_hit_accuracy_mult) + CONFIG_GET(number/med_hit_accuracy_mult)
	accuracy_mult_unwielded = CONFIG_GET(number/base_hit_accuracy_mult) - CONFIG_GET(number/min_hit_accuracy_mult)
	scatter = CONFIG_GET(number/med_scatter_value)
	scatter_unwielded = CONFIG_GET(number/max_scatter_value)
	damage_mult = CONFIG_GET(number/base_hit_damage_mult) + CONFIG_GET(number/low_hit_damage_mult)
	recoil_unwielded = CONFIG_GET(number/min_recoil_value)
...
/obj/item/weapon/gun/smg/mp5/set_gun_config_values()
	...
	accuracy_mult = CONFIG_GET(number/base_hit_accuracy_mult) + CONFIG_GET(number/min_hit_accuracy_mult)
	accuracy_mult_unwielded = CONFIG_GET(number/base_hit_accuracy_mult) + CONFIG_GET(number/min_hit_accuracy_mult) - CONFIG_GET(number/hmed_hit_accuracy_mult)
	scatter = CONFIG_GET(number/high_scatter_value)
	scatter_unwielded = CONFIG_GET(number/max_scatter_value)
	damage_mult = CONFIG_GET(number/base_hit_damage_mult) + CONFIG_GET(number/med_hit_damage_mult)
	recoil_unwielded = CONFIG_GET(number/min_recoil_value)
...
/obj/item/weapon/gun/smg/mp7/set_gun_config_values()
	fire_delay = CONFIG_GET(number/med_fire_delay)
	burst_delay = CONFIG_GET(number/mlow_fire_delay)
	burst_amount = CONFIG_GET(number/high_burst_value)

	accuracy_mult = CONFIG_GET(number/base_hit_accuracy_mult) + CONFIG_GET(number/min_hit_accuracy_mult)
	accuracy_mult_unwielded = CONFIG_GET(number/base_hit_accuracy_mult) + CONFIG_GET(number/min_hit_accuracy_mult) - CONFIG_GET(number/hmed_hit_accuracy_mult)
	scatter = CONFIG_GET(number/med_scatter_value) + CONFIG_GET(number/low_scatter_value)
	scatter_unwielded = CONFIG_GET(number/med_scatter_value) + CONFIG_GET(number/high_scatter_value)
...
/obj/item/weapon/gun/smg/skorpion/set_gun_config_values()
	...
	scatter = CONFIG_GET(number/med_scatter_value)
	scatter_unwielded = CONFIG_GET(number/max_scatter_value)
	damage_mult = CONFIG_GET(number/base_hit_damage_mult) + CONFIG_GET(number/hmed_hit_damage_mult)
	recoil_unwielded = CONFIG_GET(number/min_recoil_value)
...
/obj/item/weapon/gun/smg/ppsh/set_gun_config_values()
	fire_delay = CONFIG_GET(number/min_fire_delay)
	burst_delay = CONFIG_GET(number/min_fire_delay)
	burst_amount = CONFIG_GET(number/max_burst_value)

	accuracy_mult = CONFIG_GET(number/base_hit_accuracy_mult) - CONFIG_GET(number/min_hit_accuracy_mult)
	accuracy_mult_unwielded = CONFIG_GET(number/base_hit_accuracy_mult) - CONFIG_GET(number/min_hit_accuracy_mult) - CONFIG_GET(number/hmed_hit_accuracy_mult)
	scatter = CONFIG_GET(number/med_scatter_value) + CONFIG_GET(number/low_scatter_value)
	scatter_unwielded = CONFIG_GET(number/max_scatter_value) + CONFIG_GET(number/low_scatter_value)
	damage_mult = CONFIG_GET(number/base_hit_damage_mult)
	recoil_unwielded = CONFIG_GET(number/min_recoil_value)
...
/obj/item/weapon/gun/smg/uzi/set_gun_config_values()
	...
	scatter = CONFIG_GET(number/med_scatter_value) + CONFIG_GET(number/med_scatter_value)
	scatter_unwielded = CONFIG_GET(number/med_scatter_value) + CONFIG_GET(number/med_scatter_value) + CONFIG_GET(number/max_scatter_value)
...
/obj/item/weapon/gun/smg/p90/set_gun_config_values()
	fire_delay = CONFIG_GET(number/high_fire_delay)
	burst_delay = CONFIG_GET(number/mlow_fire_delay)
	burst_amount = CONFIG_GET(number/med_burst_value)

	accuracy_mult = CONFIG_GET(number/base_hit_accuracy_mult) + CONFIG_GET(number/high_hit_accuracy_mult)
	accuracy_mult_unwielded = CONFIG_GET(number/base_hit_accuracy_mult) + CONFIG_GET(number/high_hit_accuracy_mult) - CONFIG_GET(number/hmed_hit_accuracy_mult)
	scatter = CONFIG_GET(number/med_scatter_value)
	scatter_unwielded = CONFIG_GET(number/med_scatter_value) + CONFIG_GET(number/max_scatter_value)
	damage_mult = CONFIG_GET(number/base_hit_damage_mult) + CONFIG_GET(number/low_hit_damage_mult)
	recoil_unwielded = CONFIG_GET(number/min_recoil_value)
