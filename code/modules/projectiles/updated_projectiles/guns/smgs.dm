...
/obj/item/weapon/gun/smg/m39
	...
	desc = "Armat Battlefield Systems M-39 submachinegun. Occasionally carried by light-infantry, scouts, engineers or medics. Uses 10x20mm rounds in a 40 round magazine."
	icon_state = "m39"
	item_state = "m39"
