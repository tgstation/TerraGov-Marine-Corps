...
/obj/item/weapon/gun/pistol/chimp
	...
	fire_sound = list('sound/weapons/gun_chimp70.ogg')
	w_class = 3
	force = 8
...
/obj/item/weapon/gun/flare
	...
	item_state = "gun" //YUCK
	fire_sound = list('sound/weapons/gun_flare.ogg')
...
/obj/item/big_ammo_box
	...
	examine()
		..()
		if(bullet_amount)
			usr << "It contains [bullet_amount] round\s."
		else
			usr << "It's empty."
		...
		if(istype(I, /obj/item/ammo_magazine))
			...
			if(AM.flags_magazine & AMMUNITION_REFILLABLE)
				...
				if(AM.current_rounds == AM.max_rounds)
					...
					return
				playsound(loc, 'sound/weapons/gun_revolver_load3.ogg', 100, 1)
...
/obj/item/big_ammo_box/smg
	...
	caliber = "10x20mm"
	icon_state = "big_ammo_box2"
	base_icon_state = "big_ammo_box2"
