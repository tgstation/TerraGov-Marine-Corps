...
/obj/item/weapon/gun/pistol/m1911/custom/set_gun_config_values()
	...
	scatter = CONFIG_GET(number/med_scatter_value)
	scatter_unwielded = CONFIG_GET(number/hmed_hit_accuracy_mult)
	damage_mult = CONFIG_GET(number/base_hit_damage_mult) + CONFIG_GET(number/low_hit_damage_mult)
...
/obj/item/weapon/gun/pistol/b92fs/set_gun_config_values()
	fire_delay = CONFIG_GET(number/mhigh_fire_delay) //to simulate manually cocking the pistol
	accuracy_mult = CONFIG_GET(number/base_hit_accuracy_mult) + CONFIG_GET(number/med_hit_accuracy_mult)
	accuracy_mult_unwielded = CONFIG_GET(number/base_hit_accuracy_mult) + CONFIG_GET(number/low_hit_accuracy_mult)  //for CQC
	damage_mult = CONFIG_GET(number/base_hit_damage_mult) - CONFIG_GET(number/max_hit_damage_mult) //We don't use guns to take people down, Raiden
...
/obj/item/weapon/gun/pistol/vp78/set_gun_config_values()
	fire_delay = CONFIG_GET(number/low_fire_delay)
	burst_amount = CONFIG_GET(number/med_burst_value)
	burst_delay = CONFIG_GET(number/low_fire_delay)
	accuracy_mult = CONFIG_GET(number/base_hit_accuracy_mult) + CONFIG_GET(number/low_hit_accuracy_mult)
	accuracy_mult_unwielded = CONFIG_GET(number/base_hit_accuracy_mult) - CONFIG_GET(number/low_hit_accuracy_mult)
	scatter = CONFIG_GET(number/med_scatter_value)
	scatter_unwielded = CONFIG_GET(number/med_scatter_value)
