...
/obj/item/weapon/gun/proc/setup_bullet_accuracy(obj/projectile/projectile_to_fire, mob/user, bullets_fired = 1, dual_wield = FALSE)
	...
	if(dual_wield) //akimbo firing gives terrible accuracy
		// Used to decrease akimbo accuracy by a random median percentage between upper and lower.
		gun_accuracy_mult = gun_accuracy_mult*rand(upper_akimbo_accuracy_mult, lower_akimbo_accuracy_mult) 
