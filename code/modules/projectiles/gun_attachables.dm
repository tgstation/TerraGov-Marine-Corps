...
/obj/item/attachable/buildasentry/on_detach(detaching_item, mob/user)
	...
	var/datum/component/deployable_item/deployable_component = detaching_gun.GetComponent(/datum/component/deployable_item)
	deployable_component.RemoveComponent()
