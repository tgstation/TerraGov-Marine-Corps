...
/obj/structure/caspart/caschair/Initialize(mapload)
	...
	RegisterSignals(SSdcs, list(COMSIG_GLOB_OPEN_TIMED_SHUTTERS_LATE, COMSIG_GLOB_OPEN_TIMED_SHUTTERS_XENO_HIVEMIND, COMSIG_GLOB_OPEN_SHUTTERS_EARLY, COMSIG_GLOB_SHUTTLE_LANDED_OUTSIDE_LANDING_ZONE), PROC_REF(cas_usable))
