...
/datum/limb/proc/silolimb(obj/structure/resin/silo/siloed_to)
	...
	switch(body_part)
		if(HEAD)
			new /obj/item/limb/head(siloed_to, owner)
		if(ARM_RIGHT)
			if(limb_status & LIMB_ROBOT)
				new /obj/item/robot_parts/r_arm(siloed_to)
			else
				new /obj/item/limb/r_arm(siloed_to, owner)
		if(ARM_LEFT)
			if(limb_status & LIMB_ROBOT)
				new /obj/item/robot_parts/l_arm(siloed_to)
			else
				new /obj/item/limb/l_arm(siloed_to, owner)
		if(LEG_RIGHT)
			if(limb_status & LIMB_ROBOT)
				new /obj/item/robot_parts/r_leg(siloed_to)
			else
				new /obj/item/limb/r_leg(siloed_to, owner)
		if(LEG_LEFT)
			if(limb_status & LIMB_ROBOT)
				new /obj/item/robot_parts/l_leg(siloed_to)
			else
				new /obj/item/limb/l_leg(siloed_to, owner)
		if(HAND_RIGHT)
			if(!(limb_status & LIMB_ROBOT))
				new /obj/item/limb/r_hand(siloed_to, owner)
		if(HAND_LEFT)
			if(!(limb_status & LIMB_ROBOT))
				new /obj/item/limb/l_hand(siloed_to, owner)
		if(FOOT_RIGHT)
			if(!(limb_status & LIMB_ROBOT))
				new /obj/item/limb/r_foot/(siloed_to, owner)
		if(FOOT_LEFT)
			if(!(limb_status & LIMB_ROBOT))
				new /obj/item/limb/l_foot(siloed_to, owner)
