...
/datum/limb/head/take_damage(brute, burn, sharp, edge, used_weapon = null, list/forbidden_limbs = list(), no_limb_loss, blocked = 0)
	. = ..(brute, burn, sharp, edge, used_weapon, forbidden_limbs, no_limb_loss, blocked)
	if (!disfigured)
		if (brute_dam > 40)
			if (prob(50))
				disfigure("brute")
