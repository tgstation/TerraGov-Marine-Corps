...
/datum/podlauncher
	...
	var/static/list/ignored_atoms = typecacheof(list(null, /mob/dead, /obj/effect/landmark, /obj/docking_port, /obj/effect/particle_effect/sparks, /obj/effect/DPtarget, /obj/effect/supplypod_selector, /atom/movable/static_lighting_object))
	var/turf/oldTurf
	var/client/holder
	var/area/bay
	var/area/podarea
