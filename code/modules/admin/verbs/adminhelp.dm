...
/client/verb/adminhelp()
	...
	var/ref_mob = "\ref[mob]"
	var/mentor_msg = "\red <b>[selected_upper]: (<A HREF='?_src_=holder;dibs=[ref_mob]'>Mark</A>)(<A HREF='?_src_=holder;NOPE=[ref_mob]'>Received</A>)(<A HREF='?_src_=holder;retarded=[ref_mob]'>Retarded</A>) [get_options_bar(mob, 0, 0, 1, 0)][ai_found ? " (<A HREF='?_src_=holder;adminchecklaws=[ref_mob]'>CL</A>)" : ""]:</b> [msg]"
	msg = "\red <b>[selected_upper]: (<A HREF='?_src_=holder;dibs=[ref_mob]'>Mark</A>)(<A HREF='?_src_=holder;NOPE=[ref_mob]'>Received</A>)(<A HREF='?_src_=holder;retarded=[ref_mob]'>Retarded</A>) [get_options_bar(mob, 2, 1, 1)][ai_found ? " (<A HREF='?_src_=holder;adminchecklaws=[ref_mob]'>CL</A>)" : ""]:</b> [msg]"
...
*/
	...
	src << "<font color='red'><b>PM to Staff ([selected_type]):</b> [original_msg]</font>"
