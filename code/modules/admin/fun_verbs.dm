...
/datum/admins/proc/release(obj/O in world)
	set category = null
	...
	log_admin("[key_name(usr)] has released [CO] ([CO.type]).")
	message_admins("[ADMIN_TPMONTY(usr)] has released [CO] ([CO.type]).")
