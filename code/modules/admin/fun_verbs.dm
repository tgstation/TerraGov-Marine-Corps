...
/datum/admins/proc/queen_report()
	...
	var/msg = "<span class='faction_alert'>[span_faction_alert_title("[customname]")]<br><span class='faction_alert_container'>[span_faction_alert_text("[html_encode(input)]")]</span></span>"
...
/datum/admins/proc/custom_info()
	...
	to_chat(world, "<span class='faction_alert'>[span_faction_alert_title("Custom Information")][span_faction_alert_text("The following custom information has been set for this round.")]<br><span class='faction_alert_container'>[span_faction_alert_text("[GLOB.custom_info]")]</span></span>")
