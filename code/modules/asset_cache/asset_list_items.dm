...
/datum/asset/simple/minimap_blip
	assets = list(
		...
		"miner_platinum_on" = 'icons/UI_Icons/minimap_blips/miner_platinum_on.png',
		"miner_platinum_off" = 'icons/UI_Icons/minimap_blips/miner_platinum_off.png',
		...
		"captain" = 'icons/UI_Icons/minimap_blips/captain.png',
		"pilot" = 'icons/UI_Icons/minimap_blips/pilot.png',
		"mo" = 'icons/UI_Icons/minimap_blips/mo.png',
