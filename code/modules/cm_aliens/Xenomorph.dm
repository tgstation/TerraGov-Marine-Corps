...
/mob/living/carbon/Xenomorph/generate_static_overlay()
	return

//removes our static effect overlays and readds them.
/mob/living/carbon/Xenomorph/proc/update_mob_static_effect()
	if(!client)
		return

	for(var/i in static_overlays_list)
		client.images.Remove(i)
		static_overlays_list.Remove(i)
	static_overlays_list = list()

	for(var/mob/living/carbon/C in mob_list)
		var/image/I = C.static_overlay
		if(I)
			static_overlays_list |= I
			client.images |= I