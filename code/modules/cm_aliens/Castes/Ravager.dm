...
/mob/living/carbon/Xenomorph/Ravager
	...
	maxplasma = 100
	jellyMax = 0
	caste_desc = "A brutal, devastating attacker."
	speed = -1.5 //Not as fast as runners, but faster than other xenos. Same speed as warriors
	evolves_to = list()
	var/usedcharge = 0 //What's the deal with the all caps??
	var/CHARGESPEED = 2
