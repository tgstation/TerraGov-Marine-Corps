...
/obj/item/stack/sandbags/attack_self(mob/user as mob)
	...
	if (locate(/obj/structure/m_barricade/sandbags, usr.loc) || locate(/obj/structure/m_barricade, usr.loc) || locate(/obj/structure/table, usr.loc) || locate(/obj/structure/rack, usr.loc) || locate(/obj/structure/table/reinforced, usr.loc))
