...
/obj/item/reagent_containers/condiment/attack(mob/M, mob/user, def_zone)
	...
	if(M == user)
		...
		log_combat(user, M, "fed", get_reagent_list_text())
	reagents.trans_to(M, 10)
	playsound(M.loc,'sound/items/drink.ogg', rand(10,50), TRUE)
	return TRUE

/obj/item/reagent_containers/condiment/proc/interact_with_atom(atom/target, mob/living/user, list/modifiers)
	...
	else if(target.is_drainable() || isfood(target))
...
/obj/item/reagent_containers/condiment/pack/on_reagent_add(datum/reagents/reagents)
