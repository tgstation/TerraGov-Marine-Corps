...
/datum/reagent/medicine/oxycodone/on_mob_delete(mob/living/L, metabolism)
	...
	addtimer(CALLBACK(L, /mob/living.proc/apply_effect(L.Paralyze(3))), 10 SECONDS)
...
/datum/reagent/medicine/synaptizine/on_mob_delete(mob/living/L, metabolism)
	...
	addtimer(CALLBACK(L, /mob/living.proc/apply_effect(L.Paralyze(1.5 SECONDS))), 10 SECONDS)
...
/datum/reagent/medicine/russian_red/on_mob_delete(mob/living/L, metabolism)
	...
	addtimer(CALLBACK(L, /mob/living.proc/apply_effect(L.Paralyze(10 SECONDS))), 10 SECONDS)
