...
/datum/reagent/medicine/kelotane/on_mob_add(mob/living/L, metabolism)
	L.add_movespeed_modifier(MOVESPEED_ID_KELOTANE, TRUE, 0, NONE, TRUE, STANDARD_MEDICINE_SLOWDOWN)

/datum/reagent/medicine/kelotane/on_mob_delete(mob/living/L, metabolism)
	L.remove_movespeed_modifier(MOVESPEED_ID_KELOTANE)
...
/datum/reagent/medicine/dermaline/on_mob_add(mob/living/L, metabolism)
	L.add_movespeed_modifier(MOVESPEED_ID_DERMALINE, TRUE, 0, NONE, TRUE, PREMIUM_MEDICINE_SLOWDOWN)

/datum/reagent/medicine/dermaline/on_mob_delete(mob/living/L, metabolism)
	L.remove_movespeed_modifier(MOVESPEED_ID_DERMALINE)
...
/datum/reagent/medicine/russian_red/on_mob_add(mob/living/L, metabolism)
	...
	if(TIMER_COOLDOWN_CHECK(L, name))
		return
	if(volume > 9) //you will heal 20% of your physical damage instantly.
		to_chat(L, span_userdanger("You feel a rush of energy as stimulants course through your veins!"))
		...
		TIMER_COOLDOWN_START(L, name, 5 MINUTES)

/datum/reagent/medicine/russian_red/on_mob_delete(mob/living/L, metabolism)
	L.remove_movespeed_modifier(MOVESPEED_ID_REDRUSSIAN_SLOWDOWN)
...
/datum/reagent/medicine/russian_red/overdose_process(mob/living/L, metabolism)
	L.apply_damages(effect_str, effect_str, 0)
...
/datum/reagent/medicine/neuraline/on_mob_add(mob/living/L, metabolism)
	L.add_movespeed_modifier(MOVESPEED_ID_NEURALINE_SLOWDOWN, TRUE, 0, NONE, TRUE, REDRUSSIAN_SLOWDOWN)
	var/mob/living/carbon/human/H = L
	if(TIMER_COOLDOWN_CHECK(L, name))
		return
	if(volume < 3) //If you are in crit, and someone injects at least 3u into you, you will heal 20% of your physical damage instantly.
		return
	to_chat(L, span_userdanger("You feel a rush of energy as stimulants course through your veins!"))
	L.adjustBruteLoss(-L.getBruteLoss() * 0.20)
	L.adjustFireLoss(-L.getFireLoss() * 0.20)
...
/datum/reagent/medicine/neuraline/on_mob_delete(mob/living/L, metabolism)
	L.remove_movespeed_modifier(MOVESPEED_ID_NEURALINE_SLOWDOWN)
...
///peri that heals more depending on taken damage
...
/datum/reagent/medicine/bicaridine/on_mob_add(mob/living/L, metabolism)
	L.add_movespeed_modifier(MOVESPEED_ID_BICARDINE, TRUE, 0, NONE, TRUE, STANDARD_MEDICINE_SLOWDOWN)

/datum/reagent/medicine/bicaridine/on_mob_delete(mob/living/L, metabolism)
	L.remove_movespeed_modifier(MOVESPEED_ID_BICARDINE)
...
/datum/reagent/medicine/meralyne/on_mob_add(mob/living/L, metabolism)
	L.add_movespeed_modifier(MOVESPEED_ID_MERALYNE, TRUE, 0, NONE, TRUE, PREMIUM_MEDICINE_SLOWDOWN)

/datum/reagent/medicine/meralyne/on_mob_delete(mob/living/L, metabolism)
	L.remove_movespeed_modifier(MOVESPEED_ID_MERALYNE)
...
/datum/reagent/medicine/hyperzine/on_mob_delete(mob/living/L, metabolism)
	...
	var/amount = current_cycle
	L.adjustOxyLoss(amount)
	L.adjustStaminaLoss(amount * 3)
	if(L.stat == DEAD)
