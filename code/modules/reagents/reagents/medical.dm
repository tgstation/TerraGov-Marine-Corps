...
/datum/reagent/medicine/ultrazine/addiction_act_stage2(mob/living/L, metabolism)
	...
	if(prob(5))
		L.emote("emote_me", EMOTE_VISIBLE, pick("winces slightly.", "grimaces."))
...
/datum/reagent/medicine/ultrazine/addiction_act_stage3(mob/living/L, metabolism)
	...
	if(prob(5))
		L.emote("emote_me", EMOTE_VISIBLE, pick("winces.", "grimaces.", "groans!"))
		L.Stun(30)
	if(prob(20))
		L.hallucination += 20
		L.AdjustConfused(10 SECONDS)
...
/datum/reagent/medicine/ultrazine/addiction_act_stage4(mob/living/L, metabolism)
	...
	if(prob(5))
		L.emote("emote_me", EMOTE_VISIBLE, pick("groans painfully!", "contorts with pain!"))
		L.Stun(80)
