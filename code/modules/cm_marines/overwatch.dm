...
/obj/machinery/computer/overwatch/proc/handle_supplydrop()
	...
	if(!supplies.len)
		to_chat(usr, "[bicon(src)] <span class='warning'>No deployable object was detected on the drop pad. Get Requisitions on the line!</span>")
		return
