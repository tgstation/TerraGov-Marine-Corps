...
//I hate having to do this, but see I gotta block air 'n shit
...
/turf/simulated/wall/invisible/Bumped(var/A as mob|obj)
	if(istype(A, /mob/living/carbon))
		var/i //iterator
		var/obj/effect/step_trigger/teleporter/random/R
		for(i in src)
			R = i
