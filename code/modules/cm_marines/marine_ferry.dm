...
/datum/shuttle/ferry/marine/long_jump()
	...
	playsound(turfs_src[sound_target], sound_takeoff, 75, 0)
	...
	playsound(turfs_int[sound_target], sound_landing, 75, 0)
	playsound(turfs_trg[sound_target], sound_landing, 75, 0)
