...
/obj/structure/dropship_equipment/weapon/laser_beam_gun
	...
	desc = "State of the art technology recently acquired by the USCM, it fires a battery-fed continuous laser beam at near lightspeed setting on fire everything it touches. Moving this will require some sort of lifter."
	icon = 'icons/Marine/almayer_props64.dmi'
