...
/datum/seed/berry/poison/death
	...
	chems = list(/datum/reagent/consumable/nutriment = list(1), /datum/reagent/toxin/lexorin = list(1,5), /datum/reagent/toxin/cyanide = list(3,5))
...
/datum/seed/apple
	...
	plant_icon = "apple"
	harvest_repeat = 1
	chems = list(/datum/reagent/consumable/nutriment = list(1,10), /datum/reagent/medicine/tramadol = list(1,2))
...
/datum/seed/ambrosia/deus
	...
	chems = list(/datum/reagent/consumable/nutriment = list(1), /datum/reagent/medicine/neuraline = list(5,10), /datum/reagent/medicine/synaptizine = list(1,8,1), /datum/reagent/medicine/hyperzine = list(1,10,1), /datum/reagent/space_drugs = list(1,10))
