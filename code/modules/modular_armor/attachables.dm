...
/obj/item/armor_module/attachable/freya_explosive_armor
	name = "Freya Explosive Compensation Module"
...
/obj/item/armor_module/attachable/freya_explosive_armor/do_attach(mob/living/user, obj/item/clothing/suit/modular/parent)
	. = ..()
	parent.soft_armor = parent.soft_armor.attachArmor(soft_armor)
	parent.slowdown += slowdown

/obj/item/armor_module/attachable/freya_explosive_armor/do_detach(mob/living/user, obj/item/clothing/suit/modular/parent)
	parent.soft_armor = parent.soft_armor.detachArmor(soft_armor)
	parent.slowdown -= slowdown
	return ..()
