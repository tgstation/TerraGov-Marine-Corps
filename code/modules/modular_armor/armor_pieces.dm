...
/obj/item/armor_module/armor/chest/marine
	...
	icon_state = "infantry_chest"
	soft_armor = list("melee" = 15, "bullet" = 20, "laser" = 20, "energy" = 10, "bomb" = 10, "bio" = 10, "rad" = 10, BURN = 10, "acid" = 15)
	slowdown = 0.3
	greyscale_config = /datum/greyscale_config/modularchest_infantry
...
/obj/item/armor_module/armor/chest/marine/skirmisher
	...
	soft_armor = list("melee" = 10, "bullet" = 15, "laser" = 15, "energy" = 10, "bomb" = 10, "bio" = 10, "rad" = 10, BURN = 10, "acid" = 10)
	slowdown = 0.1
...
/obj/item/armor_module/armor/chest/marine/assault
	...
	soft_armor = list("melee" = 20, "bullet" = 25, "laser" = 25, "energy" = 10, "bomb" = 10, "bio" = 10, "rad" = 10, BURN = 10, "acid" = 20)
	slowdown = 0.5
