...
/obj/machinery/artillerycontrol/attack_hand(mob/user as mob)
	...
	dat += "Deployment of weapon authorized by <br>Weyland-Yutani Naval Command<br><br>Remember, friendly fire is grounds for termination of your contract and life.<HR>"
