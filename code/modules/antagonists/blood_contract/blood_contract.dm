...
/datum/antagonist/blood_contract/greet()
	. = ..()
	to_chat(owner, "<span class='danger'>You've been marked for death! Don't let the demons get you! KILL THEM ALL!</span>")
...
/datum/antagonist/blood_contract/proc/start_the_hunt()
	...
	for(var/mob/living/carbon/human/P in GLOB.player_list)
		if(P == H)
			continue
		to_chat(P, "<span class='danger'>I have an overwhelming desire to kill [H]. [H.p_theyve(TRUE)] been marked red! Whoever [H.p_they()] [H.p_were()], friend or foe, go kill [H.p_them()]!</span>")
