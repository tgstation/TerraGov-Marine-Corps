...
/obj/item/clothing/shoes/marine
	...
	armor = list("melee" = 60, "bullet" = 40, "laser" = 10, "energy" = 10, "bomb" = 10, "bio" = 10, "rad" = 0, "fire" = 10)
...
/obj/item/clothing/shoes/marinechief
	...
	icon_state = "laceups"
	armor = list("melee" = 50, "bullet" = 50, "laser" = 25, "energy" = 25, "bomb" = 20, "bio" = 20, "rad" = 10, "fire" = 25)
...
/obj/item/clothing/shoes/veteran/PMC/commando
	...
	flags_armor_protection = FEET
	armor = list("melee" = 90, "bullet" = 120, "laser" = 100, "energy" = 90, "bomb" = 50, "bio" = 30, "rad" = 30, "fire" = 90)
	min_cold_protection_temperature = SHOE_MIN_COLD_PROTECTION_TEMPERATURE
	max_heat_protection_temperature = SHOE_MAX_HEAT_PROTECTION_TEMPERATURE
	flags_cold_protection = FEET
	flags_heat_protection = FEET
