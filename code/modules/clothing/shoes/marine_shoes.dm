...
/obj/item/clothing/shoes/marine
	...
	soft_armor = list("melee" = 30, "bullet" = 20, "laser" = 10, "energy" = 10, "bomb" = 10, "bio" = 10, "rad" = 0, BURN = 10, "acid" = 25)
...
/obj/item/clothing/shoes/marine/pyro
	...
	hard_armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, BURN = 100, "acid" = 0)
...
/obj/item/clothing/shoes/marinechief
	...
	icon_state = "laceups"
	soft_armor = list("melee" = 35, "bullet" = 20, "laser" = 20, "energy" = 20, "bomb" = 30, "bio" = 20, "rad" = 20, BURN = 20, "acid" = 25)
...
/obj/item/clothing/shoes/veteran/PMC
	...
	flags_armor_protection = FEET
	soft_armor = list("melee" = 30, "bullet" = 20, "laser" = 20, "energy" = 20, "bomb" = 30, "bio" = 20, "rad" = 20, BURN = 20, "acid" = 15)
	min_cold_protection_temperature = SHOE_MIN_COLD_PROTECTION_TEMPERATURE
	max_heat_protection_temperature = SHOE_MAX_HEAT_PROTECTION_TEMPERATURE
	flags_cold_protection = FEET
	flags_heat_protection = FEET
...
/obj/item/clothing/shoes/veteran/PMC/commando
	...
	flags_armor_protection = FEET
	soft_armor = list("melee" = 40, "bullet" = 20, "laser" = 20, "energy" = 20, "bomb" = 30, "bio" = 20, "rad" = 20, BURN = 20, "acid" = 25)
	min_cold_protection_temperature = SHOE_MIN_COLD_PROTECTION_TEMPERATURE
	max_heat_protection_temperature = SHOE_MAX_HEAT_PROTECTION_TEMPERATURE
	flags_cold_protection = FEET
	flags_heat_protection = FEET
...
/obj/item/clothing/shoes/marine/imperial
	...
	//icon_state = ""
	soft_armor = list("melee" = 30, "bullet" = 20, "laser" = 20, "energy" = 20, "bomb" = 30, "bio" = 20, "rad" = 20, BURN = 20, "acid" = 25)
