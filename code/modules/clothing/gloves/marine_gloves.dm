...
/obj/item/clothing/gloves/marine/specialist
	...
	icon_state = "black"
	item_state = "bgloves"
	armor = list("melee" = 80, "bullet" = 95, "laser" = 80, "energy" = 80, "bomb" = 80, "bio" = 20, "rad" = 20, "fire" = 80)
	unacidable = 1
...
/obj/item/clothing/gloves/marine/veteran/PMC
	...
	item_state = "bgloves"
	siemens_coefficient = 0
	armor = list("melee" = 60, "bullet" = 60, "laser" = 35, "energy" = 30, "bomb" = 30, "bio" = 15, "rad" = 15, "fire" = 30)
