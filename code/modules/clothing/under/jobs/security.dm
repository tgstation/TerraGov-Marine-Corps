...
/obj/item/clothing/under/rank/warden
	...
	item_state = "r_suit"
	soft_armor = list("melee" = 5, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, BURN = 0, "acid" = 0)
...
/obj/item/clothing/under/tactical
	...
	soft_armor = list("melee" = 5, "bullet" = 5, "laser" = 5, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, BURN = 0, "acid" = 0)
	siemens_coefficient = 0.9
