...
/obj/item/clothing/under/acj
	...
	flags_armor_protection = CHEST|GROIN|LEGS|FEET|ARMS|HANDS
	soft_armor = list("melee" = 100, "bullet" = 100, "laser" = 100, "energy" = 100, "bomb" = 100, "bio" = 100, "rad" = 100, BURN = 100, "acid" = 100)
...
/obj/item/clothing/under/spec_operative
	...
	soft_armor = list("melee" = 70, "bullet" = 70, "laser" = 70, "energy" = 70, "bomb" = 70, "bio" = 70, "rad" = 70, BURN = 70, "acid" = 70)
