...
/obj/item/clothing/under/marine
	...
	soft_armor = list("melee" = 5, "bullet" = 5, "laser" = 5, "energy" = 5, "bomb" = 5, "bio" = 5, "rad" = 5, BURN = 5, "acid" = 5)
...
/obj/item/clothing/under/marine/officer/ce
	...
	soft_armor = list("melee" = 5, "bullet" = 5, "laser" = 25, "energy" = 5, "bomb" = 5, "bio" = 5, "rad" = 25, BURN = 5, "acid" = 5)
...
/obj/item/clothing/under/marine/officer/engi
	...
	soft_armor = list("melee" = 5, "bullet" = 5, "laser" = 15, "energy" = 5, "bomb" = 5, "bio" = 5, "rad" = 10, BURN = 5, "acid" = 5)
...
/obj/item/clothing/under/marine/officer/researcher
	...
	soft_armor = list("melee" = 5, "bullet" = 5, "laser" = 5, "energy" = 10, "bomb" = 10, "bio" = 10, "rad" = 5, BURN = 10, "acid" = 10)
...
/obj/item/clothing/under/marine/imperial
	...
	soft_armor = list("melee" = 10, "bullet" = 10, "laser" = 10, "energy" = 10, "bomb" = 10, "bio" = 10, "rad" = 10, BURN = 10, "acid" = 10)
...
/obj/item/clothing/under/marine/veteran/PMC
	...
	min_cold_protection_temperature = ICE_PLANET_MIN_COLD_PROTECTION_TEMPERATURE
	soft_armor = list("melee" = 10, "bullet" = 10, "laser" = 5, "energy" = 5, "bomb" = 10, "bio" = 5, "rad" = 5, BURN = 5, "acid" = 5)
...
/obj/item/clothing/under/marine/veteran/PMC/commando
	...
	soft_armor = list("melee" = 10, "bullet" = 10, "laser" = 10, "energy" = 20, "bomb" = 10, "bio" = 10, "rad" = 10, BURN = 20, "acid" = 20)
	has_sensor = 0
...
/obj/item/clothing/under/marine/veteran/mercenary
	...
	min_cold_protection_temperature = ICE_PLANET_MIN_COLD_PROTECTION_TEMPERATURE
	soft_armor = list("melee" = 10, "bullet" = 10, "laser" = 5, "energy" = 5, "bomb" = 10, "bio" = 1, "rad" = 1, BURN = 5, "acid" = 5)
