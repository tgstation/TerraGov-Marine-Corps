...
/obj/item/clothing/under/gimmick
	armor = list("melee" = 10, "bullet" = 10, "laser" = 10, "energy" = 10, "bomb" = 10, "bio" = 10, "rad" = 10, "fire" = 10)
	has_sensor = 0
	displays_id = 0
...
/obj/item/clothing/suit/gimmick/jason
	...
	armor = list("melee" = 13, "bullet" = 13, "laser" = 13, "energy" = 13, "bomb" = 13, "bio" = 13, "rad" = 13, "fire" = 13)
...
/obj/item/clothing/suit/armor/gimmick/dutch
	...
	flags_cold_protection = CHEST
	flags_heat_protection = CHEST
	armor = list("melee" = 45, "bullet" = 45, "laser" = 35, "energy" = 25, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 25)
	allowed = list(
			/obj/item/weapon/gun,
