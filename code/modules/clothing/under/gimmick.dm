...
/obj/item/clothing/suit/gimmick/jason
	...
	soft_armor = list("melee" = 13, "bullet" = 13, "laser" = 13, "energy" = 13, "bomb" = 13, "bio" = 13, "rad" = 13, "fire" = 13, "acid" = 13)
...
/obj/item/clothing/suit/armor/gimmick/dutch
	...
	flags_cold_protection = CHEST
	flags_heat_protection = CHEST
	soft_armor = list("melee" = 45, "bullet" = 45, "laser" = 35, "energy" = 25, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25)
	allowed = list(
		/obj/item/weapon/gun,
		/obj/item/flashlight,
...
/obj/item/clothing/shoes/gimmick/robocop
	...
	soft_armor = list("melee" = 87, "bullet" = 87, "laser" = 87, "energy" = 87, "bomb" = 87, "bio" = 50, "rad" = 50, "fire" = 87, "acid" = 87)
