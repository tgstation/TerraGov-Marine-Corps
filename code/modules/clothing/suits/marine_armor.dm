...
/obj/item/clothing/suit/storage/marine/harness
	...
	color_list = list("orange", "snow", "grey")

/obj/item/clothing/suit/storage/marine/harness/Initialize()
	. = ..()
	AddElement(/datum/element/color)
...
/obj/item/clothing/suit/storage/marine/pasvest
	...
	light_range = 6
	flags_item_map_variant = NONE
	color_list = list("standard", "snow", "black", "green")

/obj/item/clothing/suit/storage/marine/pasvest/Initialize()
	. = ..()
	AddElement(/datum/element/color)
