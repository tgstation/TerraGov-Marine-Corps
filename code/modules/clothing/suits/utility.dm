...
/obj/item/clothing/suit/fire
	...
	soft_armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, BURN = 90, "acid" = 0)
...
/obj/item/clothing/head/bomb_hood
	...
	icon_state = "bombsuit"
	soft_armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 100, "bio" = 0, "rad" = 0, BURN = 0, "acid" = 0)
...
/obj/item/clothing/head/radiation
	...
	flags_inv_hide = HIDEFACE|HIDEMASK|HIDEEARS|HIDEALLHAIR
	flags_armor_protection = HEAD|FACE|EYES
	soft_armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 60, "rad" = 100, BURN = 0, "acid" = 0)
