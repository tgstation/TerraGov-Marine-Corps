...
/obj/item/clothing/suit/surgical
	...
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 10, "rad" = 0, "fire" = 0)
	sprite_sheets = list("Vox" = 'icons/mob/species/vox/suit.dmi')
...
/obj/item/clothing/suit/storage/det_suit
	...
	armor = list("melee" = 50, "bullet" = 10, "laser" = 25, "energy" = 10, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 10)
	sprite_sheets = list("Vox" = 'icons/mob/species/vox/suit.dmi')
...
/obj/item/clothing/suit/storage/forensics
	...
	armor = list("melee" = 10, "bullet" = 10, "laser" = 15, "energy" = 10, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 10)
