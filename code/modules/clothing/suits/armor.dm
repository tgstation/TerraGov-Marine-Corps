...
/obj/item/clothing/suit/armor/vest
	...
	armor = list("melee" = 20, "bullet" = 30, "laser" = 25, "energy" = 10, "bomb" = 15, "bio" = 0, "rad" = 0, "fire" = 10)
...
/obj/item/clothing/suit/armor/vest/pilot
	...
	flags_cold_protection = CHEST|GROIN
	flags_heat_protection = CHEST|GROIN
	armor = list("melee" = 50, "bullet" = 60, "laser" = 35, "energy" = 20, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 20)
...
/obj/item/clothing/suit/armor/laserproof
	...
	blood_overlay_type = "armor"
	armor = list("melee" = 10, "bullet" = 10, "laser" = 80, "energy" = 50, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 50)
...
/obj/item/clothing/suit/armor/bulletproof
	...
	blood_overlay_type = "armor"
	flags_armor_protection = CHEST
	armor = list("melee" = 20, "bullet" = 50, "laser" = 25, "energy" = 10, "bomb" = 15, "bio" = 0, "rad" = 0, "fire" = 10)
...
/obj/item/clothing/suit/armor/riot
	...
	armor = list("melee" = 80, "bullet" = 10, "laser" = 10, "energy" = 10, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 10)
	flags_inventory = BLOCKSHARPOBJ
...
/obj/item/clothing/suit/armor/riot/marine
	...
	armor = list("melee" = 70, "bullet" = 70, "laser" = 35, "energy" = 20, "bomb" = 35, "bio" = 10, "rad" = 10, "fire" = 20)
...
/obj/item/clothing/suit/armor/swat
	...
	slowdown = 1
	armor = list("melee" = 80, "bullet" = 60, "laser" = 50, "energy" = 25, "bomb" = 50, "bio" = 100, "rad" = 100, "fire" = 25)
...
/obj/item/clothing/suit/armor/reactive
	...
	slowdown = 1
	flags_atom = CONDUCT
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0)
...
/obj/item/clothing/suit/armor/tactical
	...
	flags_armor_protection = CHEST|GROIN|LEGS|ARMS
	slowdown = 1
	armor = list("melee" = 60, "bullet" = 60, "laser" = 60, "energy" = 40, "bomb" = 20, "bio" = 0, "rad" = 0, "fire" = 40)
	siemens_coefficient = 0.7
...
/obj/item/clothing/suit/armor/hos
	...
	armor = list("melee" = 65, "bullet" = 30, "laser" = 50, "energy" = 10, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 10)
	flags_inventory = NOFLAGS
	flags_inv_hide = HIDEJUMPSUIT
	siemens_coefficient = 0.6
