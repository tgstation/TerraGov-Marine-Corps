...
/obj/item/clothing/head/beanie
	...
	flags_inv_hide = HIDETOPHAIR
	armor = list("melee" = 15, "bullet" = 20, "laser" = 20, "energy" = 10, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/head/tgmcberet
	...
	sprite_sheet_id = 1
	icon_state = "beret"
	armor = list("melee" = 10, "bullet" = 10, "laser" = 10, "energy" = 5, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 5, "acid" = 5)
	flags_item_map_variant = (ITEM_JUNGLE_VARIANT|ITEM_ICE_VARIANT)
...
/obj/item/clothing/head/tgmcberet/wo
	...
	icon_state = "beretwo"
	armor = list("melee" = 15, "bullet" = 30, "laser" = 5, "energy" = 15, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 10)
	flags_item_map_variant = NONE
...
/obj/item/clothing/head/tgmcberet/fc
	...
	icon_state = "beretfc"
	armor = list("melee" = 15, "bullet" = 30, "laser" = 15, "energy" = 15, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 20, "acid" = 20)
	flags_item_map_variant = NONE
...
/obj/item/clothing/head/tgmccap
	...
	icon = 'icons/obj/clothing/cm_hats.dmi'
	sprite_sheet_id = 1
	armor = list("melee" = 15, "bullet" = 15, "laser" = 15, "energy" = 15, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 20, "acid" = 20)
...
/obj/item/clothing/head/boonie
	...
	armor = list("melee" = 15, "bullet" = 15, "laser" = 15, "energy" = 15, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 15, "acid" = 15)
...
/obj/item/clothing/head/beret/marine
	...
	icon_state = "hosberet"
	armor = list("melee" = 15, "bullet" = 20, "laser" = 20, "energy" = 20, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 20, "acid" = 20)
