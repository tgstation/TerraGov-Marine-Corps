...
/obj/item/clothing/head/kitty
	...
	var/icon/ears = icon("icon" = 'icons/mob/head_0.dmi', "icon_state" = "kitty")
	var/icon/earbit = icon("icon" = 'icons/mob/head_0.dmi', "icon_state" = "kittyinner")

/obj/item/clothing/head/kitty/update_icon(mob/living/carbon/human/user, remove = FALSE)
	if(!istype(user))
		return

	ears = icon("icon" = 'icons/mob/head_0.dmi', "icon_state" = "kitty")
