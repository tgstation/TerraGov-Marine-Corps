...
/obj/item/clothing/head/helmet/riot
	...
	icon_state = "riot"
	armor = list("melee" = 82, "bullet" = 15, "laser" = 5, "energy" = 5, "bomb" = 5, "bio" = 2, "rad" = 0, "fire" = 5)
	flags_inventory = COVEREYES|BLOCKSHARPOBJ
...
/obj/item/clothing/head/helmet/marine
	...
	sprite_sheet_id = 1
	icon_state = "helmet"
	armor = list("melee" = 65, "bullet" = 60, "laser" = 30, "energy" = 20, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 20)
	health = 5
	var/helmet_overlays[]
...
/obj/item/clothing/head/helmet/marine/leader
	...
	armor = list("melee" = 75, "bullet" = 65, "laser" = 40, "energy" = 40, "bomb" = 35, "bio" = 10, "rad" = 10, "fire" = 40)
...
/obj/item/clothing/head/helmet/marine/specialist
	...
	armor = list("melee" = 95, "bullet" = 105, "laser" = 75, "energy" = 65, "bomb" = 70, "bio" = 15, "rad" = 15, "fire" = 65)
	unacidable = 1
	anti_hug = 6
...
/obj/item/clothing/head/helmet/marine/scout
	...
	armor = list("melee" = 75, "bullet" = 70, "laser" = 40, "energy" = 40, "bomb" = 35, "bio" = 10, "rad" = 10, "fire" = 40)
...
/obj/item/clothing/head/helmet/marine/pyro
	...
	armor = list("melee" = 85, "bullet" = 80, "laser" = 60, "energy" = 50, "bomb" = 50, "bio" = 10, "rad" = 10, "fire" = 50)
	min_cold_protection_temperature = ICE_PLANET_MIN_COLD_PROTECTION_TEMPERATURE
...
/obj/item/clothing/head/helmet/marine/pilot
	...
	icon_state = "helmetp"
	armor = list("melee" = 65, "bullet" = 65, "laser" = 35, "energy" = 45, "bomb" = 30, "bio" = 15, "rad" = 15, "fire" = 45)
	min_cold_protection_temperature = ICE_PLANET_MIN_COLD_PROTECTION_TEMPERATURE
	flags_inventory = BLOCKSHARPOBJ
...
/obj/item/clothing/head/helmet/marine/veteran/PMC
	...
	icon_state = "pmc_hat"
	armor = list("melee" = 38, "bullet" = 38, "laser" = 32, "energy" = 22, "bomb" = 12, "bio" = 5, "rad" = 5, "fire" = 22)
	min_cold_protection_temperature = ICE_PLANET_MIN_COLD_PROTECTION_TEMPERATURE
	flags_inventory = BLOCKSHARPOBJ
	flags_inv_hide = NOFLAGS
	flags_marine_helmet = NOFLAGS
...
/obj/item/clothing/head/helmet/marine/veteran/PMC/sniper
	...
	armor = list("melee" = 55, "bullet" = 65, "laser" = 45, "energy" = 55, "bomb" = 60, "bio" = 10, "rad" = 10, "fire" = 55)
...
/obj/item/clothing/head/helmet/marine/veteran/PMC/gunner
	...
	flags_armor_protection = HEAD|FACE|EYES
	armor = list("melee" = 80, "bullet" = 80, "laser" = 50, "energy" = 60, "bomb" = 70, "bio" = 10, "rad" = 10, "fire" = 60)
	flags_inventory = COVEREYES|COVERMOUTH|BLOCKSHARPOBJ
	flags_inv_hide = HIDEEARS|HIDEEYES|HIDEFACE|HIDEMASK|HIDEALLHAIR
	flags_marine_helmet = HELMET_DAMAGE_OVERLAY
...
/obj/item/clothing/head/helmet/marine/veteran/PMC/commando
	...
	flags_armor_protection = HEAD|FACE|EYES
	armor = list("melee" = 90, "bullet" = 120, "laser" = 90, "energy" = 90, "bomb" = 90, "bio" = 100, "rad" = 100, "fire" = 90)
...
/obj/item/clothing/head/helmet/marine/veteran/bear
	...
	icon_state = "dutch_helmet"
	armor = list("melee" = 90, "bullet" = 65, "laser" = 40, "energy" = 35, "bomb" = 35, "bio" = 5, "rad" = 5, "fire" = 35)
	min_cold_protection_temperature = ICE_PLANET_MIN_COLD_PROTECTION_TEMPERATURE
	flags_marine_helmet = HELMET_GARB_OVERLAY|HELMET_DAMAGE_OVERLAY|HELMET_STORE_GARB
...
/obj/item/clothing/head/helmet/UPP
	...
	armor = list("melee" = 70, "bullet" = 55, "laser" = 40, "energy" = 35, "bomb" = 35, "bio" = 5, "rad" = 5, "fire" = 35)
	min_cold_protection_temperature = ICE_PLANET_MIN_COLD_PROTECTION_TEMPERATURE
...
/obj/item/clothing/head/helmet/UPP/heavy
	...
	armor = list("melee" = 90, "bullet" = 85, "laser" = 60, "energy" = 65, "bomb" = 85, "bio" = 5, "rad" = 5, "fire" = 65)
	unacidable = 1
	anti_hug = 3
...
/obj/item/clothing/head/helmet/marine/veteran/mercenary/miner
	...
	flags_armor_protection = HEAD|FACE|EYES
	armor = list("melee" = 55, "bullet" = 55, "laser" = 45, "energy" = 55, "bomb" = 55, "bio" = 10, "rad" = 10, "fire" = 55)
...
/obj/item/clothing/head/helmet/marine/veteran/mercenary/engineer
	...
	flags_armor_protection = HEAD|FACE|EYES
	armor = list("melee" = 55, "bullet" = 60, "laser" = 45, "energy" = 55, "bomb" = 60, "bio" = 10, "rad" = 10, "fire" = 55)