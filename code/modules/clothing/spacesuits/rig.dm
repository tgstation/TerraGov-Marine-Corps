...
/obj/item/clothing/head/helmet/space/rig
	...
	item_state = "eng_helm"
	soft_armor = list("melee" = 40, "bullet" = 5, "laser" = 20, "energy" = 5, "bomb" = 35, "bio" = 100, "rad" = 20, BURN = 5, "acid" = 5)
...
/obj/item/clothing/head/helmet/space/rig/engineering
	...
	icon_state = "rig0-engineering"
	item_state = "eng_helm"
	soft_armor = list("melee" = 40, "bullet" = 5, "laser" = 20, "energy" = 5, "bomb" = 35, "bio" = 100, "rad" = 80, BURN = 5, "acid" = 5)
...
/obj/item/clothing/head/helmet/space/rig/mining
	...
	rig_color = "mining"
	soft_armor = list("melee" = 50, "bullet" = 5, "laser" = 20, "energy" = 5, "bomb" = 55, "bio" = 100, "rad" = 20, BURN = 5, "acid" = 5)
...
/obj/item/clothing/head/helmet/space/rig/syndi
	...
	rig_color = "syndie"
	soft_armor = list("melee" = 60, "bullet" = 50, "laser" = 30, "energy" = 15, "bomb" = 35, "bio" = 100, "rad" = 60, BURN = 15, "acid" = 15)
...
/obj/item/clothing/head/helmet/space/rig/wizard
	...
	soft_armor = list("melee" = 40, "bullet" = 20, "laser" = 20, "energy" = 20, "bomb" = 35, "bio" = 100, "rad" = 60, BURN = 20, "acid" = 20)
...
/obj/item/clothing/head/helmet/space/rig/medical
	...
	rig_color = "medical"
	soft_armor = list("melee" = 30, "bullet" = 5, "laser" = 20, "energy" = 5, "bomb" = 25, "bio" = 100, "rad" = 50, BURN = 5, "acid" = 5)
...
/obj/item/clothing/head/helmet/space/rig/security
	...
	item_state = "sec_helm"
	rig_color = "sec"
	soft_armor = list("melee" = 60, "bullet" = 10, "laser" = 30, "energy" = 5, "bomb" = 45, "bio" = 100, "rad" = 10, BURN = 5, "acid" = 5)
	siemens_coefficient = 0.7
...
/obj/item/clothing/head/helmet/space/rig/atmos
	...
	rig_color = "atmos"
	soft_armor = list("melee" = 40, "bullet" = 5, "laser" = 20, "energy" = 5, "bomb" = 35, "bio" = 100, "rad" = 50, BURN = 5, "acid" = 5)
