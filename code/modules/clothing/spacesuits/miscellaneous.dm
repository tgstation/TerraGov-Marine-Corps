...
/obj/item/clothing/head/helmet/space/deathsquad
	...
	armor = list("melee" = 65, "bullet" = 55, "laser" = 35, "energy" = 20, "bomb" = 30, "bio" = 100, "rad" = 60, "fire" = 20)
...
/obj/item/clothing/head/helmet/space/deathsquad/beret
	...
	armor = list("melee" = 65, "bullet" = 55, "laser" = 35, "energy" = 20, "bomb" = 30, "bio" = 30, "rad" = 30, "fire" = 20)
...
/obj/item/clothing/suit/space/compression
	...
	item_state = "compression"
	icon_state = "compression"
	armor = list("melee" = 50, "bullet" = 55, "laser" = 65, "energy" = 70, "bomb" = 65, "bio" = 100, "rad" = 70, "fire" = 70)
	unacidable = 1