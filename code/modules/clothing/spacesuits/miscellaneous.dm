...
/obj/item/clothing/head/helmet/space/deathsquad
	...
	soft_armor = list("melee" = 65, "bullet" = 55, "laser" = 35, "energy" = 20, "bomb" = 30, "bio" = 100, "rad" = 60, BURN = 20, "acid" = 20)
...
/obj/item/clothing/head/helmet/space/deathsquad/beret
	...
	soft_armor = list("melee" = 65, "bullet" = 55, "laser" = 35, "energy" = 20, "bomb" = 30, "bio" = 30, "rad" = 30, BURN = 20, "acid" = 20)
...
/obj/item/clothing/head/helmet/space/compression
	...
	soft_armor = list("melee" = 40, "bullet" = 45, "laser" = 40, "energy" = 55, "bomb" = 40, "bio" = 100, "rad" = 50, BURN = 55, "acid" = 55)
...
/obj/item/clothing/suit/space/compression
	...
	item_state = "compression"
	icon_state = "compression"
	soft_armor = list("melee" = 40, "bullet" = 55, "laser" = 65, "energy" = 70, "bomb" = 65, "bio" = 100, "rad" = 70, BURN = 70, "acid" = 70)
	resistance_flags = UNACIDABLE
...
/obj/item/clothing/suit/space/chronos
	...
	item_state = "chronos"
	icon_state = "chronos"
	soft_armor = list("melee" = 100, "bullet" = 100, "laser" = 100, "energy" = 100, "bomb" = 100, "bio" = 100, "rad" = 100, BURN = 100, "acid" = 100)	//DONT FUCK WITH THIS SENATOR
	resistance_flags = UNACIDABLE
	siemens_coefficient = 0
	slowdown = 0
	allowed = list(/obj/item/weapon/gun,/obj/item/ammo_magazine,/obj/item/ammo_casing,/obj/item/weapon/baton,/obj/item/restraints/handcuffs,/obj/item/tank/emergency_oxygen)
