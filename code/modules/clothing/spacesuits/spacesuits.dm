...
/obj/item/clothing/head/helmet/space
	...
	worn_icon = list(slot_head_str = 'icons/mob/clothing/headwear/space_suit_helmets.dmi')
...
/obj/item/clothing/suit/space
	...
	worn_icon = list(slot_wear_suit_str = 'icons/mob/clothing/suits/space_suits.dmi')
	icon_state = "space"
