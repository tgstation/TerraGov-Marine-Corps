...
/obj/item/clothing/head/modular/m10x/maska/striped
	name = "\improper painted M10ASKA-1SCh pattern marine helmet"
	desc = "A M10 Pattern Helmet with attach points and a flimsy metal face shield. This one has had some stripes painted on it, CHEEKI BREEKI IV DAMNKE."
	greyscale_config = /datum/greyscale_config/xenonaut/helm/maska_striped
