...
/obj/item/armor_module/armor/chest/marine
	...
	soft_armor = list(MELEE = 20, BULLET = 45, LASER = 45, ENERGY = 35, BOMB = 30, BIO = 30, FIRE = 30, ACID = 35)
	slowdown = 0.3
...
/obj/item/armor_module/armor/chest/marine/skirmisher
	...
	soft_armor = list(MELEE = 10, BULLET = 35, LASER = 35, ENERGY = 25, BOMB = 25, BIO = 25, FIRE = 25, ACID = 25)
	slowdown = 0.1
...
/obj/item/armor_module/armor/chest/marine/assault
	...
	soft_armor = list(MELEE = 25, BULLET = 50, LASER = 50, ENERGY = 40, BOMB = 35, BIO = 35, FIRE = 35, ACID = 40)
	slowdown = 0.5
