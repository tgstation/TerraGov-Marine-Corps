...
/obj/item/armor_module/armor/visor/on_attach(obj/item/attaching_to, mob/user)
	...
	if(visor_emissive_on)
		parent.AddElement(/datum/element/special_clothing_overlay/modular_helmet_visor, HEAD_LAYER, icon, icon_state)
	update_icon()
...
/obj/item/armor_module/armor/visor/on_detach(obj/item/detaching_from, mob/user)
	...
	parent.RemoveElement(/datum/element/special_clothing_overlay/modular_helmet_visor, HEAD_LAYER, icon, icon_state)
	update_icon()
	return ..()
