...
/obj/item/armor_module/module/binoculars/heimdall_mark_two // a little cheating with subtypes
	name = "\improper Mark 2 Heimdall Helmet Module"
	desc = "Designed for mounting on a modular helmet. The Heimdall module is designed with an overlay visor that clarifies the user's vision, allowing them to see clearly even in the harshest of circumstances. This version is enhanced and allows the marine to peer through the visor, akin to binoculars."
	icon_state = "heimdall_head"
	item_state = "heimdall_head_mk2_a"
	variants_by_parent_type = list(/obj/item/clothing/head/modular/m10x = "heimdall_head_mk2_xn", /obj/item/clothing/head/modular/marine/old/open = "heimdall_head_mk2_xn", /obj/item/clothing/head/modular/m10x/heavy = "heimdall_head_mk2")

/obj/item/armor_module/module/binoculars/heimdall_mark_two/on_attach(obj/item/attaching_to, mob/user)
	. = ..()
	parent.AddComponent(/datum/component/blur_protection)

/obj/item/armor_module/module/heimdall
	name = "\improper Mark 1 Heimdall Helmet Module"
	desc = "Designed for mounting on a modular helmet. The Heimdall module is designed with an overlay visor that clarifies the user's vision, allowing them to see clearly even in the harshest of circumstances."
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
	icon_state = "heimdall_head"
	item_state = "heimdall_head_a"
	slot = ATTACHMENT_SLOT_HEAD_MODULE
	variants_by_parent_type = list(/obj/item/clothing/head/modular/m10x = "heimdall_head_xn", /obj/item/clothing/head/modular/marine/old/open = "heimdall_head_xn", /obj/item/clothing/head/modular/m10x/heavy = "heimdall_head")
	flags_attach_features = ATTACH_REMOVABLE|ATTACH_APPLY_ON_MOB
	prefered_slot = SLOT_HEAD

/obj/item/armor_module/module/heimdall/on_attach(obj/item/attaching_to, mob/user)
	. = ..()
	parent.AddComponent(/datum/component/blur_protection)
