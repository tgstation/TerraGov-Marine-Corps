...
/obj/item/armor_module/module/tactical_sensor
	name = "\improper Tactical sensor helmet module"
	desc = "A helmet attachment that detects hostile movement. Hostiles appear as red blips. Friendlies appear as green blips."
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
