...
/datum/action/innate/message_squad/action_activate()
	...
	for(var/mob/mob_receiver in alert_receivers)
		...
		mob_receiver.play_screen_text("<span class='maptext' style=font-size:24pt;text-align:left valign='top'><u>[announcement_title]:</u></span><br>" + text, new /atom/movable/screen/text/screen_text/picture/potrait/custom_mugshot(null, null, owner), "[override_color]")
