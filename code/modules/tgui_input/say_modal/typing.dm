...
/mob/living/create_thinking_indicator()
	if(active_thinking_indicator || active_typing_indicator || !thinking_IC || stat != CONSCIOUS )
		return FALSE
	active_thinking_indicator = mutable_appearance('modular_RUtgmc/icons/mob/effects/talk.dmi', "[bubble_icon]3", TYPING_LAYER, appearance_flags = APPEARANCE_UI|KEEP_APART|TILE_BOUND) //RUTGMC edit - icon change
...
/mob/living/create_typing_indicator()
	if(active_typing_indicator || active_thinking_indicator || !thinking_IC || stat != CONSCIOUS)
		return FALSE
	active_typing_indicator = mutable_appearance('modular_RUtgmc/icons/mob/effects/talk.dmi', "[bubble_icon]0", TYPING_LAYER, appearance_flags = APPEARANCE_UI|KEEP_APART|TILE_BOUND) //RUTGMC edit - icon change
