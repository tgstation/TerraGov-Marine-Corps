/atom/movable/effect/abstract/ripple
...
/atom/movable/effect/abstract/ripple/Initialize(mapload, time_left)
	. = ..()
	animate(src, alpha=255, time=time_left)
	addtimer(CALLBACK(src, .proc/stop_animation), 8, TIMER_CLIENT_TIME)

/atom/movable/effect/abstract/ripple/proc/stop_animation()
