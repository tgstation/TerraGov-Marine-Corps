...
/obj/docking_port/mobile/marine_dropship/two
	...
	id = "normandy"
	control_flags = SHUTTLE_MARINE_PRIMARY_DROPSHIP
	callTime = 28 SECONDS //smaller shuttle for lowpop go whoosh
...
/obj/structure/dropship_piece/two/front/rightright
	icon_state = "blue_frr"
	density = FALSE

/obj/structure/dropship_piece/two/front/leftleft
	icon_state = "blue_fll"
	density = FALSE
