...
/datum/nanite_program/necrotic/active_effect()
	...
	if(prob(1))
		to_chat(host_mob, "<span class='warning'>I feel a mild ache from somewhere inside you.</span>")
...
/datum/nanite_program/toxic/active_effect()
	...
	if(prob(1))
		to_chat(host_mob, "<span class='warning'>I feel a bit sick.</span>")
...
/datum/nanite_program/suffocating/active_effect()
	...
	if(prob(1))
		to_chat(host_mob, "<span class='warning'>I feel short of breath.</span>")
...
/datum/nanite_program/skin_decay/active_effect()
	...
	if(prob(5)) //itching
		...
		"<span class='warning'>My [bodypart.name] itches. [can_scratch ? " You scratch it." : ""]</span>")
...
/datum/nanite_program/nerve_decay/active_effect()
	if(prob(5))
		to_chat(host_mob, "<span class='warning'>I feel unbalanced!</span>")
		host_mob.confused += 10
	else if(prob(4))
		to_chat(host_mob, "<span class='warning'>I can't feel my hands!</span>")
		host_mob.drop_all_held_items()
	else if(prob(4))
		to_chat(host_mob, "<span class='warning'>I can't feel my legs!</span>")
