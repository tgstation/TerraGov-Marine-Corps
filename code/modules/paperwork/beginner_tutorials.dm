...
/obj/item/paper/tutorial/plasmacutter
	...
	Use this to destroy mazes and punish xenomorphs for trying to attack you by refilling your battery.<BR>
	<BR>
	BKTT is an acronym that is used to describe the combination of Bicaridine, Kelotane, Tricordizine, and Tramadol used as an all-rounder combat medicine mix \
	for any situation that heals all different types of damage. Make sure not to take more than two of each pill at a time - medicine takes a while to process \
	through your system, and too many at once risks a dangerous overdose. Your gauze and ointment are body-part specific, unlike medication, but once you start \
...
/obj/item/paper/tutorial/point_sentry
	...
	Your primary weapon is a SH35 shotgun loaded with flechette, which pierces and shreds armor while dealing large damage. \
	Spare shotgun ammo is stored in your belt. Flechette is perfect for dealing with larger xenomorphs, such as the Queen. \
	Your left pocket contains a tool pouch for all the tools you'll need to perform your engineering duties, including a welder to fix your sentry. \
	Your right pouch contains a first aid kit, complete with Bicaridine (heals brute damage), Kelotane (heals burn damage), Tramadol (a painkiller), \
	Tricordrazine (heals all damage, but slowly), and Dylovene (heals toxin damage), as well as splints and inaprovaline. \
	Your helmet contains protein bars for eating, and your boots contain an MRE for further eating. \
	The optical mesons on your eyewear slot give you the ability to see the shape of rooms behind solid walls, though you can't see anything (including xenomorphs!) \
	...
	Your suit storage contains materials, along with a spare power cell and a plastique explosive for destroying walls. \
	Your backpack has an attached fuel tank that can be used to refill welders should yours run empty.<BR>
	<BR>
	<b>TIPS</b><BR>
	<BR>
	...
	<BR>
	Many things can threaten your sentry, especially crushers and spitters. \
	Crushers get stopped by razorwire and barricades, which should be placed above and to the sides of your sentry to cut off any crusher lanes. \
	Spitters can be trickier, you should either get aggressive with your shotgun to scare them off or quickly pick up your sentry and run.<BR>
	<BR>
	Your sentry is perfect for keeping smaller xenomorphs off of you while you work. \
	Use it for protection while helping medics, clearing maze, fixing APCs, running disks, repairing miners, or when healing yourself. \
	When combined with your flechette shotgun, you can pose a serious threat to any xenomorph in range. \
	Working with your team to flank xenomorphs and get a sentry and barricades up behind them can completely wipe out an unprepared hive.<BR>
	<BR>
	Your armor is equipped with a Loki Illusion Module, which has an active ability that turns you invisible and creates a mirage clone. \
	You can activate this by clicking the icon or using your Toggle Armor Module keybind. \
	This can be useful for evading a xenomorph while your sentry shoots them.<BR>
	<BR>
	In your webbing you will find a spare powercell and a handheld cell crank charger to charge them, when fixing apcs swap the empty battery for \
	your full one. Insert the empty one into your crank, press Z to start charging, and charge it for the next disk!<BR>
	<BR>
