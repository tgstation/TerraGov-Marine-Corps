...
/datum/preferences/proc/load_preferences()
	...
	READ_FILE(S["screentips_enabled"], screentips_enabled)
	READ_FILE(S["screentip_images"], screentip_images)
	...
	screentip_color = sanitize_hexcolor(screentip_color, 6, TRUE, initial(screentip_color))
	screentips_enabled = sanitize_inlist(screentips_enabled, list(SCREENTIP_PREFERENCE_DISABLED, SCREENTIP_PREFERENCE_ENABLED, SCREENTIP_PREFERENCE_CONTEXT_ONLY), initial(screentips_enabled))
	screentip_images = sanitize_integer(screentip_images, FALSE, TRUE, initial(screentip_images))
...
/datum/preferences/proc/save_preferences()
	...
	WRITE_FILE(S["screentips_enabled"], screentips_enabled)
