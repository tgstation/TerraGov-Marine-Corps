...
/datum/preferences/proc/load_loadout(loadout_name, loadout_job)
	///list of all available loadouts, specifying their actual content. This is super jank proof of concept, but it works
...
/datum/preferences/proc/load_loadout_list()
	///list of all available loadouts. This is super jank proof of concept, but it works
