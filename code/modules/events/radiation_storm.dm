...
/datum/event/radiation_storm/start()
	spawn()
		...
		command_announcement.Announce("The [CONFIG_GET(string/server_name)] has entered the radiation belt. Please remain in a sheltered area until it has passed.", "Anomaly Alert")
		...
		command_announcement.Announce("The [CONFIG_GET(string/server_name)] has passed the radiation belt. Please report to medbay if you experience any unusual symptoms. Maintenance will lose all access again shortly.", "Anomaly Alert")
