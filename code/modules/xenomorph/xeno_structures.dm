...
/obj/structure/xeno/silo/LateInitialize()
	...
	if(GLOB.hive_datums[hivenumber])
		RegisterSignal(GLOB.hive_datums[hivenumber], list(COMSIG_HIVE_XENO_MOTHER_PRE_CHECK, COMSIG_HIVE_XENO_MOTHER_CHECK), .proc/is_burrowed_larva_host)
...
/obj/structure/xeno/xeno_turret/Destroy()
	GLOB.xeno_resin_turrets_by_hive[XENO_HIVE_NORMAL] -= src
	set_hostile(null)
