...
/obj/structure/resin/silo/proc/resin_silo_damage_alert()
	...
	associated_hive.xeno_message("<span class='xenoannounce'>Our [name] at [AREACOORD_NO_Z(src)] is under attack! It has [obj_integrity]/[max_integrity] Health remaining.</span>", 2, FALSE, src.loc, 'sound/voice/alien_help1.ogg', /obj/screen/arrow/silo_damaged_arrow)
