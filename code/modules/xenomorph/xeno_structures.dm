...
/obj/structure/resin/silo/Destroy()
	...
	if(associated_hive)
		...
		associated_hive.xeno_message("<span class='xenoannounce'>A resin silo has been destroyed at [AREACOORD_NO_Z(src)]!</span>", 2, FALSE,src.loc, 'sound/voice/alien_help2.ogg',FALSE,null,arrow_silo_attacked)
...
/obj/structure/resin/silo/proc/resin_silo_damage_alert()
	...
	associated_hive.xeno_message("<span class='xenoannounce'>Our [name] at [AREACOORD_NO_Z(src)] is under attack! It has [obj_integrity]/[max_integrity] Health remaining.</span>", 2, FALSE, src.loc, 'sound/voice/alien_help1.ogg', arrow_silo_attacked)
