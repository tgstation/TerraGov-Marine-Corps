...
/obj/item/mecha_equipment/proc/try_attach_part(mob/user, obj/vehicle/sealed/mecha/M, attach_right = FALSE)
 ...
 */
/obj/item/mecha_equipment/proc/action_checks(atom/target, ignore_cooldown = FALSE)
	if(!target)
		return FALSE
	if(!chassis)
		return FALSE
...
/obj/item/mecha_equipment/proc/can_attach(obj/vehicle/sealed/mecha/M, attach_right = FALSE)
	return default_can_attach(M, attach_right)

/obj/item/mecha_equipment/proc/default_can_attach(obj/vehicle/sealed/mecha/mech, attach_right = FALSE)
...
/obj/item/mecha_equipment/proc/attach(obj/vehicle/sealed/mecha/M, attach_right = FALSE)
...
/obj/item/mecha_equipment/proc/attempt_rearm()
	return FALSE
