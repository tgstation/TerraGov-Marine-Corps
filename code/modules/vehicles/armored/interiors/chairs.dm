...
/obj/structure/bed/chair/vehicle_crew
	...
	///modifier to view range when in this chair. Not additive mod
	var/vis_range_mod
...
/obj/structure/bed/chair/vehicle_crew/link_interior(datum/interior/link)
	...
	vis_range_mod = owner.vis_range_mod
...
/obj/structure/bed/chair/vehicle_crew/post_buckle_mob(mob/buckling_mob)
	...
	if(vis_range_mod)
		buckling_mob.client.view_size.set_view_radius_to("[vis_range_mod]x[vis_range_mod]")
