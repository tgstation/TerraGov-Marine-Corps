...
/obj/vehicle/sealed/armored/multitile/add_desant(mob/living/new_desant)
	new_desant.add_traits(get_traits_from_pass_flags(desant_pass_flags|pass_flags), VEHICLE_TRAIT)

/obj/vehicle/sealed/armored/multitile/remove_desant(mob/living/old_desant)
	old_desant.remove_traits(get_traits_from_pass_flags(desant_pass_flags|pass_flags), VEHICLE_TRAIT)
