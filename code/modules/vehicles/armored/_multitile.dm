/obj/vehicle/sealed/armored/multitile
	...
	permitted_mods = list(/obj/item/tank_module/overdrive, /obj/item/tank_module/ability/zoom, /obj/item/tank_module/ability/smoke_launcher, /obj/item/tank_module/interior/autoloader)
