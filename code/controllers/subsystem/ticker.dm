...
/datum/controller/subsystem/ticker/Initialize(timeofday)
	...
	login_music = pick(
		list("https://youtu.be/fNdMC6_eUGk",0,180), //Space Hero
		list("https://youtu.be/KflMk8O18LI",0,180), //Man of War
		list("https://youtu.be/uV9s1a6AZT0",0,180), //Praise the lord and pass the ammunition
		list("https://youtu.be/vzrYgDnewSI",0,180), //Blood upon the risers
		list("https://youtu.be/w0cbkOm9p1k",0,180), //Dawson's Christian
		list("https://youtu.be/OlkH687M4YM",0,180)) //Bomber
