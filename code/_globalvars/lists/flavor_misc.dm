...
//RUTGMC EDIT: Moved to modular_RUtgmc\code\_globalvars\lists\flavor_misc.dm
...
/proc/init_minimap_icons()
	...
	for(var/icon_state in GLOB.playable_icons)
		.[icon_state] = icon2base64(icon('modular_RUtgmc/icons/UI_icons/map_blips.dmi', icon_state, frame = 1))
