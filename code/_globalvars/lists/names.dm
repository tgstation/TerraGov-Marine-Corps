...
GLOBAL_LIST_INIT(megacarp_first_names, file2list("strings/names/megacarp_first.txt"))
GLOBAL_LIST_INIT(megacarp_last_names, file2list("strings/names/megacarp_last.txt"))