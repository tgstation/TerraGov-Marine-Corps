GLOBAL_LIST_INIT(bitfields, list(
	...
	"sec_level_flags" = list(
		"SEC_LEVEL_CAN_SWITCH_COMMS_CONSOLE" = SEC_LEVEL_CAN_SWITCH_COMMS_CONSOLE,
		"SEC_LEVEL_CAN_SWITCH_WITH_AUTH" = SEC_LEVEL_CAN_SWITCH_WITH_AUTH,
		"SEC_LEVEL_CANNOT_SWITCH" = SEC_LEVEL_CANNOT_SWITCH,
		"SEC_LEVEL_IS_EMERGENCY" = SEC_LEVEL_IS_EMERGENCY,
	),
))
