GLOBAL_LIST_INIT(bitfields, list(
	...
	"flags_marine_gloves" = list(
		"GLOVES_SQUAD_OVERLAY" = GLOVES_SQUAD_OVERLAY,
		),
	...
	"caste_flags" = list(
		...
		"CASTE_CAN_HEAL_WIHOUT_QUEEN" = CASTE_CAN_HEAL_WIHOUT_QUEEN,
		"CASTE_INNATE_PLASMA_REGEN" = CASTE_INNATE_PLASMA_REGEN,
		"CASTE_ACID_BLOOD" = CASTE_ACID_BLOOD,
		"CASTE_CAN_CRAWL" = CASTE_CAN_CRAWL
		),
	"species_flags" = list(
		"NO_BLOOD" = NO_BLOOD,
	...
	"knockout_flags" = list(
		"KNOCKOUT_STATUSEFFECT_UNCONSCIOUS" = KNOCKOUT_STATUSEFFECT_UNCONSCIOUS,
		"KNOCKOUT_STATUSEFFECT_SLEEEPING" = KNOCKOUT_STATUSEFFECT_SLEEEPING,
		"KNOCKOUT_STATUSEFFECT_ADMINSLEEP" = KNOCKOUT_STATUSEFFECT_ADMINSLEEP,
		"KNOCKOUT_OXYLOSS" = KNOCKOUT_OXYLOSS,
		"KNOCKOUT_SSD" = KNOCKOUT_SSD
	),
	"immobile_flags" = list(
		"IMMOBILE_INNATE" = IMMOBILE_INNATE,
		"IMMOBILE_STATUSEFFECT_IMMOBILIZED" = IMMOBILE_STATUSEFFECT_IMMOBILIZED,
		"IMMOBILE_STATUSEFFECT_STUN" = IMMOBILE_STATUSEFFECT_STUN,
		"IMMOBILE_STATUSEFFECT_PARALYZED" = IMMOBILE_STATUSEFFECT_PARALYZED,
		"IMMOBILE_FAKEDDEATH" = IMMOBILE_FAKEDDEATH,
		"IMMOBILE_STAT_UNCONSCIOUS" = IMMOBILE_STAT_UNCONSCIOUS,
		"IMMOBILE_STAT_SOFTCRITPULLED" = IMMOBILE_STAT_SOFTCRITPULLED,
		"IMMOBILE_BUCKLED" = IMMOBILE_BUCKLED,
		"IMMOBILE_RESTRAINED_PSYCHICGRABBED" = IMMOBILE_RESTRAINED_PSYCHICGRABBED,
		"IMMOBILE_GRABSTATE_GRAB_NECK" = IMMOBILE_GRABSTATE_GRAB_NECK,
		"IMMOBILE_FROZEN" = IMMOBILE_FROZEN,
		"IMMOBILE_TRAIT_STASIS" = IMMOBILE_TRAIT_STASIS,
		"IMMOBILE_LIMBLESS" = IMMOBILE_LIMBLESS,
		"IMMOBILE_STEPTRIGGER_THROWER" = IMMOBILE_STEPTRIGGER_THROWER,
		"IMMOBILE_DEVOURED" = IMMOBILE_DEVOURED,
		"IMMOBILE_KNOCKOUT" = IMMOBILE_KNOCKOUT,
		"IMMOBILE_XENOLYING" = IMMOBILE_XENOLYING
	),
	"lying_flags" = list(
		"LYING_STATUSEFFECT_KNOCKEDDOWN" = LYING_STATUSEFFECT_KNOCKEDDOWN,
		"LYING_STATUSEFFECT_PARALYZED" = LYING_STATUSEFFECT_PARALYZED,
		"LYING_STAT_NOTCONSCIOUS" = LYING_STAT_NOTCONSCIOUS,
		"LYING_BUCKLED" = LYING_BUCKLED,
		"LYING_LEGLESS" = LYING_LEGLESS,
		"LYING_FAKEDDEATH" = LYING_FAKEDDEATH,
		"LYING_STATUSEFFECT_WORMED" = LYING_STATUSEFFECT_WORMED,
		"LYING_PAINSHOCK" = LYING_PAINSHOCK,
		"LYING_DEVOURED" = LYING_DEVOURED,
		"LYING_KNOCKOUT" = LYING_KNOCKOUT
	),
	"hand_block_flags" = list(
		"HANDBLOCK_STATUSEFFECT_PARALYZED" = HANDBLOCK_STATUSEFFECT_PARALYZED,
		"HANDBLOCK_STATUSEFFECT_STUN" = HANDBLOCK_STATUSEFFECT_STUN,
		"HANDBLOCK_STAT_NOTCONSCIOUS" = HANDBLOCK_STAT_NOTCONSCIOUS,
		"HANDBLOCK_TRAIT_STASIS" = HANDBLOCK_TRAIT_STASIS,
		"HANDBLOCK_FAKEDDEATH" = HANDBLOCK_FAKEDDEATH,
		"HANDBLOCK_GRABSTATE_GRAB_NECK" = HANDBLOCK_GRABSTATE_GRAB_NECK,
		"HANDBLOCK_RESTRAINED" = HANDBLOCK_RESTRAINED,
		"HANDBLOCK_ARMLESS" = HANDBLOCK_ARMLESS,
		"HANDBLOCK_STATUSEFFECT_DISABLEHANDS" = HANDBLOCK_STATUSEFFECT_DISABLEHANDS,
		"HANDBLOCK_STATUSEFFECT_WORMED" = HANDBLOCK_STATUSEFFECT_WORMED,
		"HANDBLOCK_DEVOURED" = HANDBLOCK_DEVOURED,
		"HANDBLOCK_KNOCKOUT" = HANDBLOCK_KNOCKOUT,
		"HANDBLOCK_XENOLYING" = HANDBLOCK_XENOLYING
	),
	"pull_block_flags" = list(
		"PULLBLOCK_LYING" = PULLBLOCK_LYING,
		"PULLBLOCK_HANDBLOCK" = PULLBLOCK_HANDBLOCK,
		"PULLBLOCK_STATUSEFFECT_IMMOBILIZED" = PULLBLOCK_STATUSEFFECT_IMMOBILIZED
	),
	"ui_block_flags" = list(
		"UI_LYING" = UI_LYING,
		"UI_HANDBLOCK" = UI_HANDBLOCK,
		"UI_STATUSEFFECT_IMMOBILIZED" = UI_STATUSEFFECT_IMMOBILIZED
	)
	))
