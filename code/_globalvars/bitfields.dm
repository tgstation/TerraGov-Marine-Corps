GLOBAL_LIST_INIT(bitfields, list(
	...
	"flags_gun_innate_features" = list(
		"GUN__CAN_POINTBLANK" = GUN__CAN_POINTBLANK,
		"GUN__UNUSUAL_DESIGN" = GUN__UNUSUAL_DESIGN,
		"GUN__INTERNAL_MAG" = GUN__INTERNAL_MAG,
		"GUN__AUTO_EJECTOR" = GUN__AUTO_EJECTOR,
		"GUN__AMMO_COUNTER" = GUN__AMMO_COUNTER,
		"GUN__WIELDED_FIRING_ONLY" = GUN__WIELDED_FIRING_ONLY,
		"GUN__ENERGY" = GUN__ENERGY,
		"GUN__LOAD_INTO_CHAMBER" = GUN__LOAD_INTO_CHAMBER,
		"GUN__SHOTGUN_CHAMBER" = GUN__SHOTGUN_CHAMBER,
		"GUN__ALLOW_SYNTHETIC" = GUN__ALLOW_SYNTHETIC,
		"GUN__IS_SENTRY" = GUN__IS_SENTRY,
		"GUN__IS_ATTACHMENT" = GUN__IS_ATTACHMENT,
		"GUN__ATTACHMENT_FIRE_ONLY" = GUN__ATTACHMENT_FIRE_ONLY,
		"GUN__WIELDED_FIRING_ONLY" = GUN__WIELDED_FIRING_ONLY,
		"GUN__IFF" = GUN__IFF,
		"GUN__DEPLOYED_FIRE_ONLY" = GUN__DEPLOYED_FIRE_ONLY,
		"GUN__IS_ATTACHMENT" = GUN__IS_ATTACHMENT,
		"GUN__ATTACHMENT_FIRE_ONLY" = GUN__ATTACHMENT_FIRE_ONLY,
		"GUN__IS_SENTRY" = GUN__IS_SENTRY,
		),
