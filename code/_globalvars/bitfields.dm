GLOBAL_LIST_INIT(bitfields, list(
	...
	"flags_gun_features" = list(
		...
		"GUN_ATTACHMENT_FIRE_ONLY" = GUN_ATTACHMENT_FIRE_ONLY,
		"GUN_IS_SENTRY" = GUN_IS_SENTRY,
		"GUN_PUMP_REQUIRED" = GUN_PUMP_REQUIRED
		),
	...
	"flags_magazine" = list(
		"AMMUNITION_REFILLABLE" = MAGAZINE_REFILLABLE,
		"AMMUNITION_HANDFUL" = MAGAZINE_HANDFUL,
		"AMMUNITION_WORN" = MAGAZINE_WORN
	),
	"reciever_flags" = list(
		"RECIEVER_REQUIRES_OPERATION" = RECIEVER_REQUIRES_OPERATION,
		"RECIEVER_MAGAZINES" = RECIEVER_MAGAZINES,
		"RECIEVER_HANDFULS" = RECIEVER_HANDFULS,
		"RECIEVER_TOGGLES" = RECIEVER_TOGGLES,
		"RECIEVER_CLOSED" = RECIEVER_CLOSED,
		"RECIEVER_CYCLES" = RECIEVER_CYCLES,
		"RECIEVER_AUTO_EJECT" = RECIEVER_AUTO_EJECT,
		"RECIEVER_CASING" = RECIEVER_CASING,
		"RECIEVER_INTERNAL" = RECIEVER_INTERNAL,
		"RECIEVER_TOGGLES_EJECTS" = RECIEVER_TOGGLES_EJECTS,
		"RECIEVER_LOCKS" = RECIEVER_LOCKS,
	),
	"be_special" = list(
		"BE_ALIEN" = BE_ALIEN,
		"BE_QUEEN" = BE_QUEEN,
