GLOBAL_LIST_INIT(bitfields, list(
	...
	"xeno_structure_flags" = list(
		"ACID_SPIRE_CONNECTABLE" = ACID_SPIRE_CONNECTABLE,
		"ACID_SPIRE_CONNECTED" = ACID_SPIRE_CONNECTED,
		"ACID_BROKEN" = ACID_BROKEN,
		"ACID_REPAIRABLE" = ACID_REPAIRABLE,
	),
	))
