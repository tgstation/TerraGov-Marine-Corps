GLOBAL_LIST_INIT(bitfields, list(
	...
	"flags_gun_innate_features" = list(
		"GUN_INNATE_CAN_POINTBLANK" = GUN_INNATE_CAN_POINTBLANK,
		"GUN_INNATE_UNUSUAL_DESIGN" = GUN_INNATE_UNUSUAL_DESIGN,
		"GUN_INNATE_INTERNAL_MAG" = GUN_INNATE_INTERNAL_MAG,
		"GUN_INNATE_AUTO_EJECTOR" = GUN_INNATE_AUTO_EJECTOR,
		"GUN_INNATE_AMMO_COUNTER" = GUN_INNATE_AMMO_COUNTER,
		"GUN_INNATE_WIELDED_FIRING_ONLY" = GUN_INNATE_WIELDED_FIRING_ONLY,
		"GUN_INNATE_ENERGY" = GUN_INNATE_ENERGY,
		"GUN_INNATE_LOAD_INTO_CHAMBER" = GUN_INNATE_LOAD_INTO_CHAMBER,
		"GUN_INNATE_SHOTGUN_CHAMBER" = GUN_INNATE_SHOTGUN_CHAMBER,
		"GUN_INNATE_ALLOW_SYNTHETIC" = GUN_INNATE_ALLOW_SYNTHETIC,
		"GUN_INNATE_IS_SENTRY" = GUN_INNATE_IS_SENTRY,
		"GUN_INNATE_IS_ATTACHMENT" = GUN_INNATE_IS_ATTACHMENT,
		"GUN_INNATE_ATTACHMENT_FIRE_ONLY" = GUN_INNATE_ATTACHMENT_FIRE_ONLY,
		"GUN_INNATE_WIELDED_FIRING_ONLY" = GUN_INNATE_WIELDED_FIRING_ONLY,
		"GUN_INNATE_IFF" = GUN_INNATE_IFF,
		"GUN_INNATE_DEPLOYED_FIRE_ONLY" = GUN_INNATE_DEPLOYED_FIRE_ONLY,
		"GUN_INNATE_IS_ATTACHMENT" = GUN_INNATE_IS_ATTACHMENT,
		"GUN_INNATE_ATTACHMENT_FIRE_ONLY" = GUN_INNATE_ATTACHMENT_FIRE_ONLY,
		"GUN_INNATE_IS_SENTRY" = GUN_INNATE_IS_SENTRY,
		),
	"flags_gun_added_features" = list(
