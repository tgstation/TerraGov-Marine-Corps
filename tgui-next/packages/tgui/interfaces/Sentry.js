...
export const Sentry = props => {
  ...
  return (
    <Fragment>
      ...
      <NoticeBox>
        The {data.name} is currently {data.is_on ? (<Box inline color="good">ON</Box>) : (<Box inline color="bad">OFF</Box>)}
        <Button
          icon="power-off"
      ...
      <LabeledList>
        <LabeledList.Item
          ...
          <ProgressBar
            ...
            color={(data.cell_charge > (0.67 * data.cell_maxcharge)) ? "good" : ((data.cell_charge > (0.33 * data.cell_maxcharge)) ? "average" : "bad")} />
          </Box>
          <Box>
        ...
        <LabeledList.Item
          ...
          <ProgressBar
            ...
            color={(data.health > (0.67 * data.health_max)) ? "good" : ((data.health > (0.33 * data.health_max)) ? "average" : "bad")} />
        </LabeledList.Item>
        <LabeledList.Item
          ...
          <ProgressBar
            ...
            color={(data.rounds > (0.67 * data.rounds_max)) ? "good" : ((data.rounds > (0.33 * data.rounds_max)) ? "average" : "bad")} />
          </Box>
          <Box>
        ...
        <LabeledList.Item
          label="Burst Fire">
          Burst fire is currently {data.burst_fire ? (<Box inline color="good">ON</Box>) : (<Box inline color="bad">OFF</Box>)}
          <br/>
        ...
        <LabeledList.Item
          label="Weapon Safety">
          Safety is currently {data.safety_toggle ? <Box inline color="good">ON</Box> +'(Only Xenos will be targeted.)') : (<Box inline color="bad">OFF</Box> +'(Non-Xenos without IFF clearance will be targeted.)')}
          <br/>
          <Button
        ...
        <LabeledList.Item
          ...
          Manual override is currently {data.manual_override ? (<Box inline color="good">ON</Box>) : (<Box inline color="bad">OFF</Box>)}
          <br/>
          <Button
        ...
        <LabeledList.Item
          label="Radial Mode">
          Radial Mode is currently {data.radial_mode ? (<Box inline color="good">ON</Box>) : (<Box inline color="bad">OFF</Box>)}
          <br/>
          <Button
        ...
        <LabeledList.Item
          label="Alert Mode">
          Alert Mode is currently {data.alerts_on ? (<Box inline color="good">ON</Box>) : (<Box inline color="bad">OFF</Box>)}
          <br/>
          <Button
