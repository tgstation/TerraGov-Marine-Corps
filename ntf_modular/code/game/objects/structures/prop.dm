...
/obj/structure/prop/mainship/prop_so/icc_one
	name = "Terry Maxson"
	desc = "A member of the "+FACTION_ICC+" high command, he controls and maintains the entirety of "+FACTION_ICC+"."
	icon = 'ntf_modular/icons/obj/structures/prop/mainship.dmi'
	icon_state = "ICC_officer_one"

/obj/structure/prop/mainship/prop_so/icc_two
	name = "Cassandra Maximus"
	desc = "A member of the "+FACTION_ICC+" high command, she manages what goes through and out of "+FACTION_ICC+"."
	icon = 'ntf_modular/icons/obj/structures/prop/mainship.dmi'
	icon_state = "ICC_officer_two"

/obj/structure/prop/mainship/prop_so/icc_three
	name = "Kay Moody"
	desc = "A member of the "+FACTION_ICC+" high command, she manages all the trainings between the drill sergeants."
	icon = 'ntf_modular/icons/obj/structures/prop/mainship.dmi'
	icon_state = "ICC_officer_three"

/obj/structure/prop/mainship/prop_iccinf
	name = FACTION_ICC+" infantry"
