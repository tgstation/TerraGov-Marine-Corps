...
/obj/machinery/deployable/mounted/sentry/nut/sentry_start_fire()
	. = ..()
	var/atom/target = get_target()
	if(world.time > next_movement && target)
...
/obj/machinery/deployable/mounted/sentry/nut/sentry_stop_fire()
	. = ..()
