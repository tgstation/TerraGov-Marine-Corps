  ...
  return (
    <Fragment>
      <Section title="Supplypod bay">
        <Button
          onClick={() => act(ref, 'bay', { bay: 1 })}
          disabled={data.bayNumber===1}>
          Bay #1
        </Button>
        <Button
          onClick={() => act(ref, 'bay', { bay: 2 })}
          disabled={data.bayNumber===2}>
          Bay #2
        </Button>
        <Button
          onClick={() => act(ref, 'bay', { bay: 3 })}
          disabled={data.bayNumber===3}>
          Bay #3
        </Button>
        <Button
          onClick={() => act(ref, 'bay', { bay: 4 })}
          disabled={data.bayNumber===4}>
          Bay #4
        </Button>
        <Button
          onClick={() => act(ref, 'bay', { bay: 5 })}
      ...
      <Section title="Teleport to">
        ...
        <Button
          onClick={() => act(ref, 'teleportBack')} disabled={!data.oldArea}>
      ...
      <Section title="Movement effects">
        ...
        <Button onClick={() => act(ref, 'effectCircle')}>
          Any Descent Angle
        </Button>
        <Button onClick={() => act(ref, 'effectBurst')}>
          Machine Gun Mode
        </Button>
        <Button onClick={() => act(ref, 'effectTarget')}>
          Specific Target
        </Button>
      </Section>
      ...
      <Section title="Sound">
        <Button onClick={() => act(ref, 'fallingSound')}>
          Custom Falling Sound
        </Button>
        <Button onClick={() => act(ref, 'landingSound')}>
          Custom Landing Sound
        </Button>
        <Button onClick={() => act(ref, 'openingSound')}>
          Custom Opening Sound
        </Button>
        <Button onClick={() => act(ref, 'leavingSound')}>
          Custom Leaving Sound
        </Button>
        <Button onClick={() => act(ref, 'soundVolume')}>
          Admin Sound Volume
        </Button>
      </Section>
      <Section title="Delay timers">
        <Button onClick={() => act(ref, 'fallDuration')}>
          Custom Falling Duration
        </Button>
        <Button onClick={() => act(ref, 'landingDelay')}>
          Custom Landing Time
        </Button>
        <Button onClick={() => act(ref, 'openingDelay')}>
          Custom Opening Time
        </Button>
        <Button onClick={() => act(ref, 'departureDelay')}>
          Custom Leaving Time
        </Button>
      </Section>
      <Section title="Style">
        ...
        <Button onClick={() => act(ref, 'styleSMissile')}>
          Syndicate Missile
        </Button>
      ...
      <Section title={"Action " + data.numObjects + " turfs in " + data.bay}>
        ...
        <Button onClick={() => act(ref, 'giveLauncher')}>
          Enter Launch Mode
        </Button>
