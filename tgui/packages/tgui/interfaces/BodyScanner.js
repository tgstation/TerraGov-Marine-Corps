      ...
      <Window.Content>
        <Section title={'Patient: ' + patient}>
          ...
          <LabeledList>
            ...
            <LabeledList.Item label="State" color={statstate}>
                {stat}
            </LabeledList.Item>
            {dead ? (
            ...
            <LabeledList>
              {damaged_organs.map((organ) => (
                <LabeledList.Item
                  ...
                  <Box
                    inline
                    color={organ.status === 'Healthy' ? 'green' : 'Bruised' ? 'orange' : 'red'}
                    bold={1}>
        ...
        <Section>
          <LabeledList>
            ...
            <LabeledList.Item label={'Body Temperature'}>{body_temperature}</LabeledList.Item>
            <LabeledList.Item label={'Pulse'}>{pulse}</LabeledList.Item>
            {knock ? <LabeledList.Item label={'Knockout time'}>{knock}s</LabeledList.Item> : null}
          </LabeledList>
        </Section>
        {internal_bleeding ? <NoticeBox color={'red'} warning>{internal_bleeding}</NoticeBox> : null}
        {infection ? <NoticeBox warning>{infection}</NoticeBox> : null}
        {necrotized ? <NoticeBox warning>{necrotized}</NoticeBox> : null}
        {implants ? (
          <NoticeBox info>
