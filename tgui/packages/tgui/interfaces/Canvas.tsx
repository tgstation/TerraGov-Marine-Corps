...
type CanvasData = {
  ...
  zoom: number;
  max_zoom: number;
  max_decal_size: number;
  min_decal_size: number;
  grid_height: number;
  grid_width: number;
};
      ...
      <Window.Content>
        ...
        <Flex align="start" direction="row">
          ...
          <Flex.Item>
            x
            <NumberInput
              value={data.grid_height}
              maxValue={data.max_decal_size}
              step={1}
              minValue={3}
              onChange={(value) =>
                act('resize', {
                  new_height: value,
                  new_width: data.grid_width,
                })
              }
              m={0.5}
            />
          ...
          <Flex.Item>
            y
            <NumberInput
              value={data.grid_width}
              maxValue={data.max_decal_size}
              step={1}
              minValue={3}
              onChange={(value) =>
                act('resize', {
                  new_height: data.grid_height,
                  new_width: value,
                })
              }
              m={0.5}
