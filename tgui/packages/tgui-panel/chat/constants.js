...
export const MESSAGE_TYPES = [
  ...
  },
  {
    ...
    selector: '.alert, .minorannounce, .radio, .deptradio, .syndradio, .comradio, .casradio, .engradio, .medradio, .sciradio, .supradio, .alpharadio, .bravoradio, .charlieradio, .deltaradio, .zuluradio, .yankeeradio, .xrayradio, .whiskeyradio, .thetaradio, .omegaradio, .gammaradio, .sigmaradio, .newscaster, .binarysay, .hivemind',
  },
  {
