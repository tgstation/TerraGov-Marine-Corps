...
export const MESSAGE_TYPES = [
  ...
  },
  {
    ...
    selector: '.ooc, .adminooc, .hostooc, .projleadooc, .headcoderooc, .headminooc, .headmentorooc, .trialminooc, .candiminooc, .mentorooc, .maintainerooc, .contributorooc, .otherooc',
  },
  {
